...
public abstract class GuiTeamBattleSlot
{
    ...
    public GuiTeamBattleSlot(Minecraft par1Minecraft, int par2, int par3, int par4, int par5, int par6)
    {
    ...
    public void func_148128_a(int p_148128_1_, int p_148128_2_, float p_148128_3_)
    {
        ...
        if (p_148128_1_ > this.field_148152_e && p_148128_1_ < this.field_148151_d && p_148128_2_ > this.field_148153_b && p_148128_2_ < this.field_148154_c)
        {
            if (Mouse.isButtonDown(0) && this.func_148125_i())
            {
                if (this.field_148157_o == -1.0F)
                {
                    ...
                    {
                        int var16 = this.field_148155_a / 2 - this.func_148139_c() / 2;
                        ...
                        int var18 = var10 / this.field_148149_f;

                        if (p_148128_1_ >= var16 && p_148128_1_ <= var9 && var18 >= 0 && var10 >= 0 && var18 < var4)
                        {
                            boolean var14 = var18 == this.field_148168_r && Minecraft.getSystemTime() - this.field_148167_s < 250L;
                            this.elementClicked(var18, var14, p_148128_1_, p_148128_2_);
                            this.field_148168_r = var18;
                            this.field_148167_s = Minecraft.getSystemTime();
                        }
                        else if (p_148128_1_ >= var16 && p_148128_1_ <= var9 && var10 < 0)
                        {
                            this.func_148132_a(p_148128_1_ - var16, p_148128_2_ - this.field_148153_b + (int)this.field_148169_q - 4);
                            var171 = false;
                        }
            ...
            else
            {
                for (; !this.field_148161_k.gameSettings.touchscreen && Mouse.next(); this.field_148161_k.currentScreen.handleMouseInput())
                {
                    ...
                    if (var17 != 0)
                    {
                        ...
                        this.field_148169_q += (float)(var17 * this.field_148149_f / 2);
                    }
                }
        ...
        Tessellator var172 = Tessellator.instance;
        this.field_148161_k.getTextureManager().bindTexture(Gui.optionsBackground);
        GL11.glColor4f(1.0F, 1.0F, 1.0F, 1.0F);
        float var161 = 32.0F;
        var172.startDrawingQuads();
        var172.setColorOpaque_I(2105376);
        var172.addVertexWithUV((double)this.field_148152_e, (double)this.field_148154_c, 0.0D, (double)((float)this.field_148152_e / var161), (double)((float)(this.field_148154_c + (int)this.field_148169_q) / var161));
        var172.addVertexWithUV((double)this.field_148151_d, (double)this.field_148154_c, 0.0D, (double)((float)this.field_148151_d / var161), (double)((float)(this.field_148154_c + (int)this.field_148169_q) / var161));
        var172.addVertexWithUV((double)this.field_148151_d, (double)this.field_148153_b, 0.0D, (double)((float)this.field_148151_d / var161), (double)((float)(this.field_148153_b + (int)this.field_148169_q) / var161));
        var172.addVertexWithUV((double)this.field_148152_e, (double)this.field_148153_b, 0.0D, (double)((float)this.field_148152_e / var161), (double)((float)(this.field_148153_b + (int)this.field_148169_q) / var161));
        var172.draw();
        ...
        {
            this.func_148129_a(var9, var10, var172);
        }
        ...
        var172.startDrawingQuads();
        var172.setColorRGBA_I(0, 0);
        var172.addVertexWithUV((double)this.field_148152_e, (double)(this.field_148153_b + var181), 0.0D, 0.0D, 1.0D);
        var172.addVertexWithUV((double)this.field_148151_d, (double)(this.field_148153_b + var181), 0.0D, 1.0D, 1.0D);
        var172.setColorRGBA_I(0, 255);
        var172.addVertexWithUV((double)this.field_148151_d, (double)this.field_148153_b, 0.0D, 1.0D, 0.0D);
        var172.addVertexWithUV((double)this.field_148152_e, (double)this.field_148153_b, 0.0D, 0.0D, 0.0D);
        var172.draw();
        var172.startDrawingQuads();
        var172.setColorRGBA_I(0, 255);
        var172.addVertexWithUV((double)this.field_148152_e, (double)this.field_148154_c, 0.0D, 0.0D, 1.0D);
        var172.addVertexWithUV((double)this.field_148151_d, (double)this.field_148154_c, 0.0D, 1.0D, 1.0D);
        var172.setColorRGBA_I(0, 0);
        var172.addVertexWithUV((double)this.field_148151_d, (double)(this.field_148154_c - var181), 0.0D, 1.0D, 0.0D);
        var172.addVertexWithUV((double)this.field_148152_e, (double)(this.field_148154_c - var181), 0.0D, 0.0D, 0.0D);
        var172.draw();
        var19 = this.func_148135_f();
        ...
        if (var19 > 0)
        {
            ...
            int var141 = (int)this.field_148169_q * (this.field_148154_c - this.field_148153_b - var13) / var19 + this.field_148153_b;

            if (var141 < this.field_148153_b)
            {
                var141 = this.field_148153_b;
            }

            var172.startDrawingQuads();
            var172.setColorRGBA_I(0, 255);
            var172.addVertexWithUV((double)var5, (double)this.field_148154_c, 0.0D, 0.0D, 1.0D);
            var172.addVertexWithUV((double)var6, (double)this.field_148154_c, 0.0D, 1.0D, 1.0D);
            var172.addVertexWithUV((double)var6, (double)this.field_148153_b, 0.0D, 1.0D, 0.0D);
            var172.addVertexWithUV((double)var5, (double)this.field_148153_b, 0.0D, 0.0D, 0.0D);
            var172.draw();
            var172.startDrawingQuads();
            var172.setColorRGBA_I(8421504, 255);
            var172.addVertexWithUV((double)var5, (double)(var141 + var13), 0.0D, 0.0D, 1.0D);
            var172.addVertexWithUV((double)var6, (double)(var141 + var13), 0.0D, 1.0D, 1.0D);
            var172.addVertexWithUV((double)var6, (double)var141, 0.0D, 1.0D, 0.0D);
            var172.addVertexWithUV((double)var5, (double)var141, 0.0D, 0.0D, 0.0D);
            var172.draw();
            var172.startDrawingQuads();
            var172.setColorRGBA_I(12632256, 255);
            var172.addVertexWithUV((double)var5, (double)(var141 + var13 - 1), 0.0D, 0.0D, 1.0D);
            var172.addVertexWithUV((double)(var6 - 1), (double)(var141 + var13 - 1), 0.0D, 1.0D, 1.0D);
            var172.addVertexWithUV((double)(var6 - 1), (double)var141, 0.0D, 1.0D, 0.0D);
            var172.addVertexWithUV((double)var5, (double)var141, 0.0D, 0.0D, 0.0D);
            var172.draw();
        }
    ...
    {
        return this.field_148155_a / 2 + 134;
    }
