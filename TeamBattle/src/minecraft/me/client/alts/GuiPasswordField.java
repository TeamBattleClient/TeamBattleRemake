    ...
    public void drawTextBox()
    {
        if (this.func_146176_q())
        {
            ...
            if (var4.length() > 0)
            {
                ...
                for (int stars = 0; stars < var13.length(); ++stars)
                {
                    var11 = var11.concat("*");
                }

                var9 = this.field_146211_a.drawString(var11, var7, var8, var1);
            }
            ...
            if (!var5)
            {
                var16 = var2 > 0 ? var7 + this.field_146218_h : var7;
            }
            else if (var14)
            {
                var16 = var9 - 1;
            ...
            if (var4.length() > 0 && var5 && var2 < var4.length())
            {
                ...
                for (var12 = 0; var12 < var4.substring(var2).length(); ++var12)
                {
                    var15 = var15.concat("*");
                }

                this.field_146211_a.drawString(var15, var9, var8, var1);
            }
            ...
            if (var6)
            {
                if (var14)
                {
                    Gui.drawRect(var16, var8 - 1, var16 + 1, var8 + 1 + this.field_146211_a.FONT_HEIGHT, -3092272);
                }
                else
                {
                    this.field_146211_a.drawString("_", var16, var8, var1);
                }
            }
            ...
            if (var3 != var2)
            {
                ...
                for (var12 = 0; var12 < var4.substring(0, var3).length(); ++var12)
                {
                    var15 = var15.concat("*");
                }

                var12 = var7 + this.field_146211_a.getStringWidth(var15);
                this.func_146188_c(var16, var8 - 1, var12 - 1, var8 + 1 + this.field_146211_a.FONT_HEIGHT);
            }
        }
    }
