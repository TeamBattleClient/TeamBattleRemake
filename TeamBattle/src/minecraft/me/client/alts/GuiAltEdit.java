...
public class GuiAltEdit extends GuiScreen
{
    ...
    public void initGui()
    {
        ...
        this.buttonList.add(new GuiButton(0, this.width / 2 - 100, this.height / 4 + 96 + 12, "Save"));
    ...
    protected void actionPerformed(GuiButton clickedButton)
    {
        ...
        {
            Alt newAlt = new Alt(this.nameBox.getText(), this.passwordBox.getText());
            ...
            else if (clickedButton.id == 0)
            {
                ...
                if (this.passwordBox.getText().length() == 0)
                {
                    ...
                    var10001 = GuiAlts.altList;
                    GuiAltList.alts.set(GuiAltList.alts.indexOf(this.alt), newAlt);
                    this.displayText = "";
                }
                else
                {
