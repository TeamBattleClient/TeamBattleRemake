...
public class ServerCommandManager extends CommandHandler implements
	...
	@Override
	public void func_152372_a(ICommandSender p_152372_1_, ICommand p_152372_2_,
			int p_152372_3_, String p_152372_4_, Object... p_152372_5_) {
		boolean var6 = true;
		...
		final ChatComponentTranslation var7 = new ChatComponentTranslation(
				"chat.type.admin",
				new Object[] { p_152372_1_.getCommandSenderName(),
						new ChatComponentTranslation(p_152372_4_, p_152372_5_) });
		var7.getChatStyle().setColor(EnumChatFormatting.GRAY);
		var7.getChatStyle().setItalic(Boolean.valueOf(true));

		if (var6) {
			final Iterator var8 = MinecraftServer.getServer()
			...
			while (var8.hasNext()) {
				...
				if (var9 != p_152372_1_
						&& MinecraftServer.getServer()
								...
								.func_152596_g(var9.getGameProfile())
						&& p_152372_2_.canCommandSenderUseCommand(var9)
						&& (!(p_152372_1_ instanceof RConConsoleSource) || MinecraftServer
								.getServer().func_152363_m())) {
		...
		if ((p_152372_3_ & 1) != 1) {
			p_152372_1_.addChatMessage(new ChatComponentTranslation(
					p_152372_4_, p_152372_5_));
		}
	}
}
