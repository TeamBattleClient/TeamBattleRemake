	...
	public void processCommand(ICommandSender p_71515_1_, String[] p_71515_2_) {
		if (p_71515_2_.length < 2)
			...
			if (p_71515_2_[1].equals("clear")) {
				...
				final int var4 = parseIntWithMin(p_71515_1_, p_71515_2_[1], 1);
				int var5 = 600;
				int var6 = 30;
				int var7 = 0;

				if (var4 < 0 || var4 >= Potion.potionTypes.length
						|| Potion.potionTypes[var4] == null)
					throw new NumberInvalidException(
							"commands.effect.notFound",
							new Object[] { Integer.valueOf(var4) });

				if (p_71515_2_.length >= 3) {
					var6 = parseIntBounded(p_71515_1_, p_71515_2_[2], 0,
							1000000);
				...
				if (var6 == 0) {
					...
					func_152373_a(
							...
							new Object[] {
									new ChatComponentTranslation(
											Potion.potionTypes[var4].getName(),
											new Object[0]),
									var3.getCommandSenderName() });
				} else {
					...
					func_152373_a(
							...
							new Object[] {
									new ChatComponentTranslation(var8
											.getEffectName(), new Object[0]),
