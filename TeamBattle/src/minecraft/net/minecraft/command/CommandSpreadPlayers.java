...
public class CommandSpreadPlayers extends CommandBase {
	...
	static class Position {
		...
		public int func_111092_a(World p_111092_1_) {
			final int var2 = MathHelper.floor_double(field_111101_a);
			final int var3 = MathHelper.floor_double(field_111100_b);
		...
		public boolean func_111093_a(double p_111093_1_, double p_111093_3_,
				double p_111093_5_, double p_111093_7_) {
			boolean var9 = false;
		...
		float func_111096_b() {
			return MathHelper.sqrt_double(field_111101_a * field_111101_a
					+ field_111100_b * field_111100_b);
		}

		public void func_111097_a(Random p_111097_1_, double p_111097_2_,
				double p_111097_4_, double p_111097_6_, double p_111097_8_) {
			field_111101_a = MathHelper.getRandomDoubleInRange(p_111097_1_,
					p_111097_2_, p_111097_6_);
			field_111100_b = MathHelper.getRandomDoubleInRange(p_111097_1_,
					p_111097_4_, p_111097_8_);
		}
		...
		public boolean func_111098_b(World p_111098_1_) {
			...
			final Material var5 = p_111098_1_.getBlock(var2, var4, var3)
					.getMaterial();
	...
	private int func_110668_a(CommandSpreadPlayers.Position p_110668_1_,
			double p_110668_2_, World p_110668_4_, Random p_110668_5_,
			double p_110668_6_, double p_110668_8_, double p_110668_10_,
			double p_110668_12_, CommandSpreadPlayers.Position[] p_110668_14_,
			...
			for (int var20 = 0; var20 < p_110668_14_.length; ++var20) {
				...
				for (int var24 = 0; var24 < p_110668_14_.length; ++var24) {
					if (var20 != var24) {
						...
						if (var26 < p_110668_2_) {
							++var22;
							var23.field_111101_a += var25.field_111101_a
									- var21.field_111101_a;
							var23.field_111100_b += var25.field_111100_b
									- var21.field_111100_b;
						}
					}
				}
				...
				if (var22 > 0) {
					...
					if (var30 > 0.0D) {
						...
						var21.func_111097_a(p_110668_5_, p_110668_6_,
								p_110668_8_, p_110668_10_, p_110668_12_);
					}

					var16 = true;
				}

				if (var21.func_111093_a(p_110668_6_, p_110668_8_, p_110668_10_,
						p_110668_12_)) {
					var16 = true;
				}
			}
			...
			if (!var16) {
				...
				for (var22 = 0; var22 < var29; ++var22) {
					...
					if (!var23.func_111098_b(p_110668_4_)) {
						var23.func_111097_a(p_110668_5_, p_110668_6_,
								p_110668_8_, p_110668_10_, p_110668_12_);
						var16 = true;
					}
				}
		...
		if (var17 >= 10000)
			throw new CommandException("commands.spreadplayers.failure."
					+ (p_110668_15_ ? "teams" : "players"), new Object[] {
					Integer.valueOf(p_110668_14_.length),
					Double.valueOf(p_110668_1_.field_111101_a),
					Double.valueOf(p_110668_1_.field_111100_b),
					String.format("%.2f",
							new Object[] { Double.valueOf(var18) }) });
		else
			return var17;
	}

	private void func_110669_a(ICommandSender p_110669_1_, List p_110669_2_,
			CommandSpreadPlayers.Position p_110669_3_, double p_110669_4_,
			double p_110669_6_, World p_110669_8_, boolean p_110669_9_) {
		...
		final CommandSpreadPlayers.Position[] var19 = func_110670_a(var10,
				p_110669_9_ ? func_110667_a(p_110669_2_) : p_110669_2_.size(),
				var11, var13, var15, var17);
		final int var20 = func_110668_a(p_110669_3_, p_110669_4_, p_110669_8_,
				var10, var11, var13, var15, var17, var19, p_110669_9_);
		final double var21 = func_110671_a(p_110669_2_, p_110669_8_, var19,
				p_110669_9_);
		func_152373_a(
				p_110669_1_,
				this,
				"commands.spreadplayers.success."
						+ (p_110669_9_ ? "teams" : "players"),
				new Object[] { Integer.valueOf(var19.length),
						Double.valueOf(p_110669_3_.field_111101_a),
						Double.valueOf(p_110669_3_.field_111100_b) });

		if (var19.length > 1) {
			p_110669_1_.addChatMessage(new ChatComponentTranslation(
					"commands.spreadplayers.info."
							+ (p_110669_9_ ? "teams" : "players"),
					new Object[] {
							String.format("%.2f",
									new Object[] { Double.valueOf(var21) }),
							Integer.valueOf(var20) }));
		}
	}

	private CommandSpreadPlayers.Position[] func_110670_a(Random p_110670_1_,
			int p_110670_2_, double p_110670_3_, double p_110670_5_,
			double p_110670_7_, double p_110670_9_) {
		...
		for (int var12 = 0; var12 < var11.length; ++var12) {
			...
			var13.func_111097_a(p_110670_1_, p_110670_3_, p_110670_5_,
					p_110670_7_, p_110670_9_);
			var11[var12] = var13;
		}
	...
	private double func_110671_a(List p_110671_1_, World p_110671_2_,
			CommandSpreadPlayers.Position[] p_110671_3_, boolean p_110671_4_) {
		double var5 = 0.0D;
		int var7 = 0;
		final HashMap var8 = Maps.newHashMap();

		for (int var9 = 0; var9 < p_110671_1_.size(); ++var9) {
			final EntityLivingBase var10 = (EntityLivingBase) p_110671_1_
					.get(var9);
			CommandSpreadPlayers.Position var11;

			if (p_110671_4_) {
				final Team var12 = var10 instanceof EntityPlayer ? var10
						.getTeam() : null;
			...
			var10.setPositionAndUpdate(
					MathHelper.floor_double(var11.field_111101_a) + 0.5F,
					var11.func_111092_a(p_110671_2_),
					MathHelper.floor_double(var11.field_111100_b) + 0.5D);
	...
	public void processCommand(ICommandSender p_71515_1_, String[] p_71515_2_) {
		if (p_71515_2_.length < 6)
			...
			final byte var3 = 0;
			int var16 = var3 + 1;
			final double var4 = func_110666_a(p_71515_1_, Double.NaN,
					p_71515_2_[var3]);
			final double var6 = func_110666_a(p_71515_1_, Double.NaN,
					p_71515_2_[var16++]);
			final double var8 = parseDoubleWithMin(p_71515_1_,
					p_71515_2_[var16++], 0.0D);
			final double var10 = parseDoubleWithMin(p_71515_1_,
					p_71515_2_[var16++], var8 + 1.0D);
			final boolean var12 = parseBoolean(p_71515_1_, p_71515_2_[var16++]);
			final ArrayList var13 = Lists.newArrayList();

			while (true) {
				while (var16 < p_71515_2_.length) {
					final String var14 = p_71515_2_[var16++];

					if (PlayerSelector.hasArguments(var14)) {
						final EntityPlayerMP[] var17 = PlayerSelector
								.matchPlayers(p_71515_1_, var14);
						...
						final EntityPlayerMP var15 = MinecraftServer
				...
				p_71515_1_.addChatMessage(new ChatComponentTranslation(
						"commands.spreadplayers.spreading."
								+ (var12 ? "teams" : "players"), new Object[] {
								Integer.valueOf(var13.size()),
								Double.valueOf(var10), Double.valueOf(var4),
								Double.valueOf(var6), Double.valueOf(var8) }));
				func_110669_a(p_71515_1_, var13,
						new CommandSpreadPlayers.Position(var4, var6), var8,
						var10, ((EntityLivingBase) var13.get(0)).worldObj,
						var12);
				return;
			}
		}
