...
public interface IEntitySelector {
		...
		public boolean isEntityApplicable(Entity p_82704_1_) {
			if (!p_82704_1_.isEntityAlive())
				...
				return var2.getEquipmentInSlot(EntityLiving
						.getArmorPosition(field_96567_c)) != null ? false
	...
	IEntitySelector field_152785_b = new IEntitySelector() {
		...
		public boolean isEntityApplicable(Entity p_82704_1_) {
			return p_82704_1_.isEntityAlive()
					&& p_82704_1_.riddenByEntity == null
					&& p_82704_1_.ridingEntity == null;
		}
	};
	...
	IEntitySelector selectInventories = new IEntitySelector() {
		...
		@Override
		public boolean isEntityApplicable(Entity p_82704_1_) {
			return p_82704_1_ instanceof IInventory
					&& p_82704_1_.isEntityAlive();
		}
	};
