...
public class CommandEnchant extends CommandBase {
	...
	public List addTabCompletionOptions(ICommandSender p_71516_1_,
		...
		return p_71516_2_.length == 1 ? getListOfStringsMatchingLastWord(
				p_71516_2_, getListOfPlayers()) : null;
	}
	...
	public void processCommand(ICommandSender p_71515_1_, String[] p_71515_2_) {
		if (p_71515_2_.length < 2)
			...
			final int var4 = parseIntBounded(p_71515_1_, p_71515_2_[1], 0,
			...
			if (var6 == null)
				...
				if (var7 == null)
					...
					if (p_71515_2_.length >= 3) {
						var5 = parseIntBounded(p_71515_1_, p_71515_2_[2],
								var7.getMinLevel(), var7.getMaxLevel());
					}
					...
					if (var6.hasTagCompound()) {
						...
						if (var8 != null) {
							for (int var9 = 0; var9 < var8.tagCount(); ++var9) {
								final short var10 = var8.getCompoundTagAt(var9)
										.getShort("id");
