...
public class CommandDifficulty extends CommandBase {
	...
	protected EnumDifficulty func_147201_h(ICommandSender p_147201_1_,
		...
		return !p_147201_2_.equalsIgnoreCase("peaceful")
				...
				.getDifficultyEnum(parseIntBounded(p_147201_1_, p_147201_2_, 0,
						3)) : EnumDifficulty.HARD
	...
	public void processCommand(ICommandSender p_71515_1_, String[] p_71515_2_) {
		if (p_71515_2_.length > 0) {
			final EnumDifficulty var3 = func_147201_h(p_71515_1_, p_71515_2_[0]);
			...
			func_152373_a(
					...
					new Object[] { new ChatComponentTranslation(var3
							.getDifficultyResourceKey(), new Object[0]) });
		} else
