...
public class CommandSetBlock extends CommandBase {
	...
	public List addTabCompletionOptions(ICommandSender p_71516_1_,
		...
		return p_71516_2_.length == 4 ? getListOfStringsFromIterableMatchingLastWord(
				p_71516_2_, Block.blockRegistry.getKeys())
				: p_71516_2_.length == 6 ? getListOfStringsMatchingLastWord(
						p_71516_2_,
						new String[] { "replace", "destroy", "keep" }) : null;
	}
	...
	public void processCommand(ICommandSender p_71515_1_, String[] p_71515_2_) {
		if (p_71515_2_.length >= 4) {
			...
			var5 = MathHelper.floor_double(func_110666_a(p_71515_1_, var5,
					p_71515_2_[2]));
			final Block var6 = CommandBase.getBlockByText(p_71515_1_,
					p_71515_2_[3]);
			int var7 = 0;
			...
			if (!var8.blockExists(var3, var4, var5))
				...
				if (p_71515_2_.length >= 7 && var6.hasTileEntity()) {
					final String var11 = func_147178_a(p_71515_1_, p_71515_2_,
							6).getUnformattedText();
				...
				if (p_71515_2_.length >= 6) {
					...
					} else if (p_71515_2_[5].equals("keep")
							&& !var8.isAirBlock(var3, var4, var5))
						throw new CommandException(
				...
				if (!var8.setBlock(var3, var4, var5, var6, var7, 3))
					...
					if (var10) {
						final TileEntity var14 = var8.getTileEntity(var3, var4,
								var5);
