	...
	public List addTabCompletionOptions(ICommandSender p_71516_1_,
		...
		return p_71516_2_.length == 1 ? getListOfStringsMatchingLastWord(
				p_71516_2_, MinecraftServer.getServer()
						.getConfigurationManager().func_152606_n()) : null;
	}
	...
	public void processCommand(ICommandSender p_71515_1_, String[] p_71515_2_) {
		if (p_71515_2_.length == 1 && p_71515_2_[0].length() > 0) {
			...
			final GameProfile var4 = var3.getConfigurationManager()
					.func_152603_m().func_152700_a(p_71515_2_[0]);

			if (var4 == null)
				throw new CommandException("commands.deop.failed",
						new Object[] { p_71515_2_[0] });
			else {
				var3.getConfigurationManager().func_152610_b(var4);
				func_152373_a(p_71515_1_, this, "commands.deop.success",
						new Object[] { p_71515_2_[0] });
			}
		} else
