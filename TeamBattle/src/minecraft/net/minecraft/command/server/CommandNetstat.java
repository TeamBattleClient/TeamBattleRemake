...
public class CommandNetstat extends CommandBase {
	...
	private void func_152375_a(ICommandSender p_152375_1_, int p_152375_2_,
			NetworkStatistics.PacketStat p_152375_3_) {
		if (p_152375_3_ != null) {
			p_152375_1_.addChatMessage(new ChatComponentText(p_152375_3_
					.toString()));
		} else {
			p_152375_1_.addChatMessage(new ChatComponentText("Packet "
					+ p_152375_2_ + " not found!"));
		}
	}
	...
	public void processCommand(ICommandSender p_71515_1_, String[] p_71515_2_) {
		if (p_71515_1_ instanceof EntityPlayer) {
			p_71515_1_.addChatMessage(new ChatComponentText(
					"Command is not available for players"));
		} else {
			if (p_71515_2_.length > 0 && p_71515_2_[0].length() > 1) {
				if ("hottest-read".equals(p_71515_2_[0])) {
					p_71515_1_.addChatMessage(new ChatComponentText(
							NetworkManager.field_152462_h.func_152477_e()
									.toString()));
				} else if ("hottest-write".equals(p_71515_2_[0])) {
					p_71515_1_.addChatMessage(new ChatComponentText(
							NetworkManager.field_152462_h.func_152475_g()
									.toString()));
				} else if ("most-read".equals(p_71515_2_[0])) {
					p_71515_1_.addChatMessage(new ChatComponentText(
							NetworkManager.field_152462_h.func_152467_f()
									.toString()));
				} else if ("most-write".equals(p_71515_2_[0])) {
					p_71515_1_.addChatMessage(new ChatComponentText(
							NetworkManager.field_152462_h.func_152470_h()
									.toString()));
				} else {
					...
					if ("packet-read".equals(p_71515_2_[0])) {
						if (p_71515_2_.length > 1 && p_71515_2_[1].length() > 0) {
							try {
								...
								var4 = NetworkManager.field_152462_h
										.func_152466_a(var7);
								func_152375_a(p_71515_1_, var7, var4);
						...
						p_71515_1_
								.addChatMessage(new ChatComponentText(
										"total-read-count"
												+ String.valueOf(NetworkManager.field_152462_h
														.func_152472_c())));
						...
						p_71515_1_.addChatMessage(new ChatComponentText(
								"Unrecognized: " + p_71515_2_[0]));
					}
				}
			} else {
				String var3 = "reads: "
						+ NetworkManager.field_152462_h.func_152465_a();
				var3 = var3 + ", writes: "
						+ NetworkManager.field_152462_h.func_152471_b();
