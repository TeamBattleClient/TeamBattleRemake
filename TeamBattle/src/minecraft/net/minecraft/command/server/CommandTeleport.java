		...
		if (p_71515_2_.length < 1)
			...
			if (p_71515_2_.length != 3 && p_71515_2_.length != 4) {
				if (p_71515_2_.length == 1 || p_71515_2_.length == 2) {
					final EntityPlayerMP var11 = getPlayer(p_71515_1_,
							p_71515_2_[p_71515_2_.length - 1]);
				...
				final double var5 = func_110666_a(p_71515_1_, var3.posX,
						p_71515_2_[var4++]);
				final double var7 = func_110665_a(p_71515_1_, var3.posY,
						p_71515_2_[var4++], 0, 0);
				final double var9 = func_110666_a(p_71515_1_, var3.posZ,
						p_71515_2_[var4++]);
				var3.mountEntity((Entity) null);
