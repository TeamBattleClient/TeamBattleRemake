				...
				if (p_71516_2_[0].equals("remove"))
					return getListOfStringsMatchingLastWord(p_71516_2_,
							MinecraftServer.getServer()
									.getConfigurationManager().func_152598_l());

				if (p_71516_2_[0].equals("add"))
					return getListOfStringsMatchingLastWord(p_71516_2_,
							MinecraftServer.getServer().func_152358_ax()
									.func_152654_a());
			}
	...
	public void processCommand(ICommandSender p_71515_1_, String[] p_71515_2_) {
		if (p_71515_2_.length >= 1) {
			...
			if (p_71515_2_[0].equals("list")) {
				p_71515_1_.addChatMessage(new ChatComponentTranslation(
						"commands.whitelist.list", new Object[] {
								Integer.valueOf(var3.getConfigurationManager()
										.func_152598_l().length),
								Integer.valueOf(var3.getConfigurationManager()
										.getAvailablePlayerDat().length) }));
				final String[] var5 = var3.getConfigurationManager()
						.func_152598_l();
			...
			if (p_71515_2_[0].equals("remove")) {
				...
				var4 = var3.getConfigurationManager().func_152599_k()
						.func_152706_a(p_71515_2_[1]);
