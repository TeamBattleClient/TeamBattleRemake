...
public class CommandSummon extends CommandBase {
	...
	public void processCommand(ICommandSender p_71515_1_, String[] p_71515_2_) {
		if (p_71515_2_.length < 1)
			...
			double var4 = p_71515_1_.getPlayerCoordinates().posX + 0.5D;
			double var6 = p_71515_1_.getPlayerCoordinates().posY;
			double var8 = p_71515_1_.getPlayerCoordinates().posZ + 0.5D;
			...
			final World var10 = p_71515_1_.getEntityWorld();
			...
			if (!var10.blockExists((int) var4, (int) var6, (int) var8)) {
				...
				if (p_71515_2_.length >= 5) {
					final IChatComponent var13 = func_147178_a(p_71515_1_,
							p_71515_2_, 4);

					try {
						final NBTBase var14 = JsonToNBT.func_150315_a(var13
								.getUnformattedText());
						...
						var12 = true;
					} catch (final NBTException var17) {
						func_152373_a(p_71515_1_, this,
								"commands.summon.tagError",
				...
				final Entity var18 = EntityList.createEntityFromNBT(var11,
						var10);
				...
				if (var18 == null) {
					...
					var18.setLocationAndAngles(var4, var6, var8,
							var18.rotationYaw, var18.rotationPitch);
					...
					for (NBTTagCompound var15 = var11; var19 != null
							&& var15.func_150297_b("Riding", 10); var15 = var15
							.getCompoundTag("Riding")) {
						final Entity var16 = EntityList.createEntityFromNBT(
								var15.getCompoundTag("Riding"), var10);

						if (var16 != null) {
							var16.setLocationAndAngles(var4, var6, var8,
									var16.rotationYaw, var16.rotationPitch);
