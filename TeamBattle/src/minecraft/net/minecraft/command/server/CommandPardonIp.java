...
public class CommandPardonIp extends CommandBase {
	...
	public void processCommand(ICommandSender p_71515_1_, String[] p_71515_2_) {
		if (p_71515_2_.length == 1 && p_71515_2_[0].length() > 1) {
			final Matcher var3 = CommandBanIp.field_147211_a
					.matcher(p_71515_2_[0]);

			if (var3.matches()) {
				MinecraftServer.getServer().getConfigurationManager()
						.getBannedIPs().func_152684_c(p_71515_2_[0]);
				func_152373_a(p_71515_1_, this, "commands.unbanip.success",
