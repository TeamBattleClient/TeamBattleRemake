...
public class CommandGive extends CommandBase {
	...
	public List addTabCompletionOptions(ICommandSender p_71516_1_,
		...
		return p_71516_2_.length == 1 ? getListOfStringsMatchingLastWord(
				p_71516_2_, getPlayers())
				: p_71516_2_.length == 2 ? getListOfStringsFromIterableMatchingLastWord(
						p_71516_2_, Item.itemRegistry.getKeys()) : null;
	}
	...
	public void processCommand(ICommandSender p_71515_1_, String[] p_71515_2_) {
		if (p_71515_2_.length < 2)
			...
			final Item var4 = getItemByText(p_71515_1_, p_71515_2_[1]);
			int var5 = 1;
			int var6 = 0;
			...
			if (p_71515_2_.length >= 5) {
				final String var8 = func_147178_a(p_71515_1_, p_71515_2_, 4)
						.getUnformattedText();
			...
			final EntityItem var11 = var3.dropPlayerItemWithRandomChoice(var7,
					false);
			...
			func_152373_a(p_71515_1_, this, "commands.give.success",
					new Object[] { var7.func_151000_E(), Integer.valueOf(var5),
