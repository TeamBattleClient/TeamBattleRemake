	...
	public ContainerHopper(InventoryPlayer p_i1814_1_, IInventory p_i1814_2_) {
		...
		for (var4 = 0; var4 < 3; ++var4) {
			for (int var5 = 0; var5 < 9; ++var5) {
				addSlotToContainer(new Slot(p_i1814_1_, var5 + var4 * 9 + 9,
						8 + var5 * 18, var4 * 18 + var3));
			}
		}

		for (var4 = 0; var4 < 9; ++var4) {
			addSlotToContainer(new Slot(p_i1814_1_, var4, 8 + var4 * 18,
					58 + var3));
		}
	}
	...
	public ItemStack transferStackInSlot(EntityPlayer p_82846_1_, int p_82846_2_) {
		...
		if (var4 != null && var4.getHasStack()) {
			...
			if (p_82846_2_ < field_94538_a.getSizeInventory()) {
				if (!mergeItemStack(var5, field_94538_a.getSizeInventory(),
						inventorySlots.size(), true))
					return null;
			} else if (!mergeItemStack(var5, 0,
					field_94538_a.getSizeInventory(), false))
				return null;
