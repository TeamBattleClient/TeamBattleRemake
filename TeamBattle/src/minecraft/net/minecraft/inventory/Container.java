...
public abstract class Container {
			...
			for (int var3 = 0; var3 < p_94526_0_.getSizeInventory(); ++var3) {
				...
				if (var4 != null) {
					var2 += (float) var4.stackSize
							/ (float) Math.min(
									p_94526_0_.getInventoryStackLimit(),
	...
	public static void func_94525_a(Set p_94525_0_, int p_94525_1_,
			ItemStack p_94525_2_, int p_94525_3_) {
		switch (p_94525_1_) {
		case 0:
			p_94525_2_.stackSize = MathHelper
					.floor_float((float) p_94525_2_.stackSize
							/ (float) p_94525_0_.size());
			break;
	...
	public static boolean func_94527_a(Slot p_94527_0_, ItemStack p_94527_1_,
			boolean p_94527_2_) {
		boolean var3 = p_94527_0_ == null || !p_94527_0_.getHasStack();

		if (p_94527_0_ != null
				&& p_94527_0_.getHasStack()
				&& p_94527_1_ != null
				&& p_94527_1_.isItemEqual(p_94527_0_.getStack())
				&& ItemStack.areItemStackTagsEqual(p_94527_0_.getStack(),
						p_94527_1_)) {
			final int var10002 = p_94527_2_ ? 0 : p_94527_1_.stackSize;
			var3 |= p_94527_0_.getStack().stackSize + var10002 <= p_94527_1_
					.getMaxStackSize();
		}
	...
	public void detectAndSendChanges() {
		for (int var1 = 0; var1 < inventorySlots.size(); ++var1) {
			final ItemStack var2 = ((Slot) inventorySlots.get(var1)).getStack();
			...
			if (!ItemStack.areItemStacksEqual(var3, var2)) {
				...
				for (int var4 = 0; var4 < crafters.size(); ++var4) {
					((ICrafting) crafters.get(var4)).sendSlotContents(this,
							var1, var3);
				}
			}
		}
	...
	public Slot getSlotFromInventory(IInventory p_75147_1_, int p_75147_2_) {
		for (int var3 = 0; var3 < inventorySlots.size(); ++var3) {
			final Slot var4 = (Slot) inventorySlots.get(var3);
	 ...
	 */
	protected boolean mergeItemStack(ItemStack p_75135_1_, int p_75135_2_,
		...
		if (p_75135_1_.isStackable()) {
			while (p_75135_1_.stackSize > 0
					&& (!p_75135_4_ && var6 < p_75135_3_ || p_75135_4_
							&& var6 >= p_75135_2_)) {
				var7 = (Slot) inventorySlots.get(var6);
				var8 = var7.getStack();

				if (var8 != null
						&& var8.getItem() == p_75135_1_.getItem()
						&& (!p_75135_1_.getHasSubtypes() || p_75135_1_
								.getItemDamage() == var8.getItemDamage())
					...
					if (var9 <= p_75135_1_.getMaxStackSize()) {
						...
						p_75135_1_.stackSize -= p_75135_1_.getMaxStackSize()
								- var8.stackSize;
		...
		if (p_75135_1_.stackSize > 0) {
			...
			while (!p_75135_4_ && var6 < p_75135_3_ || p_75135_4_
					&& var6 >= p_75135_2_) {
				var7 = (Slot) inventorySlots.get(var6);
				var8 = var7.getStack();
	...
	public void onContainerClosed(EntityPlayer p_75134_1_) {
		...
		if (var2.getItemStack() != null) {
			p_75134_1_.dropPlayerItemWithRandomChoice(var2.getItemStack(),
					false);
	...
	public ItemStack slotClick(int p_75144_1_, int p_75144_2_, int p_75144_3_,
		...
		if (p_75144_3_ == 5) {
			...
			if ((var7 != 1 || field_94536_g != 2) && var7 != field_94536_g) {
				...
				final Slot var8 = (Slot) inventorySlots.get(p_75144_1_);

				if (var8 != null
						&& func_94527_a(var8, var6.getItemStack(), true)
						&& var8.isItemValid(var6.getItemStack())
						&& var6.getItemStack().stackSize > field_94537_h.size()
						&& canDragIntoSlot(var8)) {
				...
				if (!field_94537_h.isEmpty()) {
					...
					final Iterator var10 = field_94537_h.iterator();

					while (var10.hasNext()) {
						final Slot var11 = (Slot) var10.next();

						if (var11 != null
								&& func_94527_a(var11, var6.getItemStack(),
										true)
								&& var11.isItemValid(var6.getItemStack())
								&& var6.getItemStack().stackSize >= field_94537_h
										.size() && canDragIntoSlot(var11)) {
							final ItemStack var12 = var17.copy();
							final int var13 = var11.getHasStack() ? var11
									.getStack().stackSize : 0;
							func_94525_a(field_94537_h, field_94535_f, var12,
									var13);
			...
			if ((p_75144_3_ == 0 || p_75144_3_ == 1)
					&& (p_75144_2_ == 0 || p_75144_2_ == 1)) {
				if (p_75144_1_ == -999) {
					if (var6.getItemStack() != null && p_75144_1_ == -999) {
						if (p_75144_2_ == 0) {
							p_75144_4_.dropPlayerItemWithRandomChoice(
									var6.getItemStack(), true);
							var6.setItemStack((ItemStack) null);
						}

						if (p_75144_2_ == 1) {
							p_75144_4_.dropPlayerItemWithRandomChoice(var6
									.getItemStack().splitStack(1), true);
					...
					if (var16 != null && var16.canTakeStack(p_75144_4_)) {
						...
						if (var17 != null) {
							final Item var19 = var17.getItem();
							var5 = var17.copy();

							if (var16.getStack() != null
									&& var16.getStack().getItem() == var19) {
								retrySlotClick(p_75144_1_, p_75144_2_, true,
										p_75144_4_);
							}
						}
					}
					...
					if (var16 != null) {
						...
						final ItemStack var20 = var6.getItemStack();
						...
						if (var17 == null) {
							...
							if (var20 == null) {
								var21 = p_75144_2_ == 0 ? var17.stackSize
										: (var17.stackSize + 1) / 2;
								...
								var16.onPickupFromSlot(p_75144_4_,
										var6.getItemStack());
							} else if (var16.isItemValid(var20)) {
								if (var17.getItem() == var20.getItem()
										&& var17.getItemDamage() == var20
												.getItemDamage()
										&& ItemStack.areItemStackTagsEqual(
												var17, var20)) {
									var21 = p_75144_2_ == 0 ? var20.stackSize
											: 1;
									...
									if (var21 > var20.getMaxStackSize()
											- var17.stackSize) {
										var21 = var20.getMaxStackSize()
												- var17.stackSize;
									}
								...
								} else if (var20.stackSize <= var16
										.getSlotStackLimit()) {
									var16.putStack(var20);
									var6.setItemStack(var17);
								}
							} else if (var17.getItem() == var20.getItem()
									&& var20.getMaxStackSize() > 1
									&& (!var17.getHasSubtypes() || var17
											.getItemDamage() == var20
											.getItemDamage())
									&& ItemStack.areItemStackTagsEqual(var17,
											var20)) {
								var21 = var17.stackSize;

								if (var21 > 0
										&& var21 + var20.stackSize <= var20
												.getMaxStackSize()) {
				...
				if (var16.canTakeStack(p_75144_4_)) {
					...
					boolean var18 = var17 == null || var16.inventory == var6
							&& var16.isItemValid(var17);
					var21 = -1;
					...
					if (var16.getHasStack() && var18) {
						...
						if ((var16.inventory != var6 || !var16
								.isItemValid(var17)) && var17 != null) {
							if (var21 > -1) {
					...
					} else if (!var16.getHasStack() && var17 != null
							&& var16.isItemValid(var17)) {
						var6.setInventorySlotContents(p_75144_2_,
								(ItemStack) null);
						var16.putStack(var17);
					}
				}
			} else if (p_75144_3_ == 3
					&& p_75144_4_.capabilities.isCreativeMode
					&& var6.getItemStack() == null && p_75144_1_ >= 0) {
				var16 = (Slot) inventorySlots.get(p_75144_1_);
			...
			} else if (p_75144_3_ == 4 && var6.getItemStack() == null
					&& p_75144_1_ >= 0) {
				var16 = (Slot) inventorySlots.get(p_75144_1_);

				if (var16 != null && var16.getHasStack()
						&& var16.canTakeStack(p_75144_4_)) {
					var17 = var16.decrStackSize(p_75144_2_ == 0 ? 1 : var16
							.getStack().stackSize);
				...
				if (var17 != null
						&& (var16 == null || !var16.getHasStack() || !var16
								.canTakeStack(p_75144_4_))) {
					var9 = p_75144_2_ == 0 ? 0 : inventorySlots.size() - 1;
					var21 = p_75144_2_ == 0 ? 1 : -1;

					for (int var22 = 0; var22 < 2; ++var22) {
						for (int var24 = var9; var24 >= 0
								&& var24 < inventorySlots.size()
								&& var17.stackSize < var17.getMaxStackSize(); var24 += var21) {
							final Slot var25 = (Slot) inventorySlots.get(var24);

							if (var25.getHasStack()
									&& func_94527_a(var25, var17, true)
									&& var25.canTakeStack(p_75144_4_)
									&& func_94530_a(var17, var25)
									&& (var22 != 0 || var25.getStack().stackSize != var25
											.getStack().getMaxStackSize())) {
								final int var14 = Math.min(
										var17.getMaxStackSize()
												- var17.stackSize,
										var25.getStack().stackSize);
								final ItemStack var15 = var25
										.decrStackSize(var14);
