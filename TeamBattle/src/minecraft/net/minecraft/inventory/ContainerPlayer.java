...
public class ContainerPlayer extends Container {
	...
	public ContainerPlayer(final InventoryPlayer p_i1819_1_,
			boolean p_i1819_2_, EntityPlayer p_i1819_3_) {
		isLocalWorld = p_i1819_2_;
		thePlayer = p_i1819_3_;
		addSlotToContainer(new SlotCrafting(p_i1819_1_.player, craftMatrix,
		...
		for (var4 = 0; var4 < 2; ++var4) {
			for (var5 = 0; var5 < 2; ++var5) {
				addSlotToContainer(new Slot(craftMatrix, var5 + var4 * 2,
						88 + var5 * 18, 26 + var4 * 18));
			}
		}

		for (var4 = 0; var4 < 4; ++var4) {
			final int var44 = var4;
			addSlotToContainer(new Slot(p_i1819_1_,
					p_i1819_1_.getSizeInventory() - 1 - var4, 8, 8 + var4 * 18) {
				...
				public boolean isItemValid(ItemStack p_75214_1_) {
					return p_75214_1_ == null ? false
							: p_75214_1_.getItem() instanceof ItemArmor ? ((ItemArmor) p_75214_1_
									.getItem()).armorType == var44
									: p_75214_1_.getItem() != Item
											.getItemFromBlock(Blocks.pumpkin)
											&& p_75214_1_.getItem() != Items.skull ? false
											: var44 == 0;
				}
			});
		}
		...
		for (var4 = 0; var4 < 3; ++var4) {
			for (var5 = 0; var5 < 9; ++var5) {
				addSlotToContainer(new Slot(p_i1819_1_, var5 + (var4 + 1) * 9,
	...
	public void onCraftMatrixChanged(IInventory p_75130_1_) {
		craftResult.setInventorySlotContents(0, CraftingManager.getInstance()
				.findMatchingRecipe(craftMatrix, thePlayer.worldObj));
	}
		...
		if (var4 != null && var4.getHasStack()) {
			...
			if (p_82846_2_ == 0) {
				...
				if (!mergeItemStack(var5, 9, 45, false))
					...
					&& !((Slot) inventorySlots.get(5 + ((ItemArmor) var3
