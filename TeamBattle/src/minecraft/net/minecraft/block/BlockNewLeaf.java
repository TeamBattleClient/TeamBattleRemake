...
public class BlockNewLeaf extends BlockLeaves {
	public static final String[][] field_150132_N = new String[][] {
			{ "leaves_acacia", "leaves_big_oak" },
			{ "leaves_acacia_opaque", "leaves_big_oak_opaque" } };
	public static final String[] field_150133_O = new String[] { "acacia",
			"big_oak" };
	...
	public void registerBlockIcons(IIconRegister p_149651_1_) {
		for (int var2 = 0; var2 < field_150132_N.length; ++var2) {
			field_150129_M[var2] = new IIcon[field_150132_N[var2].length];

			for (int var3 = 0; var3 < field_150132_N[var2].length; ++var3) {
				field_150129_M[var2][var3] = p_149651_1_
						.registerIcon(field_150132_N[var2][var3]);
			}
		}
	}
}
