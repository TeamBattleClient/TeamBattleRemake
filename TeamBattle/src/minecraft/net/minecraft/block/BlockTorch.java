...
public class BlockTorch extends Block {
	...
	public boolean canPlaceBlockAt(World p_149742_1_, int p_149742_2_,
		...
		return p_149742_1_.isBlockNormalCubeDefault(p_149742_2_ - 1,
				p_149742_3_, p_149742_4_, true) ? true : p_149742_1_
				.isBlockNormalCubeDefault(p_149742_2_ + 1, p_149742_3_,
						p_149742_4_, true) ? true : p_149742_1_
				.isBlockNormalCubeDefault(p_149742_2_, p_149742_3_,
						p_149742_4_ - 1, true) ? true : p_149742_1_
				.isBlockNormalCubeDefault(p_149742_2_, p_149742_3_,
						p_149742_4_ + 1, true) ? true : func_150107_m(
	...
	public MovingObjectPosition collisionRayTrace(World p_149731_1_,
		...
		final int var7 = p_149731_1_.getBlockMetadata(p_149731_2_, p_149731_3_,
				p_149731_4_) & 7;
		float var8 = 0.15F;

		if (var7 == 1) {
			setBlockBounds(0.0F, 0.2F, 0.5F - var8, var8 * 2.0F, 0.8F,
					0.5F + var8);
		} else if (var7 == 2) {
			setBlockBounds(1.0F - var8 * 2.0F, 0.2F, 0.5F - var8, 1.0F, 0.8F,
					0.5F + var8);
		} else if (var7 == 3) {
			setBlockBounds(0.5F - var8, 0.2F, 0.0F, 0.5F + var8, 0.8F,
					var8 * 2.0F);
		} else if (var7 == 4) {
			setBlockBounds(0.5F - var8, 0.2F, 1.0F - var8 * 2.0F, 0.5F + var8,
					0.8F, 1.0F);
		} else {
			var8 = 0.1F;
			setBlockBounds(0.5F - var8, 0.0F, 0.5F - var8, 0.5F + var8, 0.6F,
					0.5F + var8);
		}
	...
	private boolean func_150107_m(World p_150107_1_, int p_150107_2_,
		...
		if (World.doesBlockHaveSolidTopSurface(p_150107_1_, p_150107_2_,
			...
			final Block var5 = p_150107_1_.getBlock(p_150107_2_, p_150107_3_,
					p_150107_4_);
			return var5 == Blocks.fence || var5 == Blocks.nether_brick_fence
					|| var5 == Blocks.glass || var5 == Blocks.cobblestone_wall;
		}
	}
	...
	protected boolean func_150108_b(World p_150108_1_, int p_150108_2_,
		...
		if (func_150109_e(p_150108_1_, p_150108_2_, p_150108_3_, p_150108_4_)) {
			final int var6 = p_150108_1_.getBlockMetadata(p_150108_2_,
					p_150108_3_, p_150108_4_);
			boolean var7 = false;

			if (!p_150108_1_.isBlockNormalCubeDefault(p_150108_2_ - 1,
					p_150108_3_, p_150108_4_, true) && var6 == 1) {
				var7 = true;
			}

			if (!p_150108_1_.isBlockNormalCubeDefault(p_150108_2_ + 1,
					p_150108_3_, p_150108_4_, true) && var6 == 2) {
				var7 = true;
			}

			if (!p_150108_1_.isBlockNormalCubeDefault(p_150108_2_, p_150108_3_,
					p_150108_4_ - 1, true) && var6 == 3) {
				var7 = true;
			}

			if (!p_150108_1_.isBlockNormalCubeDefault(p_150108_2_, p_150108_3_,
					p_150108_4_ + 1, true) && var6 == 4) {
				var7 = true;
			}

			if (!func_150107_m(p_150108_1_, p_150108_2_, p_150108_3_ - 1,
					p_150108_4_) && var6 == 5) {
				var7 = true;
			}

			if (var7) {
				dropBlockAsItem(p_150108_1_, p_150108_2_, p_150108_3_,
	...
	protected boolean func_150109_e(World p_150109_1_, int p_150109_2_,
		...
		if (!canPlaceBlockAt(p_150109_1_, p_150109_2_, p_150109_3_, p_150109_4_)) {
			if (p_150109_1_.getBlock(p_150109_2_, p_150109_3_, p_150109_4_) == this) {
				dropBlockAsItem(p_150109_1_, p_150109_2_, p_150109_3_,
	...
	public void onBlockAdded(World p_149726_1_, int p_149726_2_,
		...
		if (p_149726_1_.getBlockMetadata(p_149726_2_, p_149726_3_, p_149726_4_) == 0) {
			if (p_149726_1_.isBlockNormalCubeDefault(p_149726_2_ - 1,
					p_149726_3_, p_149726_4_, true)) {
				p_149726_1_.setBlockMetadataWithNotify(p_149726_2_,
						p_149726_3_, p_149726_4_, 1, 2);
			} else if (p_149726_1_.isBlockNormalCubeDefault(p_149726_2_ + 1,
					p_149726_3_, p_149726_4_, true)) {
				p_149726_1_.setBlockMetadataWithNotify(p_149726_2_,
						p_149726_3_, p_149726_4_, 2, 2);
			} else if (p_149726_1_.isBlockNormalCubeDefault(p_149726_2_,
					p_149726_3_, p_149726_4_ - 1, true)) {
				p_149726_1_.setBlockMetadataWithNotify(p_149726_2_,
			...
			} else if (func_150107_m(p_149726_1_, p_149726_2_, p_149726_3_ - 1,
					p_149726_4_)) {
				p_149726_1_.setBlockMetadataWithNotify(p_149726_2_,
	...
	public int onBlockPlaced(World p_149660_1_, int p_149660_2_,
		...
		if (p_149660_5_ == 1
				&& func_150107_m(p_149660_1_, p_149660_2_, p_149660_3_ - 1,
						p_149660_4_)) {
			var10 = 5;
		}
	...
	public void onNeighborBlockChange(World p_149695_1_, int p_149695_2_,
		...
		func_150108_b(p_149695_1_, p_149695_2_, p_149695_3_, p_149695_4_,
				p_149695_5_);
	}
	...
	public void randomDisplayTick(World p_149734_1_, int p_149734_2_,
		...
		if (var6 == 1) {
			p_149734_1_.spawnParticle("smoke", var7 - var15, var9 + var13,
					var11, 0.0D, 0.0D, 0.0D);
			p_149734_1_.spawnParticle("flame", var7 - var15, var9 + var13,
					var11, 0.0D, 0.0D, 0.0D);
		} else if (var6 == 2) {
			p_149734_1_.spawnParticle("smoke", var7 + var15, var9 + var13,
					var11, 0.0D, 0.0D, 0.0D);
			...
			p_149734_1_.spawnParticle("smoke", var7, var9 + var13, var11
					- var15, 0.0D, 0.0D, 0.0D);
			p_149734_1_.spawnParticle("flame", var7, var9 + var13, var11
					- var15, 0.0D, 0.0D, 0.0D);
		} else if (var6 == 4) {
			p_149734_1_.spawnParticle("smoke", var7, var9 + var13, var11
					+ var15, 0.0D, 0.0D, 0.0D);
			...
			p_149734_1_.spawnParticle("smoke", var7, var9, var11, 0.0D, 0.0D,
					0.0D);
			p_149734_1_.spawnParticle("flame", var7, var9, var11, 0.0D, 0.0D,
					0.0D);
		}
	}
