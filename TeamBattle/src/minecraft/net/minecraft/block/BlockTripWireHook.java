...
public class BlockTripWireHook extends Block {
	...
	public void breakBlock(World p_149749_1_, int p_149749_2_, int p_149749_3_,
		...
		final boolean var7 = (p_149749_6_ & 4) == 4;
		final boolean var8 = (p_149749_6_ & 8) == 8;

		if (var7 || var8) {
			func_150136_a(p_149749_1_, p_149749_2_, p_149749_3_, p_149749_4_,
					true, p_149749_6_, false, -1, 0);
		}

		if (var8) {
			p_149749_1_.notifyBlocksOfNeighborChange(p_149749_2_, p_149749_3_,
					p_149749_4_, this);
			final int var9 = p_149749_6_ & 3;
	...
	private void func_150134_a(World p_150134_1_, int p_150134_2_,
			int p_150134_3_, int p_150134_4_, int p_150134_5_) {
		p_150134_1_.notifyBlocksOfNeighborChange(p_150134_2_, p_150134_3_,
				p_150134_4_, this);

		if (p_150134_5_ == 3) {
			p_150134_1_.notifyBlocksOfNeighborChange(p_150134_2_ - 1,
					p_150134_3_, p_150134_4_, this);
	...
	private void func_150135_a(World p_150135_1_, int p_150135_2_,
			int p_150135_3_, int p_150135_4_, boolean p_150135_5_,
			boolean p_150135_6_, boolean p_150135_7_, boolean p_150135_8_) {
		if (p_150135_6_ && !p_150135_8_) {
			p_150135_1_.playSoundEffect(p_150135_2_ + 0.5D, p_150135_3_ + 0.1D,
					p_150135_4_ + 0.5D, "random.click", 0.4F, 0.6F);
		} else if (!p_150135_6_ && p_150135_8_) {
			p_150135_1_.playSoundEffect(p_150135_2_ + 0.5D, p_150135_3_ + 0.1D,
					p_150135_4_ + 0.5D, "random.click", 0.4F, 0.5F);
		} else if (p_150135_5_ && !p_150135_7_) {
			p_150135_1_.playSoundEffect(p_150135_2_ + 0.5D, p_150135_3_ + 0.1D,
					p_150135_4_ + 0.5D, "random.click", 0.4F, 0.7F);
		} else if (!p_150135_5_ && p_150135_7_) {
			p_150135_1_.playSoundEffect(p_150135_2_ + 0.5D, p_150135_3_ + 0.1D,
					p_150135_4_ + 0.5D, "random.bowhit", 0.4F,
					1.2F / (p_150135_1_.rand.nextFloat() * 0.2F + 0.9F));
		}
	}

	public void func_150136_a(World p_150136_1_, int p_150136_2_,
			int p_150136_3_, int p_150136_4_, boolean p_150136_5_,
			int p_150136_6_, boolean p_150136_7_, int p_150136_8_,
			int p_150136_9_) {
		final int var10 = p_150136_6_ & 3;
		final boolean var11 = (p_150136_6_ & 4) == 4;
		final boolean var12 = (p_150136_6_ & 8) == 8;
		boolean var13 = !p_150136_5_;
		boolean var14 = false;
		final boolean var15 = !World.doesBlockHaveSolidTopSurface(p_150136_1_,
				p_150136_2_, p_150136_3_ - 1, p_150136_4_);
		...
		for (var20 = 1; var20 < 42; ++var20) {
			...
			if (var23 != Blocks.tripwire && var20 != p_150136_8_) {
				...
				var24 = var20 == p_150136_8_ ? p_150136_9_ : p_150136_1_
						.getBlockMetadata(var21, p_150136_3_, var22);
				final boolean var25 = (var24 & 8) != 8;
				final boolean var26 = (var24 & 1) == 1;
				final boolean var27 = (var24 & 2) == 2;
				var13 &= var27 == var15;
				var14 |= var25 && var26;
				var19[var20] = var24;

				if (var20 == p_150136_8_) {
					p_150136_1_.scheduleBlockUpdate(p_150136_2_, p_150136_3_,
							p_150136_4_, this, func_149738_a(p_150136_1_));
					var13 &= var25;
				}
			}
		}
		...
		if (var18 > 0) {
			...
			p_150136_1_.setBlockMetadataWithNotify(var21, p_150136_3_, var22,
					var28 | var20, 3);
			func_150134_a(p_150136_1_, var21, p_150136_3_, var22, var28);
			func_150135_a(p_150136_1_, var21, p_150136_3_, var22, var13, var14,
					var11, var12);
		}

		func_150135_a(p_150136_1_, p_150136_2_, p_150136_3_, p_150136_4_,
				var13, var14, var11, var12);

		if (!p_150136_5_) {
			p_150136_1_.setBlockMetadataWithNotify(p_150136_2_, p_150136_3_,
					p_150136_4_, p_150136_6_, 3);

			if (p_150136_7_) {
				func_150134_a(p_150136_1_, p_150136_2_, p_150136_3_,
						p_150136_4_, var10);
			}
		}
		...
		if (var11 != var13) {
			for (var21 = 1; var21 < var18; ++var21) {
				...
				if (var24 >= 0) {
					...
					p_150136_1_.setBlockMetadataWithNotify(var22, p_150136_3_,
							var28, var24, 3);
				}
			}
		}
	...
	private boolean func_150137_e(World p_150137_1_, int p_150137_2_,
			int p_150137_3_, int p_150137_4_) {
		if (!canPlaceBlockAt(p_150137_1_, p_150137_2_, p_150137_3_, p_150137_4_)) {
			dropBlockAsItem(p_150137_1_, p_150137_2_, p_150137_3_, p_150137_4_,
					p_150137_1_.getBlockMetadata(p_150137_2_, p_150137_3_,
							p_150137_4_), 0);
	...
	public int isProvidingStrongPower(IBlockAccess p_149748_1_,
		...
		if ((var6 & 8) != 8)
			...
			return var7 == 2 && p_149748_5_ == 2 ? 15 : var7 == 0
					&& p_149748_5_ == 3 ? 15
					: var7 == 1 && p_149748_5_ == 4 ? 15 : var7 == 3
							&& p_149748_5_ == 5 ? 15 : 0;
		}
	}
	...
	public int onBlockPlaced(World p_149660_1_, int p_149660_2_,
		...
		if (p_149660_5_ == 2
				&& p_149660_1_.isBlockNormalCubeDefault(p_149660_2_,
						p_149660_3_, p_149660_4_ + 1, true)) {
			var10 = 2;
		}
		...
		if (p_149660_5_ == 4
				&& p_149660_1_.isBlockNormalCubeDefault(p_149660_2_ + 1,
						p_149660_3_, p_149660_4_, true)) {
			var10 = 1;
		}
	...
	public void onNeighborBlockChange(World p_149695_1_, int p_149695_2_,
		...
		if (p_149695_5_ != this) {
			if (func_150137_e(p_149695_1_, p_149695_2_, p_149695_3_,
					p_149695_4_)) {
				...
				if (!p_149695_1_.getBlock(p_149695_2_ - 1, p_149695_3_,
				...
				if (var8) {
					dropBlockAsItem(p_149695_1_, p_149695_2_, p_149695_3_,
							p_149695_4_, var6, 0);
					p_149695_1_.setBlockToAir(p_149695_2_, p_149695_3_,
							p_149695_4_);
				}
			}
		}
	...
	public void onPostBlockPlaced(World p_149714_1_, int p_149714_2_,
		...
		func_150136_a(p_149714_1_, p_149714_2_, p_149714_3_, p_149714_4_,
				false, p_149714_5_, false, -1, 0);
	}
	...
	public void updateTick(World p_149674_1_, int p_149674_2_, int p_149674_3_,
		...
		func_150136_a(p_149674_1_, p_149674_2_, p_149674_3_, p_149674_4_,
				false, p_149674_1_.getBlockMetadata(p_149674_2_, p_149674_3_,
						p_149674_4_), true, -1, 0);
	}
}
