...
public class BlockHugeMushroom extends Block {
	...
	public IIcon getIcon(int p_149691_1_, int p_149691_2_) {
		return p_149691_2_ == 10 && p_149691_1_ > 1 ? field_149795_N
				: p_149691_2_ >= 1 && p_149691_2_ <= 9 && p_149691_1_ == 1 ? field_149794_M[field_149792_b]
						: p_149691_2_ >= 1 && p_149691_2_ <= 3
								&& p_149691_1_ == 2 ? field_149794_M[field_149792_b]
								: p_149691_2_ >= 7 && p_149691_2_ <= 9
										&& p_149691_1_ == 3 ? field_149794_M[field_149792_b]
										: (p_149691_2_ == 1 || p_149691_2_ == 4 || p_149691_2_ == 7)
												&& p_149691_1_ == 4 ? field_149794_M[field_149792_b]
												: (p_149691_2_ == 3
														|| p_149691_2_ == 6 || p_149691_2_ == 9)
														&& p_149691_1_ == 5 ? field_149794_M[field_149792_b]
	...
	public void registerBlockIcons(IIconRegister p_149651_1_) {
		...
		for (int var2 = 0; var2 < field_149794_M.length; ++var2) {
			field_149794_M[var2] = p_149651_1_.registerIcon(getTextureName()
					+ "_" + field_149793_a[var2]);
		}

		field_149796_O = p_149651_1_.registerIcon(getTextureName() + "_"
				+ "inside");
		field_149795_N = p_149651_1_.registerIcon(getTextureName() + "_"
				+ "skin_stem");
	}
}
