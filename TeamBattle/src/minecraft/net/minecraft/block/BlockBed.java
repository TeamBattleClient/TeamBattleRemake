...
public class BlockBed extends BlockDirectional {
	...
	public static ChunkCoordinates func_149977_a(World p_149977_0_,
		...
		final int var5 = p_149977_0_.getBlockMetadata(p_149977_1_, p_149977_2_,
				p_149977_3_);
		final int var6 = BlockDirectional.func_149895_l(var5);

		for (int var7 = 0; var7 <= 1; ++var7) {
			final int var8 = p_149977_1_ - field_149981_a[var6][0] * var7 - 1;
			final int var9 = p_149977_3_ - field_149981_a[var6][1] * var7 - 1;
			final int var10 = var8 + 2;
			final int var11 = var9 + 2;

			for (int var12 = var8; var12 <= var10; ++var12) {
				for (int var13 = var9; var13 <= var11; ++var13) {
					if (World.doesBlockHaveSolidTopSurface(p_149977_0_, var12,
							p_149977_2_ - 1, var13)
							&& !p_149977_0_.getBlock(var12, p_149977_2_, var13)
									.getMaterial().isOpaque()
							&& !p_149977_0_
									.getBlock(var12, p_149977_2_ + 1, var13)
									.getMaterial().isOpaque()) {
						if (p_149977_4_ <= 0)
							return new ChunkCoordinates(var12, p_149977_2_,
									var13);
	...
	public static void func_149979_a(World p_149979_0_, int p_149979_1_,
		...
		int var5 = p_149979_0_.getBlockMetadata(p_149979_1_, p_149979_2_,
				p_149979_3_);
	...
	public IIcon getIcon(int p_149691_1_, int p_149691_2_) {
		if (p_149691_1_ == 0)
			...
			final int var3 = func_149895_l(p_149691_2_);
			...
			return (var5 != 1 || var4 != 2) && (var5 != 0 || var4 != 3) ? var4 != 5
					&& var4 != 4 ? field_149983_N[var5] : field_149982_M[var5]
					: field_149980_b[var5];
		}
	}
	...
	public boolean onBlockActivated(World p_149727_1_, int p_149727_2_,
		...
		if (p_149727_1_.isClient)
			...
			if (!func_149975_b(var10)) {
				final int var11 = func_149895_l(var10);
				...
				var10 = p_149727_1_.getBlockMetadata(p_149727_2_, p_149727_3_,
						p_149727_4_);
			}
			...
			if (p_149727_1_.provider.canRespawnHere()
				...
				if (func_149976_c(var10)) {
					...
					final Iterator var12 = p_149727_1_.playerEntities
							.iterator();
					...
					while (var12.hasNext()) {
						...
						if (var21.isPlayerSleeping()) {
							...
							if (var14.posX == p_149727_2_
									&& var14.posY == p_149727_3_
									&& var14.posZ == p_149727_4_) {
								var19 = var21;
							}
						}
					}
				...
				final EntityPlayer.EnumStatus var20 = p_149727_5_.sleepInBedAt(
				...
				final int var17 = func_149895_l(var10);
	...
	public void onBlockHarvested(World p_149681_1_, int p_149681_2_,
		...
		if (p_149681_6_.capabilities.isCreativeMode
				&& func_149975_b(p_149681_5_)) {
			final int var7 = func_149895_l(p_149681_5_);
	...
	public void onNeighborBlockChange(World p_149695_1_, int p_149695_2_,
		...
		if (func_149975_b(var6)) {
			if (p_149695_1_.getBlock(p_149695_2_ - field_149981_a[var7][0],
					p_149695_3_, p_149695_4_ - field_149981_a[var7][1]) != this) {
				p_149695_1_
						.setBlockToAir(p_149695_2_, p_149695_3_, p_149695_4_);
			}
		} else if (p_149695_1_.getBlock(p_149695_2_ + field_149981_a[var7][0],
				p_149695_3_, p_149695_4_ + field_149981_a[var7][1]) != this) {
	...
	public void registerBlockIcons(IIconRegister p_149651_1_) {
		field_149983_N = new IIcon[] {
				p_149651_1_.registerIcon(getTextureName() + "_feet_top"),
				p_149651_1_.registerIcon(getTextureName() + "_head_top") };
		field_149980_b = new IIcon[] {
				p_149651_1_.registerIcon(getTextureName() + "_feet_end"),
				p_149651_1_.registerIcon(getTextureName() + "_head_end") };
		field_149982_M = new IIcon[] {
				p_149651_1_.registerIcon(getTextureName() + "_feet_side"),
