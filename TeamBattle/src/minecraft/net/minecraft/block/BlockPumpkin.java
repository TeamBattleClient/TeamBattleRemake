...
public class BlockPumpkin extends BlockDirectional {
	...
	public IIcon getIcon(int p_149691_1_, int p_149691_2_) {
		return p_149691_1_ == 1 ? field_149984_b
				: p_149691_1_ == 0 ? field_149984_b : p_149691_2_ == 2
						&& p_149691_1_ == 2 ? field_149986_M : p_149691_2_ == 3
						&& p_149691_1_ == 5 ? field_149986_M : p_149691_2_ == 0
						&& p_149691_1_ == 3 ? field_149986_M : p_149691_2_ == 1
						&& p_149691_1_ == 4 ? field_149986_M : blockIcon;
	}
	...
	public void onBlockAdded(World p_149726_1_, int p_149726_2_,
		...
		if (p_149726_1_.getBlock(p_149726_2_, p_149726_3_ - 1, p_149726_4_) == Blocks.snow
			...
			if (!p_149726_1_.isClient) {
				...
				var9.setLocationAndAngles(p_149726_2_ + 0.5D,
			...
			for (int var10 = 0; var10 < 120; ++var10) {
				p_149726_1_.spawnParticle("snowshovel", p_149726_2_
						+ p_149726_1_.rand.nextDouble(), p_149726_3_ - 2
						+ p_149726_1_.rand.nextDouble() * 2.5D, p_149726_4_
						+ p_149726_1_.rand.nextDouble(), 0.0D, 0.0D, 0.0D);
			}
		} else if (p_149726_1_.getBlock(p_149726_2_, p_149726_3_ - 1,
				p_149726_4_) == Blocks.iron_block
				&& p_149726_1_.getBlock(p_149726_2_, p_149726_3_ - 2,
						p_149726_4_) == Blocks.iron_block) {
			final boolean var5 = p_149726_1_.getBlock(p_149726_2_ - 1,
					p_149726_3_ - 1, p_149726_4_) == Blocks.iron_block
					&& p_149726_1_.getBlock(p_149726_2_ + 1, p_149726_3_ - 1,
							p_149726_4_) == Blocks.iron_block;
			final boolean var6 = p_149726_1_.getBlock(p_149726_2_,
					p_149726_3_ - 1, p_149726_4_ - 1) == Blocks.iron_block
					&& p_149726_1_.getBlock(p_149726_2_, p_149726_3_ - 1,
							p_149726_4_ + 1) == Blocks.iron_block;
			...
			if (var5 || var6) {
				...
				final EntityIronGolem var7 = new EntityIronGolem(p_149726_1_);
				var7.setPlayerCreated(true);
				var7.setLocationAndAngles(p_149726_2_ + 0.5D,
						p_149726_3_ - 1.95D, p_149726_4_ + 0.5D, 0.0F, 0.0F);
	...
	public void registerBlockIcons(IIconRegister p_149651_1_) {
		field_149986_M = p_149651_1_.registerIcon(getTextureName() + "_face_"
				+ (field_149985_a ? "on" : "off"));
