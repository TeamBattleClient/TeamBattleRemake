...
public class BlockDragonEgg extends Block {
	...
	private void func_150018_e(World p_150018_1_, int p_150018_2_,
		...
		if (BlockFalling.func_149831_e(p_150018_1_, p_150018_2_,
			...
			if (!BlockFalling.field_149832_M
					&& p_150018_1_.checkChunksExist(p_150018_2_ - var5,
							p_150018_3_ - var5, p_150018_4_ - var5, p_150018_2_
									+ var5, p_150018_3_ + var5, p_150018_4_
									+ var5)) {
				final EntityFallingBlock var6 = new EntityFallingBlock(
	...
	private void func_150019_m(World p_150019_1_, int p_150019_2_,
			int p_150019_3_, int p_150019_4_) {
		if (p_150019_1_.getBlock(p_150019_2_, p_150019_3_, p_150019_4_) == this) {
			for (int var5 = 0; var5 < 1000; ++var5) {
				final int var6 = p_150019_2_ + p_150019_1_.rand.nextInt(16)
						- p_150019_1_.rand.nextInt(16);
				final int var7 = p_150019_3_ + p_150019_1_.rand.nextInt(8)
						- p_150019_1_.rand.nextInt(8);
				final int var8 = p_150019_4_ + p_150019_1_.rand.nextInt(16)
						- p_150019_1_.rand.nextInt(16);
				...
				if (p_150019_1_.getBlock(var6, var7, var8).blockMaterial == Material.air) {
					if (!p_150019_1_.isClient) {
						p_150019_1_.setBlock(var6, var7, var8, this,
								p_150019_1_.getBlockMetadata(p_150019_2_,
										p_150019_3_, p_150019_4_), 2);
						p_150019_1_.setBlockToAir(p_150019_2_, p_150019_3_,
								p_150019_4_);
					} else {
						...
						for (int var10 = 0; var10 < var9; ++var10) {
							...
							final float var15 = (p_150019_1_.rand.nextFloat() - 0.5F) * 0.2F;
							final double var16 = var6 + (p_150019_2_ - var6)
									* var11
									+ (p_150019_1_.rand.nextDouble() - 0.5D)
									* 1.0D + 0.5D;
							final double var18 = var7 + (p_150019_3_ - var7)
									* var11 + p_150019_1_.rand.nextDouble()
									* 1.0D - 0.5D;
							final double var20 = var8 + (p_150019_4_ - var8)
									* var11
									+ (p_150019_1_.rand.nextDouble() - 0.5D)
									* 1.0D + 0.5D;
							p_150019_1_.spawnParticle("portal", var16, var18,
