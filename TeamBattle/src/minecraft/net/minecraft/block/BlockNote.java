...
public class BlockNote extends BlockContainer {
	...
	public boolean onBlockActivated(World p_149727_1_, int p_149727_2_,
		...
		if (p_149727_1_.isClient)
			...
			final TileEntityNote var10 = (TileEntityNote) p_149727_1_
					.getTileEntity(p_149727_2_, p_149727_3_, p_149727_4_);

			if (var10 != null) {
				var10.func_145877_a();
				var10.func_145878_a(p_149727_1_, p_149727_2_, p_149727_3_,
						p_149727_4_);
			}
	...
	public void onBlockClicked(World p_149699_1_, int p_149699_2_,
		...
		if (!p_149699_1_.isClient) {
			final TileEntityNote var6 = (TileEntityNote) p_149699_1_
					.getTileEntity(p_149699_2_, p_149699_3_, p_149699_4_);

			if (var6 != null) {
				var6.func_145878_a(p_149699_1_, p_149699_2_, p_149699_3_,
						p_149699_4_);
			}
		}
	}
	...
	public boolean onBlockEventReceived(World p_149696_1_, int p_149696_2_,
		...
		final float var7 = (float) Math.pow(2.0D, (p_149696_6_ - 12) / 12.0D);
		String var8 = "harp";
		...
		p_149696_1_.playSoundEffect(p_149696_2_ + 0.5D, p_149696_3_ + 0.5D,
				p_149696_4_ + 0.5D, "note." + var8, 3.0F, var7);
		p_149696_1_.spawnParticle("note", p_149696_2_ + 0.5D,
				p_149696_3_ + 1.2D, p_149696_4_ + 0.5D, p_149696_6_ / 24.0D,
				0.0D, 0.0D);
		return true;
	}
	...
	public void onNeighborBlockChange(World p_149695_1_, int p_149695_2_,
		...
		final TileEntityNote var7 = (TileEntityNote) p_149695_1_.getTileEntity(
				p_149695_2_, p_149695_3_, p_149695_4_);

		if (var7 != null && var7.field_145880_i != var6) {
			if (var6) {
				var7.func_145878_a(p_149695_1_, p_149695_2_, p_149695_3_,
						p_149695_4_);
			}
