...
public class BlockOre extends Block {
	...
	public void dropBlockAsItemWithChance(World p_149690_1_, int p_149690_2_,
		...
		if (getItemDropped(p_149690_5_, p_149690_1_.rand, p_149690_7_) != Item
			...
			if (this == Blocks.coal_ore) {
				var8 = MathHelper.getRandomIntegerInRange(p_149690_1_.rand, 0,
						2);
			} else if (this == Blocks.diamond_ore) {
				var8 = MathHelper.getRandomIntegerInRange(p_149690_1_.rand, 3,
						7);
			} else if (this == Blocks.emerald_ore) {
				var8 = MathHelper.getRandomIntegerInRange(p_149690_1_.rand, 3,
						7);
			} else if (this == Blocks.lapis_ore) {
				var8 = MathHelper.getRandomIntegerInRange(p_149690_1_.rand, 2,
						5);
	...
	public int quantityDroppedWithBonus(int p_149679_1_, Random p_149679_2_) {
		if (p_149679_1_ > 0
				&& Item.getItemFromBlock(this) != getItemDropped(0,
						p_149679_2_, p_149679_1_)) {
