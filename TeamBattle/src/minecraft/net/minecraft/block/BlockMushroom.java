...
public class BlockMushroom extends BlockBush implements IGrowable {
	...
	public boolean canBlockStay(World p_149718_1_, int p_149718_2_,
		...
		if (p_149718_3_ >= 0 && p_149718_3_ < 256) {
			...
			return var5 == Blocks.mycelium
					|| var5 == Blocks.dirt
					&& p_149718_1_.getBlockMetadata(p_149718_2_,
							p_149718_3_ - 1, p_149718_4_) == 2
					|| p_149718_1_.getFullBlockLightValue(p_149718_2_,
							p_149718_3_, p_149718_4_) < 13
					&& func_149854_a(var5);
		} else
			return false;
	}
	...
	public void func_149853_b(World p_149853_1_, Random p_149853_2_,
		...
		func_149884_c(p_149853_1_, p_149853_3_, p_149853_4_, p_149853_5_,
				p_149853_2_);
	}
	...
	public boolean func_149884_c(World p_149884_1_, int p_149884_2_,
			int p_149884_3_, int p_149884_4_, Random p_149884_5_) {
		final int var6 = p_149884_1_.getBlockMetadata(p_149884_2_, p_149884_3_,
				p_149884_4_);
		...
		if (var7 != null
				&& var7.generate(p_149884_1_, p_149884_5_, p_149884_2_,
						p_149884_3_, p_149884_4_))
			return true;
		else {
			p_149884_1_.setBlock(p_149884_2_, p_149884_3_, p_149884_4_, this,
					var6, 3);
			return false;
		}
	}
	...
	public void updateTick(World p_149674_1_, int p_149674_2_, int p_149674_3_,
		...
		if (p_149674_5_.nextInt(25) == 0) {
			...
			var9 = p_149674_3_ + p_149674_5_.nextInt(2)
					- p_149674_5_.nextInt(2);
			var10 = p_149674_4_ + p_149674_5_.nextInt(3) - 1;

			for (int var11 = 0; var11 < 4; ++var11) {
				if (p_149674_1_.isAirBlock(var8, var9, var10)
						&& canBlockStay(p_149674_1_, var8, var9, var10)) {
					p_149674_2_ = var8;
					p_149674_3_ = var9;
					p_149674_4_ = var10;
				}
