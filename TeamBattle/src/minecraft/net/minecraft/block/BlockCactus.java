...
public class BlockCactus extends Block {
	...
	public boolean canBlockStay(World p_149718_1_, int p_149718_2_,
		...
		if (p_149718_1_.getBlock(p_149718_2_ - 1, p_149718_3_, p_149718_4_)
			...
			final Block var5 = p_149718_1_.getBlock(p_149718_2_,
	...
	public AxisAlignedBB getCollisionBoundingBoxFromPool(World p_149668_1_,
		...
		return AxisAlignedBB.getBoundingBox(p_149668_2_ + var5, p_149668_3_,
				p_149668_4_ + var5, p_149668_2_ + 1 - var5, p_149668_3_ + 1
						- var5, p_149668_4_ + 1 - var5);
	}
	...
	public IIcon getIcon(int p_149691_1_, int p_149691_2_) {
		return p_149691_1_ == 1 ? field_150041_a
				: p_149691_1_ == 0 ? field_150040_b : blockIcon;
	}
	...
	public AxisAlignedBB getSelectedBoundingBoxFromPool(World p_149633_1_,
		...
		final float var5 = 0.0F;
		return AxisAlignedBB.getBoundingBox(p_149633_2_ + var5, p_149633_3_,
				p_149633_4_ + var5, p_149633_2_ + 1 - var5, p_149633_3_ + 1,
				p_149633_4_ + 1 - var5);
	}
	...
	public void registerBlockIcons(IIconRegister p_149651_1_) {
		...
		field_150041_a = p_149651_1_.registerIcon(getTextureName() + "_top");
		field_150040_b = p_149651_1_.registerIcon(getTextureName() + "_bottom");
	}
	...
	public void updateTick(World p_149674_1_, int p_149674_2_, int p_149674_3_,
		...
		if (p_149674_1_.isAirBlock(p_149674_2_, p_149674_3_ + 1, p_149674_4_)) {
			...
			for (var6 = 1; p_149674_1_.getBlock(p_149674_2_,
					p_149674_3_ - var6, p_149674_4_) == this; ++var6) {
				;
			}
			...
			if (var6 < 3) {
				...
				if (var7 == 15) {
					...
					onNeighborBlockChange(p_149674_1_, p_149674_2_,
