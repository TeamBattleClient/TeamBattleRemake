...
public class BlockIce extends BlockBreakable {
	...
	public void harvestBlock(World p_149636_1_, EntityPlayer p_149636_2_,
		...
		if (canSilkHarvest()
			...
			final ItemStack var9 = createStackedBlock(p_149636_6_);
			...
			if (p_149636_1_.provider.isHellWorld) {
				p_149636_1_
						.setBlockToAir(p_149636_3_, p_149636_4_, p_149636_5_);
				return;
			}
			...
			dropBlockAsItem(p_149636_1_, p_149636_3_, p_149636_4_, p_149636_5_,
					p_149636_6_, var7);
			final Material var8 = p_149636_1_.getBlock(p_149636_3_,
					p_149636_4_ - 1, p_149636_5_).getMaterial();

			if (var8.blocksMovement() || var8.isLiquid()) {
				p_149636_1_.setBlock(p_149636_3_, p_149636_4_, p_149636_5_,
	...
	public boolean shouldSideBeRendered(IBlockAccess p_149646_1_,
		...
		return super.shouldSideBeRendered(p_149646_1_, p_149646_2_,
				p_149646_3_, p_149646_4_, 1 - p_149646_5_);
	}
	...
	public void updateTick(World p_149674_1_, int p_149674_2_, int p_149674_3_,
		...
		if (p_149674_1_.getSavedLightValue(EnumSkyBlock.Block, p_149674_2_,
				p_149674_3_, p_149674_4_) > 11 - getLightOpacity()) {
