...
public class BlockQuartz extends Block {
	...
	public IIcon getIcon(int p_149691_1_, int p_149691_2_) {
		if (p_149691_2_ != 2 && p_149691_2_ != 3 && p_149691_2_ != 4) {
			...
			return p_149691_2_ == 2 && (p_149691_1_ == 1 || p_149691_1_ == 0) ? field_150194_O
					: p_149691_2_ == 3
							&& (p_149691_1_ == 5 || p_149691_1_ == 4) ? field_150194_O
							: p_149691_2_ == 4
									&& (p_149691_1_ == 2 || p_149691_1_ == 3) ? field_150194_O
	...
	public void registerBlockIcons(IIconRegister p_149651_1_) {
		...
		for (int var2 = 0; var2 < field_150192_M.length; ++var2) {
			if (field_150189_b[var2] == null) {
				field_150192_M[var2] = field_150192_M[var2 - 1];
			} else {
				field_150192_M[var2] = p_149651_1_
						.registerIcon(getTextureName() + "_"
								+ field_150189_b[var2]);
			}
		}

		field_150190_P = p_149651_1_.registerIcon(getTextureName() + "_"
				+ "top");
		field_150193_N = p_149651_1_.registerIcon(getTextureName() + "_"
				+ "chiseled_top");
		field_150194_O = p_149651_1_.registerIcon(getTextureName() + "_"
				+ "lines_top");
		field_150188_Q = p_149651_1_.registerIcon(getTextureName() + "_"
				+ "bottom");
	}
}
