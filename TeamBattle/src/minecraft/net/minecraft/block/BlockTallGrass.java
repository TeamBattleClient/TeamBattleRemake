...
public class BlockTallGrass extends BlockBush implements IGrowable {
	private static final String[] field_149871_a = new String[] { "deadbush",
			"tallgrass", "fern" };
	...
	protected BlockTallGrass() {
		...
		setBlockBounds(0.5F - var1, 0.0F, 0.5F - var1, 0.5F + var1, 0.8F,
				0.5F + var1);
	}
	...
	public int colorMultiplier(IBlockAccess p_149720_1_, int p_149720_2_,
		...
		final int var5 = p_149720_1_.getBlockMetadata(p_149720_2_, p_149720_3_,
				p_149720_4_);
		return var5 == 0 ? 16777215 : p_149720_1_.getBiomeGenForCoords(
				p_149720_2_, p_149720_4_).getBiomeGrassColor(p_149720_2_,
	...
	public void func_149853_b(World p_149853_1_, Random p_149853_2_,
		...
		if (Blocks.double_plant.canPlaceBlockAt(p_149853_1_, p_149853_3_,
				p_149853_4_, p_149853_5_)) {
			Blocks.double_plant.func_149889_c(p_149853_1_, p_149853_3_,
					p_149853_4_, p_149853_5_, var7, 2);
		}
	}
	...
	public IIcon getIcon(int p_149691_1_, int p_149691_2_) {
		if (p_149691_2_ >= field_149870_b.length) {
			p_149691_2_ = 0;
		}

		return field_149870_b[p_149691_2_];
	}
	...
	public int getRenderColor(int p_149741_1_) {
		return p_149741_1_ == 0 ? 16777215 : ColorizerGrass.getGrassColor(0.5D,
				1.0D);
	}
	...
	public void registerBlockIcons(IIconRegister p_149651_1_) {
		field_149870_b = new IIcon[field_149871_a.length];

		for (int var2 = 0; var2 < field_149870_b.length; ++var2) {
			field_149870_b[var2] = p_149651_1_
					.registerIcon(field_149871_a[var2]);
		}
	}
}
