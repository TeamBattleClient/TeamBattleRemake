...
public abstract class BlockButton extends Block {
	...
	public void breakBlock(World p_149749_1_, int p_149749_2_, int p_149749_3_,
		...
		if ((p_149749_6_ & 8) > 0) {
			...
			func_150042_a(p_149749_1_, p_149749_2_, p_149749_3_, p_149749_4_,
					var7);
		}
	...
	private void func_150042_a(World p_150042_1_, int p_150042_2_,
			int p_150042_3_, int p_150042_4_, int p_150042_5_) {
		p_150042_1_.notifyBlocksOfNeighborChange(p_150042_2_, p_150042_3_,
				p_150042_4_, this);

		if (p_150042_5_ == 1) {
			p_150042_1_.notifyBlocksOfNeighborChange(p_150042_2_ - 1,
					p_150042_3_, p_150042_4_, this);
			...
			p_150042_1_.notifyBlocksOfNeighborChange(p_150042_2_,
					p_150042_3_ - 1, p_150042_4_, this);
		}
	}

	private void func_150043_b(int p_150043_1_) {
		final int var2 = p_150043_1_ & 7;
		final boolean var3 = (p_150043_1_ & 8) > 0;
	...
	private boolean func_150044_m(World p_150044_1_, int p_150044_2_,
			int p_150044_3_, int p_150044_4_) {
		if (!canPlaceBlockAt(p_150044_1_, p_150044_2_, p_150044_3_, p_150044_4_)) {
			dropBlockAsItem(p_150044_1_, p_150044_2_, p_150044_3_, p_150044_4_,
					p_150044_1_.getBlockMetadata(p_150044_2_, p_150044_3_,
							p_150044_4_), 0);
	...
	private int func_150045_e(World p_150045_1_, int p_150045_2_,
			int p_150045_3_, int p_150045_4_) {
		return p_150045_1_.getBlock(p_150045_2_ - 1, p_150045_3_, p_150045_4_)
				.isNormalCube() ? 1 : p_150045_1_.getBlock(p_150045_2_ + 1,
				p_150045_3_, p_150045_4_).isNormalCube() ? 2 : p_150045_1_
				.getBlock(p_150045_2_, p_150045_3_, p_150045_4_ - 1)
				.isNormalCube() ? 3 : p_150045_1_.getBlock(p_150045_2_,
				p_150045_3_, p_150045_4_ + 1).isNormalCube() ? 4 : 1;
	}

	private void func_150046_n(World p_150046_1_, int p_150046_2_,
			int p_150046_3_, int p_150046_4_) {
		final int var5 = p_150046_1_.getBlockMetadata(p_150046_2_, p_150046_3_,
				p_150046_4_);
		final int var6 = var5 & 7;
		final boolean var7 = (var5 & 8) != 0;
		func_150043_b(var5);
		final List var9 = p_150046_1_.getEntitiesWithinAABB(EntityArrow.class,
				AxisAlignedBB.getBoundingBox(p_150046_2_ + field_149759_B,
						p_150046_3_ + field_149760_C, p_150046_4_
								+ field_149754_D, p_150046_2_ + field_149755_E,
						p_150046_3_ + field_149756_F, p_150046_4_
								+ field_149757_G));
		final boolean var8 = !var9.isEmpty();

		if (var8 && !var7) {
			p_150046_1_.setBlockMetadataWithNotify(p_150046_2_, p_150046_3_,
					p_150046_4_, var6 | 8, 3);
			func_150042_a(p_150046_1_, p_150046_2_, p_150046_3_, p_150046_4_,
					var6);
			p_150046_1_.markBlockRangeForRenderUpdate(p_150046_2_, p_150046_3_,
					p_150046_4_, p_150046_2_, p_150046_3_, p_150046_4_);
			p_150046_1_.playSoundEffect(p_150046_2_ + 0.5D, p_150046_3_ + 0.5D,
					p_150046_4_ + 0.5D, "random.click", 0.3F, 0.6F);
		}
		...
		if (!var8 && var7) {
			...
			p_150046_1_.markBlockRangeForRenderUpdate(p_150046_2_, p_150046_3_,
					p_150046_4_, p_150046_2_, p_150046_3_, p_150046_4_);
			p_150046_1_.playSoundEffect(p_150046_2_ + 0.5D, p_150046_3_ + 0.5D,
					p_150046_4_ + 0.5D, "random.click", 0.3F, 0.5F);
		}

		if (var8) {
			p_150046_1_.scheduleBlockUpdate(p_150046_2_, p_150046_3_,
					p_150046_4_, this, func_149738_a(p_150046_1_));
		}
	}
	...
	public int isProvidingStrongPower(IBlockAccess p_149748_1_,
		...
		if ((var6 & 8) == 0)
			...
			return var7 == 5 && p_149748_5_ == 1 ? 15 : var7 == 4
					&& p_149748_5_ == 2 ? 15
					: var7 == 3 && p_149748_5_ == 3 ? 15 : var7 == 2
	...
	public boolean onBlockActivated(World p_149727_1_, int p_149727_2_,
		...
		if (var12 == 0)
			...
			p_149727_1_.markBlockRangeForRenderUpdate(p_149727_2_, p_149727_3_,
					p_149727_4_, p_149727_2_, p_149727_3_, p_149727_4_);
			p_149727_1_.playSoundEffect(p_149727_2_ + 0.5D, p_149727_3_ + 0.5D,
					p_149727_4_ + 0.5D, "random.click", 0.3F, 0.6F);
			func_150042_a(p_149727_1_, p_149727_2_, p_149727_3_, p_149727_4_,
					var11);
			p_149727_1_.scheduleBlockUpdate(p_149727_2_, p_149727_3_,
					p_149727_4_, this, func_149738_a(p_149727_1_));
			return true;
		}
	}
	...
	public int onBlockPlaced(World p_149660_1_, int p_149660_2_,
			...
			int p_149660_9_) {
		int var10 = p_149660_1_.getBlockMetadata(p_149660_2_, p_149660_3_,
				p_149660_4_);
		...
		if (p_149660_5_ == 2
			...
			var10 = 4;
		} else if (p_149660_5_ == 3
				&& p_149660_1_.getBlock(p_149660_2_, p_149660_3_,
						p_149660_4_ - 1).isNormalCube()) {
			var10 = 3;
		} else if (p_149660_5_ == 4
				&& p_149660_1_.getBlock(p_149660_2_ + 1, p_149660_3_,
						p_149660_4_).isNormalCube()) {
			var10 = 2;
		} else if (p_149660_5_ == 5
				&& p_149660_1_.getBlock(p_149660_2_ - 1, p_149660_3_,
						p_149660_4_).isNormalCube()) {
			var10 = 1;
		} else {
			var10 = func_150045_e(p_149660_1_, p_149660_2_, p_149660_3_,
					p_149660_4_);
		}
		...
		if (!p_149670_1_.isClient) {
			if (field_150047_a) {
				if ((p_149670_1_.getBlockMetadata(p_149670_2_, p_149670_3_,
						p_149670_4_) & 8) == 0) {
					func_150046_n(p_149670_1_, p_149670_2_, p_149670_3_,
							p_149670_4_);
				}
			}
		}
	...
	public void updateTick(World p_149674_1_, int p_149674_2_, int p_149674_3_,
		...
		if (!p_149674_1_.isClient) {
			...
			if ((var6 & 8) != 0) {
				if (field_150047_a) {
					func_150046_n(p_149674_1_, p_149674_2_, p_149674_3_,
							p_149674_4_);
				} else {
					p_149674_1_.setBlockMetadataWithNotify(p_149674_2_,
							p_149674_3_, p_149674_4_, var6 & 7, 3);
					final int var7 = var6 & 7;
					func_150042_a(p_149674_1_, p_149674_2_, p_149674_3_,
							p_149674_4_, var7);
					p_149674_1_.playSoundEffect(p_149674_2_ + 0.5D,
							p_149674_3_ + 0.5D, p_149674_4_ + 0.5D,
							"random.click", 0.3F, 0.5F);
					p_149674_1_.markBlockRangeForRenderUpdate(p_149674_2_,
							p_149674_3_, p_149674_4_, p_149674_2_, p_149674_3_,
							p_149674_4_);
				}
			}
		}
