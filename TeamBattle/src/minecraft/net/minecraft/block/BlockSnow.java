...
public class BlockSnow extends Block {
	...
	public boolean canPlaceBlockAt(World p_149742_1_, int p_149742_2_,
		...
		final Block var5 = p_149742_1_.getBlock(p_149742_2_, p_149742_3_ - 1,
				p_149742_4_);
		return var5 != Blocks.ice && var5 != Blocks.packed_ice ? var5
				.getMaterial() == Material.leaves ? true : var5 == this
				&& (p_149742_1_.getBlockMetadata(p_149742_2_, p_149742_3_ - 1,
						p_149742_4_) & 7) == 7 ? true : var5.isOpaqueCube()
				&& var5.blockMaterial.blocksMovement() : false;
	}

	protected void func_150154_b(int p_150154_1_) {
		final int var2 = p_150154_1_ & 7;
	...
	private boolean func_150155_m(World p_150155_1_, int p_150155_2_,
		...
		if (!canPlaceBlockAt(p_150155_1_, p_150155_2_, p_150155_3_, p_150155_4_)) {
			dropBlockAsItem(p_150155_1_, p_150155_2_, p_150155_3_, p_150155_4_,
					p_150155_1_.getBlockMetadata(p_150155_2_, p_150155_3_,
							p_150155_4_), 0);
	...
	public void harvestBlock(World p_149636_1_, EntityPlayer p_149636_2_,
		...
		final int var7 = p_149636_6_ & 7;
		dropBlockAsItem_do(p_149636_1_, p_149636_3_, p_149636_4_, p_149636_5_,
	...
	public void setBlockBoundsBasedOnState(IBlockAccess p_149719_1_,
		...
		func_150154_b(p_149719_1_.getBlockMetadata(p_149719_2_, p_149719_3_,
				p_149719_4_));
	}
