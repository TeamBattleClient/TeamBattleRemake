...
public class Material {
	...
	public static final Material anvil = new Material(MapColor.field_151668_h)
			.setRequiresTool().setImmovableMobility();
	public static final Material carpet = new MaterialLogic(
	...
	public static final Material fire = new MaterialTransparent(
			MapColor.field_151660_b).setNoPushMobility();
	public static final Material glass = new Material(MapColor.field_151660_b)
			.setTranslucent().setAdventureModeExempt();
	...
	public static final Material ice = new Material(MapColor.field_151657_g)
			.setTranslucent().setAdventureModeExempt();
	...
	public static final Material leaves = new Material(MapColor.field_151669_i)
			.setBurning().setTranslucent().setNoPushMobility();
	/** Pistons' material. */
	...
	public static final Material Portal = new MaterialPortal(
	...
	public static final Material tnt = new Material(MapColor.field_151656_f)
			.setBurning().setTranslucent();
	public static final Material vine = new MaterialLogic(
