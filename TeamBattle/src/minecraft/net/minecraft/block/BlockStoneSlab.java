...
public class BlockStoneSlab extends BlockSlab {
	...
	public IIcon getIcon(int p_149691_1_, int p_149691_2_) {
		...
		return var3 == 0 ? p_149691_1_ != 1 && p_149691_1_ != 0 ? field_150007_M
				: blockIcon
				: var3 == 1 ? Blocks.sandstone
						.getBlockTextureFromSide(p_149691_1_)
						: var3 == 2 ? Blocks.planks
								.getBlockTextureFromSide(p_149691_1_)
								: var3 == 3 ? Blocks.cobblestone
										.getBlockTextureFromSide(p_149691_1_)
										: var3 == 4 ? Blocks.brick_block
												.getBlockTextureFromSide(p_149691_1_)
												: var3 == 5 ? Blocks.stonebrick
														.getIcon(p_149691_1_, 0)
														: var3 == 6 ? Blocks.nether_brick
																.getBlockTextureFromSide(1)
																: var3 == 7 ? Blocks.quartz_block
																		.getBlockTextureFromSide(p_149691_1_)
																		: blockIcon;
	}
