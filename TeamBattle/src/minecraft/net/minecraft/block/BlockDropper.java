	...
	protected void func_149941_e(World p_149941_1_, int p_149941_2_,
		...
		if (var6 != null) {
			...
			if (var7 < 0) {
				...
				final int var9 = p_149941_1_.getBlockMetadata(p_149941_2_,
						p_149941_3_, p_149941_4_) & 7;
				final IInventory var10 = TileEntityHopper.func_145893_b(
						p_149941_1_,
						p_149941_2_ + Facing.offsetsXForSide[var9], p_149941_3_
								+ Facing.offsetsYForSide[var9], p_149941_4_
								+ Facing.offsetsZForSide[var9]);
				ItemStack var11;

				if (var10 != null) {
					var11 = TileEntityHopper.func_145889_a(var10, var8.copy()
