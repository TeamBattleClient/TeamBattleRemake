...
public class BlockFarmland extends Block {
	...
	private boolean func_149821_m(World p_149821_1_, int p_149821_2_,
			int p_149821_3_, int p_149821_4_) {
	...
	private boolean func_149822_e(World p_149822_1_, int p_149822_2_,
			int p_149822_3_, int p_149822_4_) {
		final byte var5 = 0;

		for (int var6 = p_149822_2_ - var5; var6 <= p_149822_2_ + var5; ++var6) {
			for (int var7 = p_149822_4_ - var5; var7 <= p_149822_4_ + var5; ++var7) {
				final Block var8 = p_149822_1_.getBlock(var6, p_149822_3_ + 1,
						var7);

				if (var8 == Blocks.wheat || var8 == Blocks.melon_stem
						|| var8 == Blocks.pumpkin_stem
	...
	public AxisAlignedBB getCollisionBoundingBoxFromPool(World p_149668_1_,
		...
		return AxisAlignedBB.getBoundingBox(p_149668_2_ + 0, p_149668_3_ + 0,
				p_149668_4_ + 0, p_149668_2_ + 1, p_149668_3_ + 1,
				p_149668_4_ + 1);
	}
	...
	public IIcon getIcon(int p_149691_1_, int p_149691_2_) {
		return p_149691_1_ == 1 ? p_149691_2_ > 0 ? field_149824_a
				: field_149823_b : Blocks.dirt
	...
	public void onFallenUpon(World p_149746_1_, int p_149746_2_,
			...
			float p_149746_6_) {
		if (!p_149746_1_.isClient
				&& p_149746_1_.rand.nextFloat() < p_149746_6_ - 0.5F) {
			if (!(p_149746_5_ instanceof EntityPlayer)
					&& !p_149746_1_.getGameRules().getGameRuleBooleanValue(
							"mobGriefing"))
				return;

			p_149746_1_.setBlock(p_149746_2_, p_149746_3_, p_149746_4_,
					Blocks.dirt);
		}
	}
	...
	public void onNeighborBlockChange(World p_149695_1_, int p_149695_2_,
		...
		final Material var6 = p_149695_1_.getBlock(p_149695_2_,
				p_149695_3_ + 1, p_149695_4_).getMaterial();
		...
		if (!func_149821_m(p_149674_1_, p_149674_2_, p_149674_3_, p_149674_4_)
			...
			if (var6 > 0) {
				p_149674_1_.setBlockMetadataWithNotify(p_149674_2_,
						p_149674_3_, p_149674_4_, var6 - 1, 2);
			} else if (!func_149822_e(p_149674_1_, p_149674_2_, p_149674_3_,
					p_149674_4_)) {
