...
public class BlockCake extends Block {
	...
	public boolean canPlaceBlockAt(World p_149742_1_, int p_149742_2_,
		...
		return !super.canPlaceBlockAt(p_149742_1_, p_149742_2_, p_149742_3_,
				p_149742_4_) ? false : canBlockStay(p_149742_1_, p_149742_2_,
	...
	private void func_150036_b(World p_150036_1_, int p_150036_2_,
		...
		if (p_150036_5_.canEat(false)) {
			...
			final int var6 = p_150036_1_.getBlockMetadata(p_150036_2_,
					p_150036_3_, p_150036_4_) + 1;

			if (var6 >= 6) {
				p_150036_1_
						.setBlockToAir(p_150036_2_, p_150036_3_, p_150036_4_);
			} else {
				p_150036_1_.setBlockMetadataWithNotify(p_150036_2_,
						p_150036_3_, p_150036_4_, var6, 2);
			}
		}
	}
	...
	public AxisAlignedBB getCollisionBoundingBoxFromPool(World p_149668_1_,
		...
		return AxisAlignedBB.getBoundingBox(p_149668_2_ + var7, p_149668_3_,
				p_149668_4_ + var6, p_149668_2_ + 1 - var6, p_149668_3_ + var8
						- var6, p_149668_4_ + 1 - var6);
	}
	...
	public IIcon getIcon(int p_149691_1_, int p_149691_2_) {
		return p_149691_1_ == 1 ? field_150038_a
				: p_149691_1_ == 0 ? field_150037_b : p_149691_2_ > 0
						&& p_149691_1_ == 4 ? field_150039_M : blockIcon;
	}
	...
	public AxisAlignedBB getSelectedBoundingBoxFromPool(World p_149633_1_,
		...
		final int var5 = p_149633_1_.getBlockMetadata(p_149633_2_, p_149633_3_,
				p_149633_4_);
		final float var6 = 0.0625F;
		final float var7 = (1 + var5 * 2) / 16.0F;
		final float var8 = 0.5F;
		return AxisAlignedBB.getBoundingBox(p_149633_2_ + var7, p_149633_3_,
				p_149633_4_ + var6, p_149633_2_ + 1 - var6, p_149633_3_ + var8,
				p_149633_4_ + 1 - var6);
	}
	...
	public boolean onBlockActivated(World p_149727_1_, int p_149727_2_,
			...
			float p_149727_9_) {
		func_150036_b(p_149727_1_, p_149727_2_, p_149727_3_, p_149727_4_,
				p_149727_5_);
		return true;
	}
	...
	public void onBlockClicked(World p_149699_1_, int p_149699_2_,
		...
		func_150036_b(p_149699_1_, p_149699_2_, p_149699_3_, p_149699_4_,
				p_149699_5_);
	}
