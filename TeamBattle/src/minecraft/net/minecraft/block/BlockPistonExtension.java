...
public class BlockPistonExtension extends Block {
	public static int func_150085_b(int p_150085_0_) {
		return MathHelper.clamp_int(p_150085_0_ & 7, 0,
				Facing.offsetsXForSide.length - 1);
	}
	...
	public void breakBlock(World p_149749_1_, int p_149749_2_, int p_149749_3_,
		...
		final Block var8 = p_149749_1_.getBlock(p_149749_2_, p_149749_3_,
				p_149749_4_);

		if (var8 == Blocks.piston || var8 == Blocks.sticky_piston) {
			p_149749_6_ = p_149749_1_.getBlockMetadata(p_149749_2_,
					p_149749_3_, p_149749_4_);

			if (BlockPistonBase.func_150075_c(p_149749_6_)) {
				var8.dropBlockAsItem(p_149749_1_, p_149749_2_, p_149749_3_,
						p_149749_4_, p_149749_6_, 0);
				p_149749_1_
						.setBlockToAir(p_149749_2_, p_149749_3_, p_149749_4_);
			}
		}
	}
	...
	public IIcon getIcon(int p_149691_1_, int p_149691_2_) {
		...
		return p_149691_1_ == var3 ? field_150088_a != null ? field_150088_a
				: (p_149691_2_ & 8) != 0 ? BlockPistonBase
						.func_150074_e("piston_top_sticky") : BlockPistonBase
						.func_150074_e("piston_top_normal") : var3 < 6
				&& p_149691_1_ == Facing.oppositeSide[var3] ? BlockPistonBase
				.func_150074_e("piston_top_normal") : BlockPistonBase
	...
	public Item getItem(World p_149694_1_, int p_149694_2_, int p_149694_3_,
			int p_149694_4_) {
		final int var5 = p_149694_1_.getBlockMetadata(p_149694_2_, p_149694_3_,
				p_149694_4_);
		return (var5 & 8) != 0 ? Item.getItemFromBlock(Blocks.sticky_piston)
	...
	public void onBlockHarvested(World p_149681_1_, int p_149681_2_,
		...
		if (p_149681_6_.capabilities.isCreativeMode) {
			...
			final Block var8 = p_149681_1_.getBlock(p_149681_2_
					- Facing.offsetsXForSide[var7], p_149681_3_
					- Facing.offsetsYForSide[var7], p_149681_4_
					- Facing.offsetsZForSide[var7]);

			if (var8 == Blocks.piston || var8 == Blocks.sticky_piston) {
				p_149681_1_.setBlockToAir(p_149681_2_
						- Facing.offsetsXForSide[var7], p_149681_3_
						- Facing.offsetsYForSide[var7], p_149681_4_
						- Facing.offsetsZForSide[var7]);
			}
	...
	public void onNeighborBlockChange(World p_149695_1_, int p_149695_2_,
		...
		final int var6 = func_150085_b(p_149695_1_.getBlockMetadata(
				p_149695_2_, p_149695_3_, p_149695_4_));
		final Block var7 = p_149695_1_.getBlock(p_149695_2_
				- Facing.offsetsXForSide[var6], p_149695_3_
				- Facing.offsetsYForSide[var6], p_149695_4_
				- Facing.offsetsZForSide[var6]);

		if (var7 != Blocks.piston && var7 != Blocks.sticky_piston) {
			p_149695_1_.setBlockToAir(p_149695_2_, p_149695_3_, p_149695_4_);
		} else {
			var7.onNeighborBlockChange(p_149695_1_, p_149695_2_
					- Facing.offsetsXForSide[var6], p_149695_3_
					- Facing.offsetsYForSide[var6], p_149695_4_
					- Facing.offsetsZForSide[var6], p_149695_5_);
		}
	}
