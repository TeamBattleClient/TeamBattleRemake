...
public class BlockReed extends Block {
	...
	protected BlockReed() {
		...
		setBlockBounds(0.5F - var1, 0.0F, 0.5F - var1, 0.5F + var1, 1.0F,
				0.5F + var1);
	...
	public boolean canBlockStay(World p_149718_1_, int p_149718_2_,
		...
		return canPlaceBlockAt(p_149718_1_, p_149718_2_, p_149718_3_,
				p_149718_4_);
	}
	...
	public boolean canPlaceBlockAt(World p_149742_1_, int p_149742_2_,
		...
		final Block var5 = p_149742_1_.getBlock(p_149742_2_, p_149742_3_ - 1,
				p_149742_4_);
		return var5 == this ? true
				: var5 != Blocks.grass && var5 != Blocks.dirt
						&& var5 != Blocks.sand ? false
						: p_149742_1_.getBlock(p_149742_2_ - 1,
								p_149742_3_ - 1, p_149742_4_).getMaterial() == Material.water ? true
								: p_149742_1_.getBlock(p_149742_2_ + 1,
										p_149742_3_ - 1, p_149742_4_)
										.getMaterial() == Material.water ? true
										: p_149742_1_.getBlock(p_149742_2_,
												p_149742_3_ - 1,
												p_149742_4_ - 1).getMaterial() == Material.water ? true
												: p_149742_1_.getBlock(
														p_149742_2_,
														p_149742_3_ - 1,
														p_149742_4_ + 1)
	...
	protected final boolean func_150170_e(World p_150170_1_, int p_150170_2_,
			int p_150170_3_, int p_150170_4_) {
		if (!canBlockStay(p_150170_1_, p_150170_2_, p_150170_3_, p_150170_4_)) {
			dropBlockAsItem(p_150170_1_, p_150170_2_, p_150170_3_, p_150170_4_,
					p_150170_1_.getBlockMetadata(p_150170_2_, p_150170_3_,
							p_150170_4_), 0);
	...
	public void updateTick(World p_149674_1_, int p_149674_2_, int p_149674_3_,
		...
		if (p_149674_1_.getBlock(p_149674_2_, p_149674_3_ - 1, p_149674_4_) == Blocks.reeds
				|| func_150170_e(p_149674_1_, p_149674_2_, p_149674_3_,
						p_149674_4_)) {
			if (p_149674_1_.isAirBlock(p_149674_2_, p_149674_3_ + 1,
					p_149674_4_)) {
				int var6;

				for (var6 = 1; p_149674_1_.getBlock(p_149674_2_, p_149674_3_
						- var6, p_149674_4_) == this; ++var6) {
					;
				}
				...
				if (var6 < 3) {
					...
					if (var7 == 15) {
						...
						p_149674_1_.setBlockMetadataWithNotify(p_149674_2_,
								p_149674_3_, p_149674_4_, var7 + 1, 4);
					}
				}
			}
		}
