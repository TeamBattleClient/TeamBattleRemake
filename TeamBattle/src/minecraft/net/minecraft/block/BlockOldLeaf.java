...
public class BlockOldLeaf extends BlockLeaves {
	...
	public int colorMultiplier(IBlockAccess p_149720_1_, int p_149720_2_,
		...
		return (var5 & 3) == 1 ? ColorizerFoliage.getFoliageColorPine()
				: (var5 & 3) == 2 ? ColorizerFoliage.getFoliageColorBirch()
						: super.colorMultiplier(p_149720_1_, p_149720_2_,
	...
	protected void func_150124_c(World p_150124_1_, int p_150124_2_,
		...
		if ((p_150124_5_ & 3) == 0
				&& p_150124_1_.rand.nextInt(p_150124_6_) == 0) {
			dropBlockAsItem_do(p_150124_1_, p_150124_2_, p_150124_3_,
					p_150124_4_, new ItemStack(Items.apple, 1, 0));
		}
	}
	...
	public int getRenderColor(int p_149741_1_) {
		return (p_149741_1_ & 3) == 1 ? ColorizerFoliage.getFoliageColorPine()
				: (p_149741_1_ & 3) == 2 ? ColorizerFoliage
						.getFoliageColorBirch() : super
						.getRenderColor(p_149741_1_);
	}
	...
	public void registerBlockIcons(IIconRegister p_149651_1_) {
		for (int var2 = 0; var2 < field_150130_N.length; ++var2) {
			field_150129_M[var2] = new IIcon[field_150130_N[var2].length];

			for (int var3 = 0; var3 < field_150130_N[var2].length; ++var3) {
				field_150129_M[var2][var3] = p_149651_1_
						.registerIcon(field_150130_N[var2][var3]);
			}
		}
	}
}
