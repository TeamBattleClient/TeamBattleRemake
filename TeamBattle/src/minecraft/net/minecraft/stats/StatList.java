...
public class StatList {
	...
	public static StatBase playerKillsStat = new StatBasic("stat.playerKills",
			new ChatComponentTranslation("stat.playerKills", new Object[0]))
			.registerStat();
	...
	public static StatBase func_151176_b(EntityList.EntityEggInfo p_151176_0_) {
		...
		return var1 == null ? null : new StatBase(
				"stat.entityKilledBy." + var1, new ChatComponentTranslation(
						"stat.entityKilledBy",
						new Object[] { new ChatComponentTranslation("entity."
								+ var1 + ".name", new Object[0]) }))
				.registerStat();
	}
		...
		while (var0.hasNext()) {
			...
			if (var1 != null) {
				...
				if (var1.isDamageable()) {
					objectBreakStats[var2] = new StatCrafting("stat.breakItem."
							+ var2,
							new ChatComponentTranslation("stat.breakItem",
									new Object[] { new ItemStack(var1)
											.func_151000_E() }), var1)
							.registerStat();
				}
			}
	...
	private static void func_151180_a(StatBase[] p_151180_0_,
			Block p_151180_1_, Block p_151180_2_) {
	...
	private static void func_151181_c() {
		...
		while (var0.hasNext()) {
			...
			if (Item.getItemFromBlock(var1) != null) {
				final int var2 = Block.getIdFromBlock(var1);

				if (var1.getEnableStats()) {
					mineBlockStatArray[var2] = new StatCrafting(
							"stat.mineBlock." + var2,
	...
	public static StatBase func_151182_a(EntityList.EntityEggInfo p_151182_0_) {
		...
		return var1 == null ? null : new StatBase("stat.killEntity." + var1,
	...
	private static void initCraftableStats() {
		...
		Iterator var1 = CraftingManager.getInstance().getRecipeList()
				.iterator();
		...
		while (var1.hasNext()) {
			final ItemStack var4 = (ItemStack) var1.next();
		...
		while (var1.hasNext()) {
			final Item var5 = (Item) var1.next();

			if (var5 != null) {
				final int var3 = Item.getIdFromItem(var5);
				objectCraftStats[var3] = new StatCrafting("stat.craftItem."
						+ var3, new ChatComponentTranslation("stat.craftItem",
						new Object[] { new ItemStack(var5).func_151000_E() }),
						var5).registerStat();
			}
		}
	...
	private static void initStats() {
		...
		while (var0.hasNext()) {
			...
			if (var1 != null) {
				final int var2 = Item.getIdFromItem(var1);
				objectUseStats[var2] = new StatCrafting("stat.useItem." + var2,
						new ChatComponentTranslation("stat.useItem",
								new Object[] { new ItemStack(var1)
										.func_151000_E() }), var1)
						.registerStat();
	...
	private static void replaceAllSimilarBlocks(StatBase[] p_75924_0_) {
		...
		func_151180_a(p_75924_0_, Blocks.powered_repeater,
				Blocks.unpowered_repeater);
		func_151180_a(p_75924_0_, Blocks.powered_comparator,
				Blocks.unpowered_comparator);
		func_151180_a(p_75924_0_, Blocks.redstone_torch,
				Blocks.unlit_redstone_torch);
		func_151180_a(p_75924_0_, Blocks.lit_redstone_lamp,
