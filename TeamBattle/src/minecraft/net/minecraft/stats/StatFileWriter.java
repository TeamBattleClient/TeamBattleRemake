...
public class StatFileWriter {
	...
	public boolean canUnlockAchievement(Achievement p_77442_1_) {
		return p_77442_1_.parentAchievement == null
				|| hasAchievementUnlocked(p_77442_1_.parentAchievement);
	}

	public IJsonSerializable func_150870_b(StatBase p_150870_1_) {
		final TupleIntJsonSerializable var2 = (TupleIntJsonSerializable) field_150875_a
				.get(p_150870_1_);
		return var2 != null ? var2.getJsonSerializableValue() : null;
	}

	public void func_150871_b(EntityPlayer p_150871_1_, StatBase p_150871_2_,
			int p_150871_3_) {
		if (!p_150871_2_.isAchievement()
				|| canUnlockAchievement((Achievement) p_150871_2_)) {
			func_150873_a(p_150871_1_, p_150871_2_, writeStat(p_150871_2_)
					+ p_150871_3_);
		}
	}

	public IJsonSerializable func_150872_a(StatBase p_150872_1_,
			IJsonSerializable p_150872_2_) {
		TupleIntJsonSerializable var3 = (TupleIntJsonSerializable) field_150875_a
				.get(p_150872_1_);
	...
	public void func_150873_a(EntityPlayer p_150873_1_, StatBase p_150873_2_,
			int p_150873_3_) {
		TupleIntJsonSerializable var4 = (TupleIntJsonSerializable) field_150875_a
				.get(p_150873_2_);
