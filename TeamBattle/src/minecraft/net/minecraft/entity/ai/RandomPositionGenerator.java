...
public class RandomPositionGenerator {
	...
	public static Vec3 findRandomTarget(EntityCreature p_75463_0_,
			int p_75463_1_, int p_75463_2_) {
		return findRandomTargetBlock(p_75463_0_, p_75463_1_, p_75463_2_,
				(Vec3) null);
	}
	 ...
	 */
	private static Vec3 findRandomTargetBlock(EntityCreature p_75462_0_,
			int p_75462_1_, int p_75462_2_, Vec3 p_75462_3_) {
		...
		if (p_75462_0_.hasHome()) {
			final double var11 = p_75462_0_.getHomePosition()
					.getDistanceSquared(
							MathHelper.floor_double(p_75462_0_.posX),
							MathHelper.floor_double(p_75462_0_.posY),
							MathHelper.floor_double(p_75462_0_.posZ)) + 4.0F;
			final double var13 = p_75462_0_.func_110174_bM() + p_75462_1_;
		...
		for (int var16 = 0; var16 < 10; ++var16) {
			...
			if (p_75462_3_ == null
					|| var12 * p_75462_3_.xCoord + var14 * p_75462_3_.zCoord >= 0.0D) {
				...
				if (!var10
						|| p_75462_0_.isWithinHomeDistance(var12, var17, var14)) {
					final float var15 = p_75462_0_.getBlockPathWeight(var12,
							var17, var14);
	...
	public static Vec3 findRandomTargetBlockAwayFrom(EntityCreature p_75461_0_,
			int p_75461_1_, int p_75461_2_, Vec3 p_75461_3_) {
		...
		return findRandomTargetBlock(p_75461_0_, p_75461_1_, p_75461_2_,
				staticVector);
	}
	...
	public static Vec3 findRandomTargetBlockTowards(EntityCreature p_75464_0_,
			int p_75464_1_, int p_75464_2_, Vec3 p_75464_3_) {
		...
		return findRandomTargetBlock(p_75464_0_, p_75464_1_, p_75464_2_,
				staticVector);
	}
}
