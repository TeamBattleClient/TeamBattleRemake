...
public class EntityList {
	 ...
	 * and an ID
	 */
	private static void addMapping(Class p_75618_0_, String p_75618_1_,
			int p_75618_2_) {
	 ...
	 */
	private static void addMapping(Class p_75614_0_, String p_75614_1_,
			int p_75614_2_, int p_75614_3_, int p_75614_4_) {
		addMapping(p_75614_0_, p_75614_1_, p_75614_2_);
		entityEggs
				.put(Integer.valueOf(p_75614_2_), new EntityList.EntityEggInfo(
						p_75614_2_, p_75614_3_, p_75614_4_));
	}
	 ...
	 */
	public static Entity createEntityFromNBT(NBTTagCompound p_75615_0_,
			World p_75615_1_) {
		Entity var2 = null;
		...
		try {
			final Class var3 = (Class) stringToClassMapping.get(p_75615_0_
					.getString("id"));
