...
public class EntityTracker {
	...
	public EntityTracker(WorldServer p_i1516_1_) {
		theWorld = p_i1516_1_;
		entityViewDistance = p_i1516_1_.func_73046_m()
	...
	public void addEntityToTracker(Entity p_72791_1_, int p_72791_2_,
			int p_72791_3_) {
		this.addEntityToTracker(p_72791_1_, p_72791_2_, p_72791_3_, false);
	}

	public void addEntityToTracker(Entity p_72785_1_, int p_72785_2_,
			final int p_72785_3_, boolean p_72785_4_) {
		if (p_72785_2_ > entityViewDistance) {
			p_72785_2_ = entityViewDistance;
		}

		try {
			if (trackedEntityIDs.containsItem(p_72785_1_.getEntityId()))
				throw new IllegalStateException("Entity is already tracked!");

			final EntityTrackerEntry var5 = new EntityTrackerEntry(p_72785_1_,
					p_72785_2_, p_72785_3_, p_72785_4_);
			trackedEntities.add(var5);
			trackedEntityIDs.addKey(p_72785_1_.getEntityId(), var5);
			...
			((EntityTrackerEntry) trackedEntityIDs.lookup(p_72785_1_
					.getEntityId())).myEntity.addEntityCrashInfo(var8);
	...
	public void func_85172_a(EntityPlayerMP p_85172_1_, Chunk p_85172_2_) {
		...
		while (var3.hasNext()) {
			...
			if (var4.myEntity != p_85172_1_
					&& var4.myEntity.chunkCoordX == p_85172_2_.xPosition
