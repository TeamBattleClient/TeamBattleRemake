...
public class ScoreboardSaveData extends WorldSavedData {
	...
	protected NBTTagList func_96496_a() {
		...
		final Collection var2 = theScoreboard.getTeams();
	...
	protected void func_96497_d(NBTTagCompound p_96497_1_) {
		...
		for (int var4 = 0; var4 < 3; ++var4) {
			final ScoreObjective var5 = theScoreboard.func_96539_a(var4);
	...
	protected void func_96498_a(NBTTagList p_96498_1_) {
		for (int var2 = 0; var2 < p_96498_1_.tagCount(); ++var2) {
			...
			final ScorePlayerTeam var4 = theScoreboard.createTeam(var3
					.getString("Name"));
	...
	protected void func_96500_c(NBTTagList p_96500_1_) {
		for (int var2 = 0; var2 < p_96500_1_.tagCount(); ++var2) {
			...
			final ScoreObjective var4 = theScoreboard.getObjective(var3
					.getString("Objective"));
			final Score var5 = theScoreboard.func_96529_a(
	...
	protected void func_96501_b(NBTTagList p_96501_1_) {
		for (int var2 = 0; var2 < p_96501_1_.tagCount(); ++var2) {
			...
			final IScoreObjectiveCriteria var4 = (IScoreObjectiveCriteria) IScoreObjectiveCriteria.field_96643_a
					.get(var3.getString("CriteriaName"));
			final ScoreObjective var5 = theScoreboard.addScoreObjective(
					var3.getString("Name"), var4);
	...
	protected void func_96502_a(ScorePlayerTeam p_96502_1_,
		...
		for (int var3 = 0; var3 < p_96502_2_.tagCount(); ++var3) {
			theScoreboard.func_151392_a(p_96502_2_.getStringTagAt(var3),
					p_96502_1_.getRegisteredName());
		}
	}

	protected NBTTagList func_96503_e() {
		final NBTTagList var1 = new NBTTagList();
		final Collection var2 = theScoreboard.func_96528_e();
		final Iterator var3 = var2.iterator();
	...
	protected void func_96504_c(NBTTagCompound p_96504_1_) {
		for (int var2 = 0; var2 < 3; ++var2) {
			if (p_96504_1_.func_150297_b("slot_" + var2, 8)) {
				...
				final ScoreObjective var4 = theScoreboard.getObjective(var3);
				theScoreboard.func_96530_a(var2, var4);
			}
		}
	}
	...
	protected NBTTagList func_96505_b() {
		final NBTTagList var1 = new NBTTagList();
		final Collection var2 = theScoreboard.getScoreObjectives();
		final Iterator var3 = var2.iterator();
	...
	public void readFromNBT(NBTTagCompound p_76184_1_) {
		if (theScoreboard == null) {
			...
			func_96501_b(p_76184_1_.getTagList("Objectives", 10));
			func_96500_c(p_76184_1_.getTagList("PlayerScores", 10));
			...
			if (p_76184_1_.func_150297_b("Teams", 9)) {
				func_96498_a(p_76184_1_.getTagList("Teams", 10));
			}
		}
	}
