...
public abstract class Enchantment {
	...
	static {
		...
		final Enchantment[] var1 = enchantmentsList;
		final int var2 = var1.length;

		for (int var3 = 0; var3 < var2; ++var3) {
			final Enchantment var4 = var1[var3];
	...
	protected Enchantment(int p_i1926_1_, int p_i1926_2_,
	...
	public String getTranslatedName(int p_77316_1_) {
		final String var2 = StatCollector.translateToLocal(getName());
		return var2
				+ " "
