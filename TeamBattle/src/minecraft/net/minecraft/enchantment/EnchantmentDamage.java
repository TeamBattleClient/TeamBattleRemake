...
public class EnchantmentDamage extends Enchantment {
	...
	public boolean canApply(ItemStack p_92089_1_) {
		return p_92089_1_.getItem() instanceof ItemAxe ? true : super
				.canApply(p_92089_1_);
	}
	...
	public void func_151368_a(EntityLivingBase p_151368_1_, Entity p_151368_2_,
		...
		if (p_151368_2_ instanceof EntityLivingBase) {
			...
			if (damageType == 2
				...
				final int var5 = 20 + p_151368_1_.getRNG().nextInt(
						10 * p_151368_3_);
	...
	public float func_152376_a(int p_152376_1_,
		...
		return damageType == 0 ? p_152376_1_ * 1.25F
				: damageType == 1
						&& p_152376_2_ == EnumCreatureAttribute.UNDEAD ? p_152376_1_ * 2.5F
						: damageType == 2
								&& p_152376_2_ == EnumCreatureAttribute.ARTHROPOD ? p_152376_1_ * 2.5F
								: 0.0F;
	}
	...
	public int getMaxEnchantability(int p_77317_1_) {
		return getMinEnchantability(p_77317_1_)
				+ thresholdEnchantability[damageType];
	}
	...
	public int getMinEnchantability(int p_77321_1_) {
		return baseEnchantability[damageType] + (p_77321_1_ - 1)
