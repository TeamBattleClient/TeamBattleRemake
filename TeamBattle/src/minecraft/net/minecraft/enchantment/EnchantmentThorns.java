...
public class EnchantmentThorns extends Enchantment {
	...
	public static boolean func_92094_a(int p_92094_0_, Random p_92094_1_) {
		return p_92094_0_ <= 0 ? false
				: p_92094_1_.nextFloat() < 0.15F * p_92094_0_;
	}
	...
	public boolean canApply(ItemStack p_92089_1_) {
		return p_92089_1_.getItem() instanceof ItemArmor ? true : super
				.canApply(p_92089_1_);
	}
	...
	public void func_151367_b(EntityLivingBase p_151367_1_, Entity p_151367_2_,
		...
		final ItemStack var5 = EnchantmentHelper.func_92099_a(
				Enchantment.thorns, p_151367_1_);

		if (func_92094_a(p_151367_3_, var4)) {
			p_151367_2_.attackEntityFrom(
					DamageSource.causeThornsDamage(p_151367_1_),
					func_92095_b(p_151367_3_, var4));
