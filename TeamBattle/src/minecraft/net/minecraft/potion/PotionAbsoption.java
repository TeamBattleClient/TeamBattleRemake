...
public class PotionAbsoption extends Potion {
	...
	public void applyAttributesModifiersToEntity(EntityLivingBase p_111185_1_,
		...
		p_111185_1_.setAbsorptionAmount(p_111185_1_.getAbsorptionAmount() + 4
				* (p_111185_3_ + 1));
		super.applyAttributesModifiersToEntity(p_111185_1_, p_111185_2_,
				p_111185_3_);
	}
	...
	public void removeAttributesModifiersFromEntity(
			...
			int p_111187_3_) {
		p_111187_1_.setAbsorptionAmount(p_111187_1_.getAbsorptionAmount() - 4
				* (p_111187_3_ + 1));
		super.removeAttributesModifiersFromEntity(p_111187_1_, p_111187_2_,
				p_111187_3_);
	}
}
