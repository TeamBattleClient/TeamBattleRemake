...
public class PotionHelper {
	...
	static {
		...
		potionRequirements.put(Integer.valueOf(Potion.nightVision.getId()),
				"!0 & 1 & 2 & !3 & 2+6");
		potionRequirements.put(Integer.valueOf(Potion.invisibility.getId()),
				"!0 & 1 & 2 & 3 & 2+6");
		field_151423_m = "+0-1+2+3+13&4-4";
		potionRequirements.put(Integer.valueOf(Potion.waterBreathing.getId()),
				"0 & !1 & 2 & 3 & 2+6");
		...
		potionPrefixes = new String[] { "potion.prefix.mundane",
				...
				"potion.prefix.rank", "potion.prefix.harsh",
				"potion.prefix.acrid", "potion.prefix.gross",
	...
	public static int applyIngredient(int p_77913_0_, String p_77913_1_) {
		...
		for (int var9 = var2; var9 < var3; ++var9) {
			...
			if (var10 >= 48 && var10 <= 57) {
				...
				if (var4) {
					p_77913_0_ = brewBitOperations(p_77913_0_, var8, var6,
							var5, var7);
					var7 = false;
					var5 = false;
					var6 = false;
	 ...
	 * bit is not present.
	 */
	private static int brewBitOperations(int p_77906_0_, int p_77906_1_,
			boolean p_77906_2_, boolean p_77906_3_, boolean p_77906_4_) {
		if (p_77906_4_) {
	...
	public static int calcPotionLiquidColor(Collection p_77911_0_) {
		...
		if (p_77911_0_ != null && !p_77911_0_.isEmpty()) {
			...
			float var4 = 0.0F;
			float var5 = 0.0F;
			final Iterator var6 = p_77911_0_.iterator();

			while (var6.hasNext()) {
				final PotionEffect var7 = (PotionEffect) var6.next();
				final int var8 = Potion.potionTypes[var7.getPotionID()]
						.getLiquidColor();
	...
	private static int func_77904_a(boolean p_77904_0_, boolean p_77904_1_,
			boolean p_77904_2_, int p_77904_3_, int p_77904_4_, int p_77904_5_,
			int p_77904_6_) {
		int var7 = 0;
		...
		if (p_77904_0_) {
			...
			if (p_77904_3_ == 0 && countSetFlags(p_77904_6_) == p_77904_4_) {
				var7 = 1;
					...
					&& countSetFlags(p_77904_6_) > p_77904_4_) {
				var7 = 1;
			} else if (p_77904_3_ == 2
					&& countSetFlags(p_77904_6_) < p_77904_4_) {
				var7 = 1;
			}
		} else {
	...
	public static int func_77908_a(int p_77908_0_, int p_77908_1_,
			int p_77908_2_, int p_77908_3_, int p_77908_4_, int p_77908_5_) {
	...
	public static int func_77915_a(int p_77915_0_, boolean p_77915_1_) {
		if (!p_77915_1_) {
			if (field_77925_n.containsKey(Integer.valueOf(p_77915_0_)))
				return ((Integer) field_77925_n
						.get(Integer.valueOf(p_77915_0_))).intValue();
			else {
				final int var2 = calcPotionLiquidColor(getPotionEffects(
						p_77915_0_, false));
				field_77925_n.put(Integer.valueOf(p_77915_0_),
						Integer.valueOf(var2));
				return var2;
			}
		} else
			return calcPotionLiquidColor(getPotionEffects(p_77915_0_,
					p_77915_1_));
	}

	public static boolean func_82817_b(Collection p_82817_0_) {
		final Iterator var1 = p_82817_0_.iterator();
		PotionEffect var2;
	...
	public static List getPotionEffects(int p_77917_0_, boolean p_77917_1_) {
		ArrayList var2 = null;
		final Potion[] var3 = Potion.potionTypes;
		...
		for (int var5 = 0; var5 < var4; ++var5) {
			...
			if (var6 != null && (!var6.isUsable() || p_77917_1_)) {
				final String var7 = (String) potionRequirements.get(Integer
						.valueOf(var6.getId()));

				if (var7 != null) {
					int var8 = parsePotionEffects(var7, 0, var7.length(),
							p_77917_0_);

					if (var8 > 0) {
						int var9 = 0;
						final String var10 = (String) potionAmplifiers
								.get(Integer.valueOf(var6.getId()));

						if (var10 != null) {
							var9 = parsePotionEffects(var10, 0, var10.length(),
									p_77917_0_);
						...
						if (var6.isInstant()) {
							...
							var8 >>= var9;
							var8 = (int) Math.round(var8
									* var6.getEffectiveness());
						...
						final PotionEffect var11 = new PotionEffect(
								var6.getId(), var8, var9);
	...
	private static int parsePotionEffects(String p_77912_0_, int p_77912_1_,
			int p_77912_2_, int p_77912_3_) {
		if (p_77912_1_ < p_77912_0_.length() && p_77912_2_ >= 0
				&& p_77912_1_ < p_77912_2_) {
			final int var4 = p_77912_0_.indexOf(124, p_77912_1_);
			int var5;
			int var17;

			if (var4 >= 0 && var4 < p_77912_2_) {
				var5 = parsePotionEffects(p_77912_0_, p_77912_1_, var4 - 1,
						p_77912_3_);

				if (var5 > 0)
					return var5;
				else {
					var17 = parsePotionEffects(p_77912_0_, var4 + 1,
							p_77912_2_, p_77912_3_);
				...
				if (var5 >= 0 && var5 < p_77912_2_) {
					var17 = parsePotionEffects(p_77912_0_, p_77912_1_,
							var5 - 1, p_77912_3_);

					if (var17 <= 0)
						return 0;
					else {
						final int var18 = parsePotionEffects(p_77912_0_,
								var5 + 1, p_77912_2_, p_77912_3_);
					...
					for (int var15 = p_77912_1_; var15 < p_77912_2_; ++var15) {
						final char var16 = p_77912_0_.charAt(var15);
						...
						if (var16 >= 48 && var16 <= 57) {
							...
							if (var8) {
								var14 += func_77904_a(var9, var7, var10, var11,
										var12, var13, p_77912_3_);
								var9 = false;
								var10 = false;
								var6 = false;
								var7 = false;
					...
					if (var8) {
						var14 += func_77904_a(var9, var7, var10, var11, var12,
								var13, p_77912_3_);
					}
