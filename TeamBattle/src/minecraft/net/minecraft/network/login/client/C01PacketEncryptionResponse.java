...
public class C01PacketEncryptionResponse extends Packet {
	...
	public C01PacketEncryptionResponse(SecretKey p_i45271_1_,
			PublicKey p_i45271_2_, byte[] p_i45271_3_) {
		field_149302_a = CryptManager.encryptData(p_i45271_2_,
				p_i45271_1_.getEncoded());
		field_149301_b = CryptManager.encryptData(p_i45271_2_, p_i45271_3_);
	}

	public byte[] func_149299_b(PrivateKey p_149299_1_) {
		return p_149299_1_ == null ? field_149301_b : CryptManager.decryptData(
				p_149299_1_, field_149301_b);
	}
