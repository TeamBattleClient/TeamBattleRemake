...
public class NettyEncryptionTranslator {
	...
	protected ByteBuf func_150503_a(ChannelHandlerContext p_150503_1_,
		...
		final byte[] var4 = func_150502_a(p_150503_2_);
		final ByteBuf var5 = p_150503_1_.alloc().heapBuffer(
				field_150507_a.getOutputSize(var3));
		var5.writerIndex(field_150507_a.update(var4, 0, var3, var5.array(),
				var5.arrayOffset()));
		return var5;
	}
	...
	protected void func_150504_a(ByteBuf p_150504_1_, ByteBuf p_150504_2_)
		...
		final int var5 = field_150507_a.getOutputSize(var3);

		if (field_150506_c.length < var5) {
			field_150506_c = new byte[var5];
		}

		p_150504_2_.writeBytes(field_150506_c, 0,
				field_150507_a.update(var4, 0, var3, field_150506_c));
	}
}
