...
public class NettyEncryptingEncoder extends MessageToByteEncoder {
	...
	public NettyEncryptingEncoder(Cipher p_i45142_1_) {
		field_150750_a = new NettyEncryptionTranslator(p_i45142_1_);
	}

	protected void encode(ChannelHandlerContext p_encode_1_,
			ByteBuf p_encode_2_, ByteBuf p_encode_3_)
			throws ShortBufferException {
		field_150750_a.func_150504_a(p_encode_2_, p_encode_3_);
	}

	@Override
	protected void encode(ChannelHandlerContext p_encode_1_,
			Object p_encode_2_, ByteBuf p_encode_3_)
			throws ShortBufferException {
