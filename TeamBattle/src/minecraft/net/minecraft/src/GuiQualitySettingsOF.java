...
public class GuiQualitySettingsOF extends GuiScreen {
	private static GameSettings.Options[] enumOptions = new GameSettings.Options[] {
			...
			GameSettings.Options.AA_LEVEL, GameSettings.Options.CLEAR_WATER,
	...
	private String[] getTooltipLines(String btnName) {
		return btnName.equals("Mipmap Levels") ? new String[] {
				"Visual effect which makes distant objects look better",
				"by smoothing the texture details", "  OFF - no smoothing",
				"  1 - minimum smoothing", "  4 - maximum smoothing",
				"This option usually does not affect the performance." }
				: btnName.equals("Mipmap Type") ? new String[] {
						"Visual effect which makes distant objects look better",
						"by smoothing the texture details",
						"  Nearest - rough smoothing",
						"  Linear - fine smoothing",
						"This option usually does not affect the performance." }
						: btnName.equals("Anisotropic Filtering") ? new String[] {
								...
								: btnName.equals("Antialiasing") ? new String[] {
										"Antialiasing",
																...
																: btnName
																		...
																		: btnName
																				...
																				: btnName
																						...
																						: btnName
																								.equals("Custom Fonts") ? new String[] {
																								"Custom Fonts",
																								...
																								"texture pack" }
																								: btnName
																										.equals("Custom Colors") ? new String[] {
																										"Custom Colors",
																										...
																										: btnName
																												...
																												: btnName
																														.equals("Connected Textures") ? new String[] {
																														"Connected Textures",
																														...
																														: btnName
																																...
																																: btnName
																																		.equals("Natural Textures") ? new String[] {
																																		"Natural Textures",
