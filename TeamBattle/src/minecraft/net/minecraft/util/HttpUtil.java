...
public class HttpUtil {
	...
	public static String buildPostString(Map p_76179_0_) {
		...
		final Iterator var2 = p_76179_0_.entrySet().iterator();
	...
	public static void func_151223_a(final File p_151223_0_,
			final String p_151223_1_,
			final HttpUtil.DownloadListener p_151223_2_, final Map p_151223_3_,
			final int p_151223_4_, final IProgressUpdate p_151223_5_,
			final Proxy p_151223_6_) {
		final Thread var7 = new Thread(new Runnable() {
			...
			public void run() {
				...
				if (p_151223_5_ != null) {
					...
					p_151223_5_
							.resetProgresAndWorkingMessage("Making Request...");
				}
				...
				try {
					try {
						...
						float var6 = 0.0F;
						float var7 = p_151223_3_.entrySet().size();
						final Iterator var8 = p_151223_3_.entrySet().iterator();

						while (var8.hasNext()) {
							final Entry var9 = (Entry) var8.next();
							var1.setRequestProperty((String) var9.getKey(),
									(String) var9.getValue());

							if (p_151223_5_ != null) {
								p_151223_5_.setLoadingProgress((int) (++var6
										/ var7 * 100.0F));
							}
						}
						...
						final int var28 = var1.getContentLength();

						if (p_151223_5_ != null) {
							p_151223_5_
									.resetProgresAndWorkingMessage(String
											.format("Downloading file (%.2f MB)...",
													new Object[] { Float
															.valueOf(var7 / 1000.0F / 1000.0F) }));
						}

						if (p_151223_0_.exists()) {
							final long var29 = p_151223_0_.length();
						...
						var3 = new DataOutputStream(new FileOutputStream(
								p_151223_0_));
						...
						if (p_151223_4_ > 0 && var7 > p_151223_4_) {
							...
							throw new IOException(
									"Filesize is bigger than maximum allowed (file is "
											+ var6 + ", limit is "
											+ p_151223_4_ + ")");
						}
						...
						while ((var31 = var2.read(var4)) >= 0) {
							...
							if (p_151223_4_ > 0 && var6 > p_151223_4_) {
								...
								throw new IOException(
										"Filesize was bigger than maximum allowed (got >= "
												+ var6 + ", limit was "
												+ p_151223_4_ + ")");
							}
	...
	private static String func_151225_a(URL p_151225_0_, String p_151225_1_,
		...
		try {
			...
			final HttpURLConnection var4 = (HttpURLConnection) p_151225_0_
					.openConnection(var3);
			...
			final DataOutputStream var5 = new DataOutputStream(
					var4.getOutputStream());
			var5.writeBytes(p_151225_1_);
			var5.flush();
			var5.close();
			final BufferedReader var6 = new BufferedReader(
	...
	public static String func_152755_a(URL p_152755_0_) throws IOException {
		final HttpURLConnection var1 = (HttpURLConnection) p_152755_0_
				.openConnection();
		var1.setRequestMethod("GET");
		final BufferedReader var2 = new BufferedReader(new InputStreamReader(
				var1.getInputStream()));
