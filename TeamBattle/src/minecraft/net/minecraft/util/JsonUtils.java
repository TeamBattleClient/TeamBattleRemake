...
public class JsonUtils {
	...
	public static JsonObject func_152754_s(JsonObject p_152754_0_,
			String p_152754_1_) {
		if (p_152754_0_.has(p_152754_1_))
			return getJsonElementAsJsonObject(p_152754_0_.get(p_152754_1_),
					p_152754_1_);
		else
			throw new JsonSyntaxException("Missing " + p_152754_1_
					+ ", expected to find a JsonObject");
	}
	 ...
	 * thrown.
	 */
	public static JsonObject getJsonElementAsJsonObject(
	 ...
	 * to be thrown.
	 */
	public static boolean getJsonElementBooleanValue(JsonElement p_151216_0_,
			String p_151216_1_) {
		if (p_151216_0_.isJsonPrimitive())
			return p_151216_0_.getAsBoolean();
		else
			throw new JsonSyntaxException("Expected " + p_151216_1_
					+ " to be a Boolean, was "
					+ getJsonElementTypeDescription(p_151216_0_));
	}
	 ...
	 * to be thrown.
	 */
	public static float getJsonElementFloatValue(JsonElement p_151220_0_,
			String p_151220_1_) {
		if (p_151220_0_.isJsonPrimitive()
				&& p_151220_0_.getAsJsonPrimitive().isNumber())
			return p_151220_0_.getAsFloat();
		else
			throw new JsonSyntaxException("Expected " + p_151220_1_
					+ " to be a Float, was "
					+ getJsonElementTypeDescription(p_151220_0_));
	}
	...
	public static String getJsonElementTypeDescription(JsonElement p_151222_0_) {
		final String var1 = org.apache.commons.lang3.StringUtils
				.abbreviateMiddle(String.valueOf(p_151222_0_), "...", 10);
	 ...
	 * name.
	 */
	public static boolean getJsonObjectBooleanFieldValue(
			JsonObject p_151212_0_, String p_151212_1_) {
		if (p_151212_0_.has(p_151212_1_))
			return getJsonElementBooleanValue(p_151212_0_.get(p_151212_1_),
					p_151212_1_);
		else
			throw new JsonSyntaxException("Missing " + p_151212_1_
					+ ", expected to find a Boolean");
	}
	 ...
	 */
	public static boolean getJsonObjectBooleanFieldValueOrDefault(
			JsonObject p_151209_0_, String p_151209_1_, boolean p_151209_2_) {
		return p_151209_0_.has(p_151209_1_) ? getJsonElementBooleanValue(
				p_151209_0_.get(p_151209_1_), p_151209_1_) : p_151209_2_;
	}
	 ...
	 */
	public static JsonObject getJsonObjectFieldOrDefault(
			JsonObject p_151218_0_, String p_151218_1_, JsonObject p_151218_2_) {
		return p_151218_0_.has(p_151218_1_) ? getJsonElementAsJsonObject(
				p_151218_0_.get(p_151218_1_), p_151218_1_) : p_151218_2_;
	}

	/**
	 * Gets the float value of the field on the JsonObject with the given name.
	 */
	public static float getJsonObjectFloatFieldValue(JsonObject p_151217_0_,
			String p_151217_1_) {
		if (p_151217_0_.has(p_151217_1_))
			return getJsonElementFloatValue(p_151217_0_.get(p_151217_1_),
					p_151217_1_);
		else
			throw new JsonSyntaxException("Missing " + p_151217_1_
					+ ", expected to find a Float");
	}
	 ...
	 */
	public static float getJsonObjectFloatFieldValueOrDefault(
			JsonObject p_151221_0_, String p_151221_1_, float p_151221_2_) {
		return p_151221_0_.has(p_151221_1_) ? getJsonElementFloatValue(
				p_151221_0_.get(p_151221_1_), p_151221_1_) : p_151221_2_;
	}
	...
	public static int getJsonObjectIntegerFieldValueOrDefault(
		...
		return p_151208_0_.has(p_151208_1_) ? getJsonElementIntegerValue(
				p_151208_0_.get(p_151208_1_), p_151208_1_) : p_151208_2_;
	}
	 ...
	 * given default value if the field is missing.
	 */
	public static JsonArray getJsonObjectJsonArrayFieldOrDefault(
			JsonObject p_151213_0_, String p_151213_1_, JsonArray p_151213_2_) {
		return p_151213_0_.has(p_151213_1_) ? getJsonElementAsJsonArray(
				p_151213_0_.get(p_151213_1_), p_151213_1_) : p_151213_2_;
	}
	...
	public static String getJsonObjectStringFieldValueOrDefault(
		...
		return p_151219_0_.has(p_151219_1_) ? getJsonElementStringValue(
				p_151219_0_.get(p_151219_1_), p_151219_1_) : p_151219_2_;
	}
	...
	public static boolean jsonElementTypeIsString(JsonElement p_151211_0_) {
		return !p_151211_0_.isJsonPrimitive() ? false : p_151211_0_
	 ...
	 */
	public static boolean jsonObjectFieldTypeIsPrimitive(
			JsonObject p_151201_0_, String p_151201_1_) {
	 ...
	 */
	public static boolean jsonObjectFieldTypeIsString(JsonObject p_151205_0_,
			String p_151205_1_) {
