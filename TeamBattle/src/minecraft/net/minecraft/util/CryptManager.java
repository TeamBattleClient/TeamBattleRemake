...
public class CryptManager {
	 ...
	 */
	private static byte[] cipherOperation(int p_75885_0_, Key p_75885_1_,
			byte[] p_75885_2_) {
		try {
			return createTheCipherInstance(p_75885_0_,
					p_75885_1_.getAlgorithm(), p_75885_1_).doFinal(p_75885_2_);
	 ...
	 */
	private static Cipher createTheCipherInstance(int p_75886_0_,
			String p_75886_1_, Key p_75886_2_) {
		try {
	 ...
	 */
	public static SecretKey decryptSharedKey(PrivateKey p_75887_0_,
			byte[] p_75887_1_) {
	 ...
	 */
	private static byte[] digestOperation(String p_75893_0_,
			byte[]... p_75893_1_) {
		try {
	 ...
	 */
	public static byte[] getServerIdHash(String p_75895_0_,
			PublicKey p_75895_1_, SecretKey p_75895_2_) {
		try {
			return digestOperation("SHA-1",
					new byte[][] { p_75895_0_.getBytes("ISO_8859_1"),
							p_75895_2_.getEncoded(), p_75895_1_.getEncoded() });
