...
public class WeightedRandom {
	 ...
	 */
	public static WeightedRandom.Item getRandomItem(Random p_76271_0_,
			Collection p_76271_1_) {
	 ...
	 */
	public static WeightedRandom.Item getRandomItem(Random p_76273_0_,
			Collection p_76273_1_, int p_76273_2_) {
		if (p_76273_2_ <= 0)
			throw new IllegalArgumentException();
		else {
			int var3 = p_76273_0_.nextInt(p_76273_2_);
			final Iterator var4 = p_76273_1_.iterator();
	 ...
	 * Returns a random choice from the input items.
	 */
	public static WeightedRandom.Item getRandomItem(Random p_76274_0_,
	 ...
	 * weight value.
	 */
	public static WeightedRandom.Item getRandomItem(Random p_76269_0_,
			WeightedRandom.Item[] p_76269_1_, int p_76269_2_) {
		if (p_76269_2_ <= 0)
			throw new IllegalArgumentException();
		else {
			int var3 = p_76269_0_.nextInt(p_76269_2_);
			final WeightedRandom.Item[] var4 = p_76269_1_;
			final int var5 = p_76269_1_.length;

			for (int var6 = 0; var6 < var5; ++var6) {
				final WeightedRandom.Item var7 = var4[var6];
	...
	public static int getTotalWeight(WeightedRandom.Item[] p_76270_0_) {
		int var1 = 0;
		final WeightedRandom.Item[] var2 = p_76270_0_;
		final int var3 = p_76270_0_.length;

		for (int var4 = 0; var4 < var3; ++var4) {
			final WeightedRandom.Item var5 = var2[var4];
