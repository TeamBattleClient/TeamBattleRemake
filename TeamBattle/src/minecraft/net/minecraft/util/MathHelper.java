...
public class MathHelper {
	...
	static {
		...
		for (i = 0; i < 4096; ++i) {
			SIN_TABLE_FAST[i] = (float) Math.sin((i + 0.5F) / 4096.0F
					* ((float) Math.PI * 2F));
		}

		for (i = 0; i < 360; i += 90) {
			SIN_TABLE_FAST[(int) (i * 11.377778F) & 4095] = (float) Math
					.sin(i * 0.017453292F);
		}
	}
	...
	public static int calculateLogBaseTwo(int p_151239_0_) {
		return calculateLogBaseTwoDeBruijn(p_151239_0_)
				- (isPowerOfTwo(p_151239_0_) ? 0 : 1);
	}
	...
	private static int calculateLogBaseTwoDeBruijn(int p_151241_0_) {
		p_151241_0_ = isPowerOfTwo(p_151241_0_) ? p_151241_0_
				: roundUpToPowerOfTwo(p_151241_0_);
	...
	public static double clamp_double(double p_151237_0_, double p_151237_2_,
			double p_151237_4_) {
	...
	public static double denormalizeClamp(double p_151238_0_,
			double p_151238_2_, double p_151238_4_) {
	...
	public static double parseDoubleWithDefaultAndMax(String par0Str,
			double par1, double par3) {
		double var5 = par1;
	...
	public static float randomFloatClamp(Random p_151240_0_, float p_151240_1_,
			float p_151240_2_) {
