...
public final class SpawnerAnimals
{
    ...
    public int findChunksForSpawning(WorldServer par1WorldServer, boolean par2, boolean par3, boolean par4)
    {
        ...
        else
        {
            ...
            if (player == null || player.chunkCoordX != this.lastPlayerChunkX || player.chunkCoordZ != this.lastPlayerChunkZ || this.eligibleChunksForSpawning.size() <= 0)
            {
                ...
                for (var5 = 0; var5 < par1WorldServer.playerEntities.size(); ++var5)
                {
                    ...
                    for (int var37 = -var36; var37 <= var36; ++var37)
                    {
                        ...
                        {
                            boolean var39 = var37 == -var36 || var37 == var36 || var38 == -var36 || var38 == var36;
                            ChunkCoordIntPair chunk = new ChunkCoordIntPair(var37 + var35, var38 + var8);
            ...
            {
                EnumCreatureType var40 = var381[var391];

                if ((!var40.getPeacefulCreature() || par3) && (var40.getPeacefulCreature() || par2) && (!var40.getAnimal() || par4) && par1WorldServer.countEntities(var40.getCreatureClass()) <= var40.getMaxNumberOfCreature() * this.eligibleChunksForSpawning.size() / 256)
                {
                    Iterator var411 = this.eligibleChunksForSpawning.keySet().iterator();
                    label120:

                    while (var411.hasNext())
                    {
                        ChunkCoordIntPair var42 = (ChunkCoordIntPair)var411.next();
                        ...
                        if (!((Boolean)this.eligibleChunksForSpawning.get(var42)).booleanValue())
                        {
                            ...
                            if (!par1WorldServer.getBlock(var14, var15, var16).isNormalCube() && par1WorldServer.getBlock(var14, var15, var16).getMaterial() == var40.getCreatureMaterial())
                            {
                                int var17 = 0;
                                int var18 = 0;
                                    ...
                                    while (true)
                                    {
                                        if (var25 < 4)
                                        {
                                            label113:
                                            {
                                                ...
                                                if (canCreatureTypeSpawnAtLocation(var40, par1WorldServer, var19, var20, var21))
                                                {
                                                    ...
                                                    if (par1WorldServer.getClosestPlayer((double)var26, (double)var27, (double)var28, 24.0D) == null)
                                                    {
                                                        ...
                                                        if (var32 >= 576.0F)
                                                        {
                                                            if (var23 == null)
                                                            {
                                                                var23 = par1WorldServer.spawnRandomCreature(var40, var19, var20, var21);
