...
public class ChunkLoader {
	...
	public static void convertToAnvilFormat(
			ChunkLoader.AnvilConverterData p_76690_0_,
			NBTTagCompound p_76690_1_, WorldChunkManager p_76690_2_) {
		...
		for (int var5 = 0; var5 < 8; ++var5) {
			...
			for (var7 = 0; var7 < 16 && var6; ++var7) {
				...
				while (var8 < 16 && var6) {
					...
					while (true) {
						if (var9 < 16) {
							final int var10 = var7 << 11 | var9 << 7 | var8
									+ (var5 << 4);
							final byte var11 = p_76690_0_.blocks[var10];
			...
			if (!var6) {
				final byte[] var19 = new byte[4096];
				final NibbleArray var20 = new NibbleArray(var19.length, 4);
				final NibbleArray var21 = new NibbleArray(var19.length, 4);
				final NibbleArray var22 = new NibbleArray(var19.length, 4);

				for (int var23 = 0; var23 < 16; ++var23) {
					for (int var12 = 0; var12 < 16; ++var12) {
						for (int var13 = 0; var13 < 16; ++var13) {
							final int var14 = var23 << 11 | var13 << 7 | var12
									+ (var5 << 4);
							final byte var15 = p_76690_0_.blocks[var14];
							var19[var12 << 8 | var13 << 4 | var23] = (byte) (var15 & 255);
							var20.set(
									var23,
									var12,
									var13,
									p_76690_0_.data.get(var23, var12
											+ (var5 << 4), var13));
							var21.set(
									var23,
									var12,
									var13,
									p_76690_0_.skyLight.get(var23, var12
											+ (var5 << 4), var13));
							var22.set(
									var23,
									var12,
									var13,
									p_76690_0_.blockLight.get(var23, var12
											+ (var5 << 4), var13));
						}
					}
				}

				final NBTTagCompound var24 = new NBTTagCompound();
		...
		final byte[] var17 = new byte[256];

		for (int var18 = 0; var18 < 16; ++var18) {
			for (var7 = 0; var7 < 16; ++var7) {
				var17[var7 << 4 | var18] = (byte) (p_76690_2_.getBiomeGenAt(
						p_76690_0_.x << 4 | var18, p_76690_0_.z << 4 | var7).biomeID & 255);
			}
		}
	...
	public static ChunkLoader.AnvilConverterData load(NBTTagCompound p_76691_0_) {
		...
		final ChunkLoader.AnvilConverterData var3 = new ChunkLoader.AnvilConverterData(
				var1, var2);
		...
		var3.skyLight = new NibbleArrayReader(
				p_76691_0_.getByteArray("SkyLight"), 7);
		var3.blockLight = new NibbleArrayReader(
				p_76691_0_.getByteArray("BlockLight"), 7);
