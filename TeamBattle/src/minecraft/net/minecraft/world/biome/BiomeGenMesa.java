...
public class BiomeGenMesa extends BiomeGenBase {
	...
	protected BiomeGenBase func_150566_k() {
		final boolean var1 = biomeID == BiomeGenBase.field_150589_Z.biomeID;
		final BiomeGenMesa var2 = new BiomeGenMesa(biomeID + 128, var1,
				field_150620_aI);
	...
	public void func_150573_a(World p_150573_1_, Random p_150573_2_,
		...
		if (field_150623_aE == null || field_150624_aF == null
				|| field_150622_aD != p_150573_1_.getSeed()) {
			final Random var9 = new Random(field_150622_aD);
		...
		if (field_150626_aH) {
			...
			final double var13 = Math
					.min(Math.abs(p_150573_7_), field_150623_aE.func_151601_a(
							var11 * 0.25D, var12 * 0.25D));

			if (var13 > 0.0D) {
				final double var15 = 0.001953125D;
				final double var17 = Math.abs(field_150624_aF.func_151601_a(
						var11 * var15, var12 * var15));
				var25 = var13 * var13 * 2.5D;
				final double var19 = Math.ceil(var17 * 50.0D) + 14.0D;
		...
		final int var16 = (int) (p_150573_7_ / 3.0D + 3.0D + p_150573_2_
				.nextDouble() * 0.25D);
		final boolean var28 = Math.cos(p_150573_7_ / 3.0D * Math.PI) > 0.0D;
		int var18 = -1;
		boolean var29 = false;
		final int var20 = p_150573_3_.length / 256;

		for (int var21 = 255; var21 >= 0; --var21) {
			final int var22 = (var12 * 16 + var11) * var20 + var21;
			...
			if (var21 <= 0 + p_150573_2_.nextInt(5)) {
				...
				final Block var23 = p_150573_3_[var22];
					...
					if (var23 == Blocks.stone) {
						...
						if (var18 == -1) {
							...
							if (var21 >= 62) {
								if (field_150620_aI && var21 > 86 + var16 * 2) {
									...
									if (var21 >= 64 && var21 <= 127) {
										if (!var28) {
											var24 = func_150618_d(p_150573_5_,
													var21, p_150573_6_);
										}
									} else {
										var24 = 1;
							...
							if (var29) {
								...
								var24 = func_150618_d(p_150573_5_, var21,
										p_150573_6_);
	...
	private byte func_150618_d(int p_150618_1_, int p_150618_2_, int p_150618_3_) {
		final int var4 = (int) Math
				.round(field_150625_aG.func_151601_a(
						p_150618_1_ * 1.0D / 512.0D,
						p_150618_1_ * 1.0D / 512.0D) * 2.0D);
