...
public class BiomeGenTaiga extends BiomeGenBase {
	...
	public void decorate(World p_76728_1_, Random p_76728_2_, int p_76728_3_,
		...
		if (field_150644_aH == 1 || field_150644_aH == 2) {
			...
			for (var6 = 0; var6 < var5; ++var6) {
				...
				field_150643_aG.generate(p_76728_1_, p_76728_2_, var7, var9,
						var8);
			}
		}
		...
		for (var5 = 0; var5 < 7; ++var5) {
			...
			var8 = p_76728_2_
					.nextInt(p_76728_1_.getHeightValue(var6, var7) + 32);
	...
	protected BiomeGenBase func_150566_k() {
		return biomeID == BiomeGenBase.field_150578_U.biomeID ? new BiomeGenTaiga(
				biomeID + 128, 2).func_150557_a(5858897, true)
				.setBiomeName("Mega Spruce Taiga").func_76733_a(5159473)
				.setTemperatureRainfall(0.25F, 0.8F)
				.func_150570_a(new BiomeGenBase.Height(minHeight, maxHeight))
				: super.func_150566_k();
	}

	@Override
	public WorldGenAbstractTree func_150567_a(Random p_150567_1_) {
		return (field_150644_aH == 1 || field_150644_aH == 2)
				&& p_150567_1_.nextInt(3) == 0 ? field_150644_aH != 2
	...
	public WorldGenerator getRandomWorldGenForGrass(Random p_76730_1_) {
		return p_76730_1_.nextInt(5) > 0 ? new WorldGenTallGrass(
