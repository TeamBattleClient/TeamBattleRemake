...
public class BiomeGenSavanna extends BiomeGenBase {
	...
	private static final WorldGenSavannaTree field_150627_aC = new WorldGenSavannaTree(
			false);

	protected BiomeGenSavanna(int p_i45383_1_) {
		super(p_i45383_1_);
		spawnableCreatureList.add(new BiomeGenBase.SpawnListEntry(
				EntityHorse.class, 1, 2, 6));
	...
	public void decorate(World p_76728_1_, Random p_76728_2_, int p_76728_3_,
		...
		for (int var5 = 0; var5 < 7; ++var5) {
			...
			final int var8 = p_76728_2_.nextInt(p_76728_1_.getHeightValue(var6,
					var7) + 32);
	...
	protected BiomeGenBase func_150566_k() {
		final BiomeGenSavanna.Mutated var1 = new BiomeGenSavanna.Mutated(
				biomeID + 128, this);
	...
	public WorldGenAbstractTree func_150567_a(Random p_150567_1_) {
		return p_150567_1_.nextInt(5) > 0 ? field_150627_aC
				: worldGeneratorTrees;
	}
}
