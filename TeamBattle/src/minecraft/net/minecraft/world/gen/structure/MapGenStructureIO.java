...
public class MapGenStructureIO {
	...
	public static StructureComponent func_143032_b(NBTTagCompound p_143032_0_,
		...
		try {
			final Class var3 = (Class) field_143039_c.get(p_143032_0_
					.getString("id"));
	...
	public static StructureStart func_143035_a(NBTTagCompound p_143035_0_,
			World p_143035_1_) {
		StructureStart var2 = null;

		try {
			final Class var3 = (Class) field_143040_a.get(p_143035_0_
					.getString("id"));
