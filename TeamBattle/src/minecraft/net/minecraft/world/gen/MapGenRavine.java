...
public class MapGenRavine extends MapGenBase {
	...
	protected void func_151538_a(World p_151538_1_, int p_151538_2_,
		...
		if (rand.nextInt(50) == 0) {
			final double var7 = p_151538_2_ * 16 + rand.nextInt(16);
			final double var9 = rand.nextInt(rand.nextInt(40) + 8) + 20;
			final double var11 = p_151538_3_ * 16 + rand.nextInt(16);
			final byte var13 = 1;
			...
			for (int var14 = 0; var14 < var13; ++var14) {
				...
				func_151540_a(rand.nextLong(), p_151538_4_, p_151538_5_,
						p_151538_6_, var7, var9, var11, var17, var15, var16, 0,
						0, 3.0D);
			}
		}
	}

	protected void func_151540_a(long p_151540_1_, int p_151540_3_,
			int p_151540_4_, Block[] p_151540_5_, double p_151540_6_,
			double p_151540_8_, double p_151540_10_, float p_151540_12_,
			float p_151540_13_, float p_151540_14_, int p_151540_15_,
			int p_151540_16_, double p_151540_17_) {
		final Random var19 = new Random(p_151540_1_);
		final double var20 = p_151540_3_ * 16 + 8;
		final double var22 = p_151540_4_ * 16 + 8;
		float var24 = 0.0F;
		float var25 = 0.0F;
		...
		for (; p_151540_15_ < p_151540_16_; ++p_151540_15_) {
			...
			final float var32 = MathHelper.cos(p_151540_14_);
			final float var33 = MathHelper.sin(p_151540_14_);
			...
			var25 *= 0.8F;
			var24 *= 0.5F;
			var25 += (var19.nextFloat() - var19.nextFloat())
					* var19.nextFloat() * 2.0F;
			var24 += (var19.nextFloat() - var19.nextFloat())
					* var19.nextFloat() * 4.0F;

			if (var53 || var19.nextInt(4) != 0) {
				final double var34 = p_151540_6_ - var20;
				final double var36 = p_151540_10_ - var22;
				final double var38 = p_151540_16_ - p_151540_15_;
				final double var40 = p_151540_12_ + 2.0F + 16.0F;

				if (var34 * var34 + var36 * var36 - var38 * var38 > var40
						* var40)
					return;

				if (p_151540_6_ >= var20 - 16.0D - var54 * 2.0D
						&& p_151540_10_ >= var22 - 16.0D - var54 * 2.0D
						&& p_151540_6_ <= var20 + 16.0D + var54 * 2.0D
						&& p_151540_10_ <= var22 + 16.0D + var54 * 2.0D) {
					int var55 = MathHelper.floor_double(p_151540_6_ - var54)
							- p_151540_3_ * 16 - 1;
					int var35 = MathHelper.floor_double(p_151540_6_ + var54)
							- p_151540_3_ * 16 + 1;
					int var56 = MathHelper.floor_double(p_151540_8_ - var30) - 1;
					int var37 = MathHelper.floor_double(p_151540_8_ + var30) + 1;
					int var57 = MathHelper.floor_double(p_151540_10_ - var54)
							- p_151540_4_ * 16 - 1;
					int var39 = MathHelper.floor_double(p_151540_10_ + var54)
							- p_151540_4_ * 16 + 1;
					...
					for (var41 = var55; !var58 && var41 < var35; ++var41) {
						for (int var42 = var57; !var58 && var42 < var39; ++var42) {
							for (int var43 = var37 + 1; !var58
									&& var43 >= var56 - 1; --var43) {
								var44 = (var41 * 16 + var42) * 256 + var43;

								if (var43 >= 0 && var43 < 256) {
									final Block var45 = p_151540_5_[var44];

									if (var45 == Blocks.flowing_water
											|| var45 == Blocks.water) {
										var58 = true;
									}

									if (var43 != var56 - 1 && var41 != var55
											&& var41 != var35 - 1
											&& var42 != var57
											&& var42 != var39 - 1) {
										var43 = var56;
					...
					if (!var58) {
						for (var41 = var55; var41 < var35; ++var41) {
							final double var59 = (var41 + p_151540_3_ * 16
									+ 0.5D - p_151540_6_)
									/ var54;

							for (var44 = var57; var44 < var39; ++var44) {
								final double var60 = (var44 + p_151540_4_ * 16
										+ 0.5D - p_151540_10_)
										/ var54;
								...
								if (var59 * var59 + var60 * var60 < 1.0D) {
									for (int var49 = var37 - 1; var49 >= var56; --var49) {
										final double var50 = (var49 + 0.5D - p_151540_8_)
												/ var30;

										if ((var59 * var59 + var60 * var60)
												* field_75046_d[var49] + var50
												* var50 / 6.0D < 1.0D) {
											final Block var52 = p_151540_5_[var47];

											if (var52 == Blocks.grass) {
												var48 = true;
											}

											if (var52 == Blocks.stone
													|| var52 == Blocks.dirt
													|| var52 == Blocks.grass) {
												if (var49 < 10) {
													...
													if (var48
															&& p_151540_5_[var47 - 1] == Blocks.dirt) {
														p_151540_5_[var47 - 1] = worldObj
