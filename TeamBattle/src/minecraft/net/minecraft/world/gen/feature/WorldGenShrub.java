...
public class WorldGenShrub extends WorldGenTrees {
	...
	public boolean generate(World p_76484_1_, Random p_76484_2_,
		...
		final Block var7 = p_76484_1_.getBlock(p_76484_3_, p_76484_4_,
				p_76484_5_);

		if (var7 == Blocks.dirt || var7 == Blocks.grass) {
			++p_76484_4_;
			func_150516_a(p_76484_1_, p_76484_3_, p_76484_4_, p_76484_5_,
					Blocks.log, field_150527_b);

			for (int var8 = p_76484_4_; var8 <= p_76484_4_ + 2; ++var8) {
				final int var9 = var8 - p_76484_4_;
				final int var10 = 2 - var9;

				for (int var11 = p_76484_3_ - var10; var11 <= p_76484_3_
						+ var10; ++var11) {
					...
					for (int var13 = p_76484_5_ - var10; var13 <= p_76484_5_
						...
						if ((Math.abs(var12) != var10
								|| Math.abs(var14) != var10 || p_76484_2_
								.nextInt(2) != 0)
								&& !p_76484_1_.getBlock(var11, var8, var13)
										.func_149730_j()) {
							func_150516_a(p_76484_1_, var11, var8, var13,
									Blocks.leaves, field_150528_a);
						}
					}
				}
			}
