...
public class WorldGeneratorBonusChest extends WorldGenerator {
	...
	public WorldGeneratorBonusChest(WeightedRandomChestContent[] p_i2010_1_,
			int p_i2010_2_) {
	...
	public boolean generate(World p_76484_1_, Random p_76484_2_,
		...
		if (p_76484_4_ < 1)
			...
			for (int var7 = 0; var7 < 4; ++var7) {
				final int var8 = p_76484_3_ + p_76484_2_.nextInt(4)
						- p_76484_2_.nextInt(4);
				final int var9 = p_76484_4_ + p_76484_2_.nextInt(3)
						- p_76484_2_.nextInt(3);
				final int var10 = p_76484_5_ + p_76484_2_.nextInt(4)
						- p_76484_2_.nextInt(4);

				if (p_76484_1_.isAirBlock(var8, var9, var10)
						&& World.doesBlockHaveSolidTopSurface(p_76484_1_, var8,
								var9 - 1, var10)) {
					p_76484_1_.setBlock(var8, var9, var10, Blocks.chest, 0, 2);
					final TileEntityChest var11 = (TileEntityChest) p_76484_1_
							.getTileEntity(var8, var9, var10);

					if (var11 != null && var11 != null) {
						WeightedRandomChestContent.generateChestContents(
								p_76484_2_, theBonusChestGenerator, var11,
								itemsToGenerateInBonusChest);
					}

					if (p_76484_1_.isAirBlock(var8 - 1, var9, var10)
							&& World.doesBlockHaveSolidTopSurface(p_76484_1_,
									var8 - 1, var9 - 1, var10)) {
						p_76484_1_.setBlock(var8 - 1, var9, var10,
								Blocks.torch, 0, 2);
					}
					...
					if (p_76484_1_.isAirBlock(var8, var9, var10 - 1)
							&& World.doesBlockHaveSolidTopSurface(p_76484_1_,
									var8 - 1, var9 - 1, var10)) {
						p_76484_1_.setBlock(var8, var9, var10 - 1,
								Blocks.torch, 0, 2);
					}
