	...
	public boolean generate(World p_76484_1_, Random p_76484_2_,
		...
		if (p_76484_4_ >= 1 && p_76484_4_ + var7 + 1 < 256) {
			...
			for (int var9 = p_76484_4_; var9 <= p_76484_4_ + 1 + var7; ++var9) {
				...
				for (var11 = p_76484_3_ - var10; var11 <= p_76484_3_ + var10
						&& var8; ++var11) {
					for (var12 = p_76484_5_ - var10; var12 <= p_76484_5_
							+ var10
							&& var8; ++var12) {
						if (var9 >= 0 && var9 < 256) {
							final Block var13 = p_76484_1_.getBlock(var11,
									var9, var12);

							if (var13.getMaterial() != Material.air
									&& var13.getMaterial() != Material.leaves) {
								var8 = false;
							}
						} else {
							var8 = false;
			...
			if (!var8)
				...
				if (var16 != Blocks.dirt && var16 != Blocks.grass
					...
					for (var11 = var17; var11 <= p_76484_4_ + var7; ++var11) {
						...
						for (int var19 = p_76484_3_ - var12; var19 <= p_76484_3_
								+ var12; ++var19) {
							for (int var14 = p_76484_5_ - var12; var14 <= p_76484_5_
									+ var12; ++var14) {
								int var15 = 5;
								...
								if (var6 == 0 || var11 < p_76484_4_ + var7) {
									if ((var19 == p_76484_3_ - var12 || var19 == p_76484_3_
											+ var12)
											&& (var14 == p_76484_5_ - var12 || var14 == p_76484_5_
													+ var12)) {
										continue;
									}

									if (var19 == p_76484_3_ - (var12 - 1)
											&& var14 == p_76484_5_ - var12) {
										var15 = 1;
									}
								...
								if ((var15 != 0 || p_76484_4_ >= p_76484_4_
										+ var7 - 1)
										&& !p_76484_1_.getBlock(var19, var11,
												var14).func_149730_j()) {
									func_150516_a(
											p_76484_1_,
											var19,
