	...
	public boolean generate(World p_76484_1_, Random p_76484_2_,
		...
		if (p_76484_1_.getBlock(p_76484_3_, p_76484_4_, p_76484_5_) != Blocks.snow)
			...
			for (var8 = 0; var8 < var6; ++var8) {
				final float var9 = (1.0F - (float) var8 / (float) var6) * var7;
						...
						if ((var11 == 0 && var13 == 0 || var12 * var12 + var14
								* var14 <= var9 * var9)
								&& (var11 != -var10 && var11 != var10
										&& var13 != -var10 && var13 != var10 || p_76484_2_
										.nextFloat() <= 0.75F)) {
							Block var15 = p_76484_1_.getBlock(p_76484_3_
									+ var11, p_76484_4_ + var8, p_76484_5_
									+ var13);
							...
							if (var15.getMaterial() == Material.air
									...
									|| var15 == Blocks.snow
									|| var15 == Blocks.ice) {
								func_150515_a(p_76484_1_, p_76484_3_ + var11,
										p_76484_4_ + var8, p_76484_5_ + var13,
										Blocks.packed_ice);
							}

							if (var8 != 0 && var10 > 1) {
								var15 = p_76484_1_.getBlock(p_76484_3_ + var11,
										p_76484_4_ - var8, p_76484_5_ + var13);
								...
								if (var15.getMaterial() == Material.air
										...
										|| var15 == Blocks.snow
										|| var15 == Blocks.ice) {
									func_150515_a(p_76484_1_, p_76484_3_
											+ var11, p_76484_4_ - var8,
											p_76484_5_ + var13,
											Blocks.packed_ice);
								}
							}
					...
					while (true) {
						if (var11 > 50) {
							...
							if (var18.getMaterial() == Material.air
								...
								func_150515_a(p_76484_1_, p_76484_3_ + var16,
										var11, p_76484_5_ + var10,
										Blocks.packed_ice);
								--var11;
								--var17;
