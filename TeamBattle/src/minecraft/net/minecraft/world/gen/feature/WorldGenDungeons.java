	...
	public boolean generate(World p_76484_1_, Random p_76484_2_,
		...
		for (var10 = p_76484_3_ - var7 - 1; var10 <= p_76484_3_ + var7 + 1; ++var10) {
			for (var11 = p_76484_4_ - 1; var11 <= p_76484_4_ + var6 + 1; ++var11) {
				for (var12 = p_76484_5_ - var8 - 1; var12 <= p_76484_5_ + var8
						+ 1; ++var12) {
					final Material var13 = p_76484_1_.getBlock(var10, var11,
							var12).getMaterial();
					...
					if ((var10 == p_76484_3_ - var7 - 1
							|| var10 == p_76484_3_ + var7 + 1
							|| var12 == p_76484_5_ - var8 - 1 || var12 == p_76484_5_
							+ var8 + 1)
							&& var11 == p_76484_4_
		...
		if (var9 >= 1 && var9 <= 5) {
			for (var10 = p_76484_3_ - var7 - 1; var10 <= p_76484_3_ + var7 + 1; ++var10) {
				for (var11 = p_76484_4_ + var6; var11 >= p_76484_4_ - 1; --var11) {
					for (var12 = p_76484_5_ - var8 - 1; var12 <= p_76484_5_
							+ var8 + 1; ++var12) {
						if (var10 != p_76484_3_ - var7 - 1
								&& var11 != p_76484_4_ - 1
								&& var12 != p_76484_5_ - var8 - 1
								&& var10 != p_76484_3_ + var7 + 1
								&& var11 != p_76484_4_ + var6 + 1
								&& var12 != p_76484_5_ + var8 + 1) {
							p_76484_1_.setBlockToAir(var10, var11, var12);
						} else if (var11 >= 0
								&& !p_76484_1_
										.getBlock(var10, var11 - 1, var12)
										.getMaterial().isSolid()) {
							p_76484_1_.setBlockToAir(var10, var11, var12);
						} else if (p_76484_1_.getBlock(var10, var11, var12)
								.getMaterial().isSolid()) {
							if (var11 == p_76484_4_ - 1
									&& p_76484_2_.nextInt(4) != 0) {
								p_76484_1_.setBlock(var10, var11, var12,
			...
			while (var10 < 2) {
				...
				while (true) {
					if (var11 < 3) {
						label101: {
							var12 = p_76484_3_
									+ p_76484_2_.nextInt(var7 * 2 + 1) - var7;
							final int var14 = p_76484_5_
									+ p_76484_2_.nextInt(var8 * 2 + 1) - var8;

							if (p_76484_1_.isAirBlock(var12, p_76484_4_, var14)) {
								int var15 = 0;

								if (p_76484_1_
										.getBlock(var12 - 1, p_76484_4_, var14)
										.getMaterial().isSolid()) {
									++var15;
								}
								...
								if (p_76484_1_
										.getBlock(var12, p_76484_4_, var14 - 1)
										.getMaterial().isSolid()) {
									++var15;
								}
								...
								if (var15 == 1) {
									p_76484_1_.setBlock(var12, p_76484_4_,
											var14, Blocks.chest, 0, 2);
									final WeightedRandomChestContent[] var16 = WeightedRandomChestContent
											.func_92080_a(
													field_111189_a,
													new WeightedRandomChestContent[] { Items.enchanted_book
															.func_92114_b(p_76484_2_) });
									final TileEntityChest var17 = (TileEntityChest) p_76484_1_
											.getTileEntity(var12, p_76484_4_,
													var14);
			...
			final TileEntityMobSpawner var18 = (TileEntityMobSpawner) p_76484_1_
					.getTileEntity(p_76484_3_, p_76484_4_, p_76484_5_);

			if (var18 != null) {
				var18.func_145881_a().setMobID(pickMobSpawner(p_76484_2_));
			} else {
