...
public class WorldGenSpikes extends WorldGenerator {
	...
	public boolean generate(World p_76484_1_, Random p_76484_2_,
		...
		if (p_76484_1_.isAirBlock(p_76484_3_, p_76484_4_, p_76484_5_)
				&& p_76484_1_.getBlock(p_76484_3_, p_76484_4_ - 1, p_76484_5_) == field_150520_a) {
			...
			for (var8 = p_76484_3_ - var7; var8 <= p_76484_3_ + var7; ++var8) {
				for (var9 = p_76484_5_ - var7; var9 <= p_76484_5_ + var7; ++var9) {
					...
					if (var10 * var10 + var11 * var11 <= var7 * var7 + 1
							&& p_76484_1_.getBlock(var8, p_76484_4_ - 1, var9) != field_150520_a)
						return false;
				}
			}
				...
				for (var9 = p_76484_3_ - var7; var9 <= p_76484_3_ + var7; ++var9) {
					for (var10 = p_76484_5_ - var7; var10 <= p_76484_5_ + var7; ++var10) {
						...
						if (var11 * var11 + var12 * var12 <= var7 * var7 + 1) {
							p_76484_1_.setBlock(var9, var8, var10,
									Blocks.obsidian, 0, 2);
						}
					}
				}
			...
			var13.setLocationAndAngles(p_76484_3_ + 0.5F, p_76484_4_ + var6,
					p_76484_5_ + 0.5F, p_76484_2_.nextFloat() * 360.0F, 0.0F);
			p_76484_1_.spawnEntityInWorld(var13);
			p_76484_1_.setBlock(p_76484_3_, p_76484_4_ + var6, p_76484_5_,
					Blocks.bedrock, 0, 2);
			return true;
		} else
			return false;
