...
public interface IWorldAccess {
	 ...
	 */
	void destroyBlockPartially(int p_147587_1_, int p_147587_2_,
	 ...
	 */
	void markBlockForRenderUpdate(int p_147588_1_, int p_147588_2_,
			int p_147588_3_);
	 ...
	 */
	void markBlockRangeForRenderUpdate(int p_147585_1_, int p_147585_2_,
	 ...
	 */
	void playAuxSFX(EntityPlayer p_72706_1_, int p_72706_2_, int p_72706_3_,
			int p_72706_4_, int p_72706_5_, int p_72706_6_);

	/**
	 * Plays the specified record. Arg: recordName, x, y, z
	 */
	void playRecord(String p_72702_1_, int p_72702_2_, int p_72702_3_,
			int p_72702_4_);

	/**
	 * Plays the specified sound. Arg: soundName, x, y, z, volume, pitch
	 */
	void playSound(String p_72704_1_, double p_72704_2_, double p_72704_4_,
			double p_72704_6_, float p_72704_8_, float p_72704_9_);

	/**
	 * Plays sound to all near players except the player reference given
	 */
	void playSoundToNearExcept(EntityPlayer p_85102_1_, String p_85102_2_,
	 ...
	 */
	void spawnParticle(String p_72708_1_, double p_72708_2_, double p_72708_4_,
			double p_72708_6_, double p_72708_8_, double p_72708_10_,
			double p_72708_12_);
}
