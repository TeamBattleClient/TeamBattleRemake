...
public class RealmsMth {
	...
	public static double clamp(double p_clamp_0_, double p_clamp_2_,
			double p_clamp_4_) {
		return MathHelper.clamp_double(p_clamp_0_, p_clamp_2_, p_clamp_4_);
	}

	public static float clamp(float p_clamp_0_, float p_clamp_1_,
			float p_clamp_2_) {
	...
	public static double clampedLerp(double p_clampedLerp_0_,
			double p_clampedLerp_2_, double p_clampedLerp_4_) {
		return MathHelper.denormalizeClamp(p_clampedLerp_0_, p_clampedLerp_2_,
				p_clampedLerp_4_);
	}
	...
	public static double getDouble(String p_getDouble_0_, double p_getDouble_1_) {
		return MathHelper
				.parseDoubleWithDefault(p_getDouble_0_, p_getDouble_1_);
	}

	public static double getDouble(String p_getDouble_0_,
			double p_getDouble_1_, double p_getDouble_3_) {
		return MathHelper.parseDoubleWithDefaultAndMax(p_getDouble_0_,
				p_getDouble_1_, p_getDouble_3_);
	}
	...
	public static int getInt(String p_getInt_0_, int p_getInt_1_,
			int p_getInt_2_) {
		return MathHelper.parseIntWithDefaultAndMax(p_getInt_0_, p_getInt_1_,
				p_getInt_2_);
	}
	...
	public static double nextDouble(Random p_nextDouble_0_,
			double p_nextDouble_1_, double p_nextDouble_3_) {
		return MathHelper.getRandomDoubleInRange(p_nextDouble_0_,
				p_nextDouble_1_, p_nextDouble_3_);
	}

	public static float nextFloat(Random p_nextFloat_0_, float p_nextFloat_1_,
			float p_nextFloat_2_) {
		return MathHelper.randomFloatClamp(p_nextFloat_0_, p_nextFloat_1_,
				p_nextFloat_2_);
	}

	public static int nextInt(Random p_nextInt_0_, int p_nextInt_1_,
			int p_nextInt_2_) {
		return MathHelper.getRandomIntegerInRange(p_nextInt_0_, p_nextInt_1_,
				p_nextInt_2_);
	}
	...
	public static int smallestEncompassingPowerOfTwo(
			int p_smallestEncompassingPowerOfTwo_0_) {
		return MathHelper
				.roundUpToPowerOfTwo(p_smallestEncompassingPowerOfTwo_0_);
	}
