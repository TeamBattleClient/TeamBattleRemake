...
public class Tezzelator {
	...
	public void addOffset(float p_addOffset_1_, float p_addOffset_2_,
	...
	public void offset(double p_offset_1_, double p_offset_3_,
			double p_offset_5_) {
	...
	public TesselatorVertexState sortQuads(float p_sortQuads_1_,
			float p_sortQuads_2_, float p_sortQuads_3_) {
	...
	public void vertex(double p_vertex_1_, double p_vertex_3_,
			double p_vertex_5_) {
		t.addVertex(p_vertex_1_, p_vertex_3_, p_vertex_5_);
	}

	public void vertexUV(double p_vertexUV_1_, double p_vertexUV_3_,
			double p_vertexUV_5_, double p_vertexUV_7_, double p_vertexUV_9_) {
		t.addVertexWithUV(p_vertexUV_1_, p_vertexUV_3_, p_vertexUV_5_,
				p_vertexUV_7_, p_vertexUV_9_);
	}
}
