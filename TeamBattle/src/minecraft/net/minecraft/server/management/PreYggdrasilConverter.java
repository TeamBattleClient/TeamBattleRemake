...
public class PreYggdrasilConverter {
	...
	private static void func_152717_a(MinecraftServer p_152717_0_,
			Collection p_152717_1_, ProfileLookupCallback p_152717_2_) {
		final String[] var3 = Iterators.toArray(
				Iterators.filter(p_152717_1_.iterator(), new Predicate() {
		...
		if (p_152717_0_.isServerInOnlineMode()) {
			p_152717_0_.func_152359_aw().findProfilesByNames(var3,
					Agent.MINECRAFT, p_152717_2_);
		} else {
			...
			for (int var6 = 0; var6 < var5; ++var6) {
				...
				final UUID var8 = EntityPlayer.func_146094_a(new GameProfile(
						(UUID) null, var7));
	...
	public static String func_152719_a(String p_152719_0_) {
		if (!StringUtils.isNullOrEmpty(p_152719_0_)
				&& p_152719_0_.length() <= 16) {
			final MinecraftServer var1 = MinecraftServer.getServer();
			final GameProfile var2 = var1.func_152358_ax().func_152655_a(
					p_152719_0_);
			...
			if (var2 != null && var2.getId() != null)
				...
				final ProfileLookupCallback var4 = new ProfileLookupCallback() {
					...
					public void onProfileLookupSucceeded(
						...
						var1.func_152358_ax().func_152649_a(
								p_onProfileLookupSucceeded_1_);
						var3.add(p_onProfileLookupSucceeded_1_);
					}
				};
				func_152717_a(var1,
						Lists.newArrayList(new String[] { p_152719_0_ }), var4);
				return var3.size() > 0
						&& ((GameProfile) var3.get(0)).getId() != null ? ((GameProfile) var3
						.get(0)).getId().toString() : "";
			} else
				return EntityPlayer.func_146094_a(
						new GameProfile((UUID) null, p_152719_0_)).toString();
		} else
			return p_152719_0_;
	}
}
