...
public class RenderHorse extends RenderLiving {
	private static final ResourceLocation donkeyTextures = new ResourceLocation(
			"textures/entity/horse/donkey.png");
	private static final Map field_110852_a = Maps.newHashMap();
	private static final ResourceLocation muleTextures = new ResourceLocation(
	...
	private ResourceLocation func_110848_b(EntityHorse p_110848_1_) {
		...
		if (var3 == null) {
			...
			Minecraft
					...
					.loadTexture(
							var3,
							new LayeredTexture(p_110848_1_
	...
	protected ResourceLocation getEntityTexture(EntityHorse p_110775_1_) {
		if (!p_110775_1_.func_110239_cn()) {
			...
			return func_110848_b(p_110775_1_);
	}
	 ...
	 */
	protected void renderModel(EntityHorse p_77036_1_, float p_77036_2_,
	...
	protected void renderModel(EntityLivingBase p_77036_1_, float p_77036_2_,
			float p_77036_3_, float p_77036_4_, float p_77036_5_,
			float p_77036_6_, float p_77036_7_) {
		this.renderModel((EntityHorse) p_77036_1_, p_77036_2_, p_77036_3_,
