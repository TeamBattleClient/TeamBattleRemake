...
public class RenderFallingBlock extends Render {
	...
	public void doRender(Entity p_76986_1_, double p_76986_2_,
			...
			float p_76986_9_) {
		this.doRender((EntityFallingBlock) p_76986_1_, p_76986_2_, p_76986_4_,
	 ...
	 * f1). But JAD is pre 1.5 so doesn't do that.
	 */
	public void doRender(EntityFallingBlock p_76986_1_, double p_76986_2_,
			double p_76986_4_, double p_76986_6_, float p_76986_8_,
			float p_76986_9_) {
		...
		if (var11 != null && var11 != var10.getBlock(var12, var13, var14)) {
			...
			if (var11 instanceof BlockAnvil) {
				field_147920_a.blockAccess = var10;
				var15 = Tessellator.instance;
				var15.startDrawingQuads();
				var15.setTranslation((-var12) - 0.5F, (-var13) - 0.5F,
						(-var14) - 0.5F);
				field_147920_a.renderBlockAnvilMetadata((BlockAnvil) var11,
						var12, var13, var14, p_76986_1_.field_145814_a);
				...
				var15.setTranslation((-var12) - 0.5F, (-var13) - 0.5F,
						(-var14) - 0.5F);
				field_147920_a.renderBlockDragonEgg((BlockDragonEgg) var11,
						var12, var13, var14);
				var15.setTranslation(0.0D, 0.0D, 0.0D);
				var15.draw();
			} else {
				field_147920_a.setRenderBoundsFromBlock(var11);
				field_147920_a.renderBlockSandFalling(var11, var10, var12,
						var13, var14, p_76986_1_.field_145814_a);
			}
