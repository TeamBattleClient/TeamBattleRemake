...
public class RenderLightningBolt extends Render {
	...
	public void doRender(Entity p_76986_1_, double p_76986_2_,
			...
			float p_76986_9_) {
		this.doRender((EntityLightningBolt) p_76986_1_, p_76986_2_, p_76986_4_,
	 ...
	 * f1). But JAD is pre 1.5 so doesn't do that.
	 */
	public void doRender(EntityLightningBolt p_76986_1_, double p_76986_2_,
			double p_76986_4_, double p_76986_6_, float p_76986_8_,
			float p_76986_9_) {
		...
		double var13 = 0.0D;
		double var15 = 0.0D;
		final Random var17 = new Random(p_76986_1_.boltVertex);
		...
		for (int var45 = 0; var45 < 4; ++var45) {
			final Random var46 = new Random(p_76986_1_.boltVertex);
			...
			for (int var19 = 0; var19 < 3; ++var19) {
				...
				for (int var26 = var20; var26 >= var21; --var26) {
					final double var27 = var22;
					final double var29 = var24;
					...
					final float var31 = 0.5F;
					var10.setColorRGBA_F(0.9F * var31, 0.9F * var31,
							1.0F * var31, 0.3F);
					...
					for (int var36 = 0; var36 < 5; ++var36) {
						...
						var10.addVertex(var41 + var22, p_76986_4_ + var26 * 16,
								var43 + var24);
						var10.addVertex(var37 + var27, p_76986_4_ + (var26 + 1)
								* 16, var39 + var29);
					}
