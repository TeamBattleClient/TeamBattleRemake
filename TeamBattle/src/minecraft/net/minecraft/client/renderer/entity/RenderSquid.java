...
public class RenderSquid extends RenderLiving {
	...
	public void doRender(Entity p_76986_1_, double p_76986_2_,
			...
			float p_76986_9_) {
		this.doRender((EntitySquid) p_76986_1_, p_76986_2_, p_76986_4_,
	 ...
	 * f1). But JAD is pre 1.5 so doesn't do that.
	 */
	public void doRender(EntitySquid p_76986_1_, double p_76986_2_,
			double p_76986_4_, double p_76986_6_, float p_76986_8_,
			float p_76986_9_) {
	...
	protected float handleRotationFloat(EntitySquid p_77044_1_, float p_77044_2_) {
		return p_77044_1_.lastTentacleAngle
				+ (p_77044_1_.tentacleAngle - p_77044_1_.lastTentacleAngle)
				* p_77044_2_;
	}
	...
	protected void rotateCorpse(EntityLivingBase p_77043_1_, float p_77043_2_,
		...
		this.rotateCorpse((EntitySquid) p_77043_1_, p_77043_2_, p_77043_3_,
				p_77043_4_);
	}

	protected void rotateCorpse(EntitySquid p_77043_1_, float p_77043_2_,
			float p_77043_3_, float p_77043_4_) {
		final float var5 = p_77043_1_.prevSquidPitch
				+ (p_77043_1_.squidPitch - p_77043_1_.prevSquidPitch)
				* p_77043_4_;
		final float var6 = p_77043_1_.prevSquidYaw
				+ (p_77043_1_.squidYaw - p_77043_1_.prevSquidYaw) * p_77043_4_;
