...
public class RenderMinecart extends Render {
	...
	public void doRender(Entity p_76986_1_, double p_76986_2_,
			...
			float p_76986_9_) {
		this.doRender((EntityMinecart) p_76986_1_, p_76986_2_, p_76986_4_,
	 ...
	 * f1). But JAD is pre 1.5 so doesn't do that.
	 */
	public void doRender(EntityMinecart p_76986_1_, double p_76986_2_,
			double p_76986_4_, double p_76986_6_, float p_76986_8_,
			float p_76986_9_) {
		GL11.glPushMatrix();
		...
		final double var15 = p_76986_1_.lastTickPosX
				+ (p_76986_1_.posX - p_76986_1_.lastTickPosX) * p_76986_9_;
		final double var17 = p_76986_1_.lastTickPosY
				+ (p_76986_1_.posY - p_76986_1_.lastTickPosY) * p_76986_9_;
		final double var19 = p_76986_1_.lastTickPosZ
				+ (p_76986_1_.posZ - p_76986_1_.lastTickPosZ) * p_76986_9_;
		final double var21 = 0.30000001192092896D;
		final Vec3 var23 = p_76986_1_.func_70489_a(var15, var17, var19);
		...
		if (var23 != null) {
			...
			Vec3 var27 = var26.addVector(-var25.xCoord, -var25.yCoord,
					-var25.zCoord);
		...
		final float var31 = p_76986_1_.getRollingAmplitude() - p_76986_9_;
		...
		if (var31 > 0.0F) {
			GL11.glRotatef(MathHelper.sin(var31) * var31 * var32 / 10.0F
					* p_76986_1_.getRollingDirection(), 1.0F, 0.0F, 0.0F);
		}

		final int var33 = p_76986_1_.getDisplayTileOffset();
		final Block var28 = p_76986_1_.func_145820_n();
		final int var29 = p_76986_1_.getDisplayTileData();

		if (var28.getRenderType() != -1) {
			GL11.glPushMatrix();
			bindTexture(TextureMap.locationBlocksTexture);
			final float var30 = 0.75F;
			GL11.glScalef(var30, var30, var30);
			GL11.glTranslatef(0.0F, var33 / 16.0F, 0.0F);
			func_147910_a(p_76986_1_, p_76986_9_, var28, var29);
			GL11.glPopMatrix();
		...
		modelMinecart
				.render(p_76986_1_, 0.0F, 0.0F, -0.1F, 0.0F, 0.0F, 0.0625F);
		GL11.glPopMatrix();
	}

	protected void func_147910_a(EntityMinecart p_147910_1_, float p_147910_2_,
			Block p_147910_3_, int p_147910_4_) {
		final float var5 = p_147910_1_.getBrightness(p_147910_2_);
		GL11.glPushMatrix();
		field_94145_f.renderBlockAsItem(p_147910_3_, p_147910_4_, var5);
		GL11.glPopMatrix();
	}
