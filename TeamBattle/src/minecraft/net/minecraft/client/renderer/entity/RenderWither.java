...
public class RenderWither extends RenderLiving {
	...
	private static final ResourceLocation witherTextures = new ResourceLocation(
	...
	public void doRender(Entity p_76986_1_, double p_76986_2_,
			...
			float p_76986_9_) {
		this.doRender((EntityWither) p_76986_1_, p_76986_2_, p_76986_4_,
	 ...
	 * f1). But JAD is pre 1.5 so doesn't do that.
	 */
	public void doRender(EntityWither p_76986_1_, double p_76986_2_,
			double p_76986_4_, double p_76986_6_, float p_76986_8_,
			float p_76986_9_) {
		BossStatus.setBossStatus(p_76986_1_, true);
		final int var10 = ((ModelWither) mainModel).func_82903_a();
	...
	protected ResourceLocation getEntityTexture(EntityWither p_110775_1_) {
		...
		return var2 > 0 && (var2 > 80 || var2 / 5 % 2 != 1) ? invulnerableWitherTextures
				: witherTextures;
	}
	...
	protected int inheritRenderPass(EntityLivingBase p_77035_1_,
		...
		return this.inheritRenderPass((EntityWither) p_77035_1_, p_77035_2_,
				p_77035_3_);
	}

	protected int inheritRenderPass(EntityWither p_77035_1_, int p_77035_2_,
			float p_77035_3_) {
		return -1;
	}
	...
	protected int shouldRenderPass(EntityLivingBase p_77032_1_, int p_77032_2_,
			float p_77032_3_) {
		return this.shouldRenderPass((EntityWither) p_77032_1_, p_77032_2_,
				p_77032_3_);
	}
	 ...
	 * Queries whether should render the specified pass or not.
	 */
	protected int shouldRenderPass(EntityWither p_77032_1_, int p_77032_2_,
			float p_77032_3_) {
