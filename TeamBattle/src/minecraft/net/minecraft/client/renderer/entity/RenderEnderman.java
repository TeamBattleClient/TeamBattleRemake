...
public class RenderEnderman extends RenderLiving {
	...
	public void doRender(Entity p_76986_1_, double p_76986_2_,
			...
			float p_76986_9_) {
		this.doRender((EntityEnderman) p_76986_1_, p_76986_2_, p_76986_4_,
	 ...
	 * f1). But JAD is pre 1.5 so doesn't do that.
	 */
	public void doRender(EntityEnderman p_76986_1_, double p_76986_2_,
			double p_76986_4_, double p_76986_6_, float p_76986_8_,
			float p_76986_9_) {
		endermanModel.isCarrying = p_76986_1_.func_146080_bZ().getMaterial() != Material.air;
	...
	protected void renderEquippedItems(EntityEnderman p_77029_1_,
		...
		if (p_77029_1_.func_146080_bZ().getMaterial() != Material.air) {
			...
			field_147909_c.renderBlockAsItem(p_77029_1_.func_146080_bZ(),
					p_77029_1_.getCarryingData(), 1.0F);
			GL11.glPopMatrix();
	 ...
	 */
	protected int shouldRenderPass(EntityEnderman p_77032_1_, int p_77032_2_,
			float p_77032_3_) {
		if (p_77032_2_ != 0)
			return -1;
		else {
	...
	protected int shouldRenderPass(EntityLivingBase p_77032_1_, int p_77032_2_,
			float p_77032_3_) {
		return this.shouldRenderPass((EntityEnderman) p_77032_1_, p_77032_2_,
				p_77032_3_);
	}
}
