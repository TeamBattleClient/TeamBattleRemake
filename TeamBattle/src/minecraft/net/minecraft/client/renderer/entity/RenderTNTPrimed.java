...
public class RenderTNTPrimed extends Render {
	...
	public void doRender(Entity p_76986_1_, double p_76986_2_,
			...
			float p_76986_9_) {
		this.doRender((EntityTNTPrimed) p_76986_1_, p_76986_2_, p_76986_4_,
	 ...
	 * f1). But JAD is pre 1.5 so doesn't do that.
	 */
	public void doRender(EntityTNTPrimed p_76986_1_, double p_76986_2_,
			double p_76986_4_, double p_76986_6_, float p_76986_8_,
			float p_76986_9_) {
		GL11.glPushMatrix();
		...
		if (p_76986_1_.fuse - p_76986_9_ + 1.0F < 10.0F) {
			var10 = 1.0F - (p_76986_1_.fuse - p_76986_9_ + 1.0F) / 10.0F;
		...
		var10 = (1.0F - (p_76986_1_.fuse - p_76986_9_ + 1.0F) / 100.0F) * 0.8F;
		bindEntityTexture(p_76986_1_);
		blockRenderer.renderBlockAsItem(Blocks.tnt, 0,
				p_76986_1_.getBrightness(p_76986_9_));
