...
public class RenderChicken extends RenderLiving {
	...
	public void doRender(Entity p_76986_1_, double p_76986_2_,
			...
			float p_76986_9_) {
		this.doRender((EntityChicken) p_76986_1_, p_76986_2_, p_76986_4_,
	 ...
	 * f1). But JAD is pre 1.5 so doesn't do that.
	 */
	public void doRender(EntityChicken p_76986_1_, double p_76986_2_,
			double p_76986_4_, double p_76986_6_, float p_76986_8_,
			float p_76986_9_) {
	...
	protected float handleRotationFloat(EntityChicken p_77044_1_,
			float p_77044_2_) {
		final float var3 = p_77044_1_.field_70888_h
				+ (p_77044_1_.field_70886_e - p_77044_1_.field_70888_h)
				* p_77044_2_;
		final float var4 = p_77044_1_.field_70884_g
				+ (p_77044_1_.destPos - p_77044_1_.field_70884_g) * p_77044_2_;
