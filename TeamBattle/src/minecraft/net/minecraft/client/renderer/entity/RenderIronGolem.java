...
public class RenderIronGolem extends RenderLiving {
	private static final ResourceLocation ironGolemTextures = new ResourceLocation(
	...
	public RenderIronGolem() {
		...
		ironGolemModel = (ModelIronGolem) mainModel;
	}
	...
	public void doRender(Entity p_76986_1_, double p_76986_2_,
			...
			float p_76986_9_) {
		this.doRender((EntityIronGolem) p_76986_1_, p_76986_2_, p_76986_4_,
	 ...
	 * f1). But JAD is pre 1.5 so doesn't do that.
	 */
	public void doRender(EntityIronGolem p_76986_1_, double p_76986_2_,
			double p_76986_4_, double p_76986_6_, float p_76986_8_,
			float p_76986_9_) {
	...
	protected void renderEquippedItems(EntityIronGolem p_77029_1_,
		...
		if (p_77029_1_.getHoldRoseTick() != 0) {
			...
			GL11.glPushMatrix();
			GL11.glRotatef(5.0F + 180.0F
					* ironGolemModel.ironGolemRightArm.rotateAngleX
	...
	protected void rotateCorpse(EntityIronGolem p_77043_1_, float p_77043_2_,
			float p_77043_3_, float p_77043_4_) {
		super.rotateCorpse(p_77043_1_, p_77043_2_, p_77043_3_, p_77043_4_);

		if (p_77043_1_.limbSwingAmount >= 0.01D) {
			final float var5 = 13.0F;
			final float var6 = p_77043_1_.limbSwing
					- p_77043_1_.limbSwingAmount * (1.0F - p_77043_4_) + 6.0F;
			final float var7 = (Math.abs(var6 % var5 - var5 * 0.5F) - var5 * 0.25F)
					/ (var5 * 0.25F);
	...
	protected void rotateCorpse(EntityLivingBase p_77043_1_, float p_77043_2_,
			float p_77043_3_, float p_77043_4_) {
		this.rotateCorpse((EntityIronGolem) p_77043_1_, p_77043_2_, p_77043_3_,
				p_77043_4_);
	}
}
