...
public class RenderPig extends RenderLiving {
	private static final ResourceLocation pigTextures = new ResourceLocation(
	...
	public RenderPig(ModelBase p_i1265_1_, ModelBase p_i1265_2_,
			float p_i1265_3_) {
	...
	protected int shouldRenderPass(EntityLivingBase p_77032_1_, int p_77032_2_,
			float p_77032_3_) {
		return this.shouldRenderPass((EntityPig) p_77032_1_, p_77032_2_,
				p_77032_3_);
	}
	 ...
	 * Queries whether should render the specified pass or not.
	 */
	protected int shouldRenderPass(EntityPig p_77032_1_, int p_77032_2_,
			float p_77032_3_) {
