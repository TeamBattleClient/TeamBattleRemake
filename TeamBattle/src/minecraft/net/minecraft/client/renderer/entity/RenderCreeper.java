...
public class RenderCreeper extends RenderLiving {
	 ...
	 * partialTickTime
	 */
	protected int getColorMultiplier(EntityCreeper p_77030_1_,
	...
	protected int getColorMultiplier(EntityLivingBase p_77030_1_,
			float p_77030_2_, float p_77030_3_) {
		return this.getColorMultiplier((EntityCreeper) p_77030_1_, p_77030_2_,
				p_77030_3_);
	}
	...
	protected int inheritRenderPass(EntityCreeper p_77035_1_, int p_77035_2_,
			float p_77035_3_) {
		return -1;
	}
	...
	protected int inheritRenderPass(EntityLivingBase p_77035_1_,
		...
		return this.inheritRenderPass((EntityCreeper) p_77035_1_, p_77035_2_,
				p_77035_3_);
	}
	 ...
	 */
	protected int shouldRenderPass(EntityCreeper p_77032_1_, int p_77032_2_,
			float p_77032_3_) {
	...
	protected int shouldRenderPass(EntityLivingBase p_77032_1_, int p_77032_2_,
			float p_77032_3_) {
		return this.shouldRenderPass((EntityCreeper) p_77032_1_, p_77032_2_,
				p_77032_3_);
	}
}
