...
public class RenderWolf extends RenderLiving {
	...
	private static final ResourceLocation wolfTextures = new ResourceLocation(
			"textures/entity/wolf/wolf.png");

	public RenderWolf(ModelBase p_i1269_1_, ModelBase p_i1269_2_,
			float p_i1269_3_) {
	...
	protected ResourceLocation getEntityTexture(EntityWolf p_110775_1_) {
		return p_110775_1_.isTamed() ? tamedWolfTextures : p_110775_1_
				.isAngry() ? anrgyWolfTextures : wolfTextures;
	}
	...
	protected int shouldRenderPass(EntityLivingBase p_77032_1_, int p_77032_2_,
			float p_77032_3_) {
		return this.shouldRenderPass((EntityWolf) p_77032_1_, p_77032_2_,
				p_77032_3_);
	}
	 ...
	 * Queries whether should render the specified pass or not.
	 */
	protected int shouldRenderPass(EntityWolf p_77032_1_, int p_77032_2_,
			float p_77032_3_) {
		if (p_77032_2_ == 0 && p_77032_1_.getWolfShaking()) {
			final float var5 = p_77032_1_.getBrightness(p_77032_3_)
					* p_77032_1_.getShadingWhileShaking(p_77032_3_);
			...
			final int var4 = p_77032_1_.getCollarColor();
