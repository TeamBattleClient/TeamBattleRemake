...
public class RenderBat extends RenderLiving {
	...
	public void doRender(Entity p_76986_1_, double p_76986_2_,
			...
			float p_76986_9_) {
		this.doRender((EntityBat) p_76986_1_, p_76986_2_, p_76986_4_,
	 ...
	 * f1). But JAD is pre 1.5 so doesn't do that.
	 */
	public void doRender(EntityBat p_76986_1_, double p_76986_2_,
			double p_76986_4_, double p_76986_6_, float p_76986_8_,
			float p_76986_9_) {
	 ...
	 */
	protected void renderLivingAt(EntityBat p_77039_1_, double p_77039_2_,
			double p_77039_4_, double p_77039_6_) {
	...
	protected void renderLivingAt(EntityLivingBase p_77039_1_,
		...
		this.renderLivingAt((EntityBat) p_77039_1_, p_77039_2_, p_77039_4_,
				p_77039_6_);
	}

	protected void rotateCorpse(EntityBat p_77043_1_, float p_77043_2_,
			float p_77043_3_, float p_77043_4_) {
		if (!p_77043_1_.getIsBatHanging()) {
			GL11.glTranslatef(0.0F, MathHelper.cos(p_77043_2_ * 0.3F) * 0.1F,
					0.0F);
		} else {
	...
	protected void rotateCorpse(EntityLivingBase p_77043_1_, float p_77043_2_,
			float p_77043_3_, float p_77043_4_) {
		this.rotateCorpse((EntityBat) p_77043_1_, p_77043_2_, p_77043_3_,
				p_77043_4_);
	}
}
