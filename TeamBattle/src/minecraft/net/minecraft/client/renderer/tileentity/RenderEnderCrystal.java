...
public class RenderEnderCrystal extends Render {
	...
	public void doRender(Entity p_76986_1_, double p_76986_2_,
			...
			float p_76986_9_) {
		this.doRender((EntityEnderCrystal) p_76986_1_, p_76986_2_, p_76986_4_,
	 ...
	 * f1). But JAD is pre 1.5 so doesn't do that.
	 */
	public void doRender(EntityEnderCrystal p_76986_1_, double p_76986_2_,
			double p_76986_4_, double p_76986_6_, float p_76986_8_,
			float p_76986_9_) {
		...
		var11 += var11 * var11;
		field_76995_b.render(p_76986_1_, 0.0F, var10 * 3.0F, var11 * 0.2F,
				0.0F, 0.0F, 0.0625F);
		GL11.glPopMatrix();
	}
