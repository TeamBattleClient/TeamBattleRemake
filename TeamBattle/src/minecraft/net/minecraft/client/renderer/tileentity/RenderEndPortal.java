...
public class RenderEndPortal extends TileEntitySpecialRenderer {
	private static final ResourceLocation field_147526_d = new ResourceLocation(
			"textures/entity/end_portal.png");
	private static final Random field_147527_e = new Random(31100L);
	private static final ResourceLocation field_147529_c = new ResourceLocation(
			"textures/environment/end_sky.png");
	FloatBuffer field_147528_b = GLAllocation.createDirectFloatBuffer(16);

	private FloatBuffer func_147525_a(float p_147525_1_, float p_147525_2_,
			float p_147525_3_, float p_147525_4_) {
		field_147528_b.clear();
		field_147528_b.put(p_147525_1_).put(p_147525_2_).put(p_147525_3_)
				.put(p_147525_4_);
		field_147528_b.flip();
	...
	public void renderTileEntityAt(TileEntity p_147500_1_, double p_147500_2_,
		...
		this.renderTileEntityAt((TileEntityEndPortal) p_147500_1_, p_147500_2_,
	...
	public void renderTileEntityAt(TileEntityEndPortal p_147500_1_,
			...
			float p_147500_8_) {
		final float var9 = (float) field_147501_a.field_147560_j;
		final float var10 = (float) field_147501_a.field_147561_k;
		final float var11 = (float) field_147501_a.field_147558_l;
		...
		for (int var13 = 0; var13 < 16; ++var13) {
			...
			GL11.glTexGen(GL11.GL_S, GL11.GL_OBJECT_PLANE,
					func_147525_a(1.0F, 0.0F, 0.0F, 0.0F));
			GL11.glTexGen(GL11.GL_T, GL11.GL_OBJECT_PLANE,
					func_147525_a(0.0F, 0.0F, 1.0F, 0.0F));
			GL11.glTexGen(GL11.GL_R, GL11.GL_OBJECT_PLANE,
					func_147525_a(0.0F, 0.0F, 0.0F, 1.0F));
			GL11.glTexGen(GL11.GL_Q, GL11.GL_EYE_PLANE,
					func_147525_a(0.0F, 1.0F, 0.0F, 0.0F));
			...
			GL11.glTranslatef(0.0F,
					Minecraft.getSystemTime() % 700000L / 700000.0F, 0.0F);
			GL11.glScalef(var15, var15, var15);
			GL11.glTranslatef(0.5F, 0.5F, 0.0F);
			GL11.glRotatef((var13 * var13 * 4321 + var13 * 9) * 2.0F, 0.0F,
					0.0F, 1.0F);
			GL11.glTranslatef(-0.5F, -0.5F, 0.0F);
			GL11.glTranslatef(-var9, -var11, -var10);
			var18 = var17 + ActiveRenderInfo.objectY;
			GL11.glTranslatef(ActiveRenderInfo.objectX * var14 / var18,
					ActiveRenderInfo.objectZ * var14 / var18, -var10);
			...
			var23.setColorRGBA_F(var20 * var16, var21 * var16, var22 * var16,
					1.0F);
			var23.addVertex(p_147500_2_, p_147500_4_ + var12, p_147500_6_);
			var23.addVertex(p_147500_2_, p_147500_4_ + var12,
					p_147500_6_ + 1.0D);
			var23.addVertex(p_147500_2_ + 1.0D, p_147500_4_ + var12,
					p_147500_6_ + 1.0D);
			var23.addVertex(p_147500_2_ + 1.0D, p_147500_4_ + var12,
					p_147500_6_);
			var23.draw();
