...
public class RenderWitherSkull extends Render {
	...
	public void doRender(Entity p_76986_1_, double p_76986_2_,
			...
			float p_76986_9_) {
		this.doRender((EntityWitherSkull) p_76986_1_, p_76986_2_, p_76986_4_,
	 ...
	 * f1). But JAD is pre 1.5 so doesn't do that.
	 */
	public void doRender(EntityWitherSkull p_76986_1_, double p_76986_2_,
			double p_76986_4_, double p_76986_6_, float p_76986_8_,
			float p_76986_9_) {
		GL11.glPushMatrix();
		GL11.glDisable(GL11.GL_CULL_FACE);
		final float var10 = func_82400_a(p_76986_1_.prevRotationYaw,
				p_76986_1_.rotationYaw, p_76986_9_);
		...
		skeletonHeadModel.render(p_76986_1_, 0.0F, 0.0F, 0.0F, var10, var11,
				var12);
		GL11.glPopMatrix();
	}

	private float func_82400_a(float p_82400_1_, float p_82400_2_,
			float p_82400_3_) {
		float var4;
	...
	protected ResourceLocation getEntityTexture(EntityWitherSkull p_110775_1_) {
		return p_110775_1_.isInvulnerable() ? invulnerableWitherTextures
				: witherTextures;
	}
}
