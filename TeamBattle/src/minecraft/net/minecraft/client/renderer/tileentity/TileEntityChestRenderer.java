...
public class TileEntityChestRenderer extends TileEntitySpecialRenderer {
	private static final ResourceLocation field_147503_f = new ResourceLocation(
	...
	private static final ResourceLocation field_147506_e = new ResourceLocation(
	...
	public void renderTileEntityAt(TileEntity p_147500_1_, double p_147500_2_,
		...
		this.renderTileEntityAt((TileEntityChest) p_147500_1_, p_147500_2_,
	...
	public void renderTileEntityAt(TileEntityChest p_147500_1_,
		...
		if (!p_147500_1_.hasWorldObj()) {
			...
			if (var10 instanceof BlockChest && var9 == 0) {
				((BlockChest) var10).func_149954_e(p_147500_1_.getWorldObj(),
		...
		if (p_147500_1_.field_145992_i == null
				&& p_147500_1_.field_145991_k == null) {
			ModelChest var14;

			if (p_147500_1_.field_145990_j == null
					&& p_147500_1_.field_145988_l == null) {
				var14 = field_147510_h;
			...
			GL11.glTranslatef((float) p_147500_2_, (float) p_147500_4_ + 1.0F,
					(float) p_147500_6_ + 1.0F);
			...
			float var12 = p_147500_1_.field_145986_n
					+ (p_147500_1_.field_145989_m - p_147500_1_.field_145986_n)
					* p_147500_8_;
			float var13;
