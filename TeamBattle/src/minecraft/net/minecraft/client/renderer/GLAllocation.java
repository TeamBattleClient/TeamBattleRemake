...
public class GLAllocation {
	...
	public static synchronized ByteBuffer createDirectByteBuffer(int p_74524_0_) {
		return ByteBuffer.allocateDirect(p_74524_0_).order(
	...
	public static synchronized void deleteDisplayLists(int p_74523_0_) {
		GL11.glDeleteLists(p_74523_0_, ((Integer) mapDisplayLists
				.remove(Integer.valueOf(p_74523_0_))).intValue());
	}
	...
	public static synchronized void deleteTexturesAndDisplayLists() {
		final Iterator var0 = mapDisplayLists.entrySet().iterator();

		while (var0.hasNext()) {
			final Entry var1 = (Entry) var0.next();
