...
public class JsonBlendingMode {
	...
	private static int func_148107_b(String p_148107_0_) {
		...
		return var1.equals("0") ? 0 : var1.equals("1") ? 1 : var1
				.equals("srccolor") ? 768 : var1.equals("1-srccolor") ? 769
				: var1.equals("dstcolor") ? 774
						: var1.equals("1-dstcolor") ? 775 : var1
								.equals("srcalpha") ? 770 : var1
								.equals("1-srcalpha") ? 771 : var1
								.equals("dstalpha") ? 772 : var1
								.equals("1-dstalpha") ? 773 : -1;
	}

	private static int func_148108_a(String p_148108_0_) {
		final String var1 = p_148108_0_.trim().toLowerCase();
		return var1.equals("add") ? 32774 : var1.equals("subtract") ? 32778
				: var1.equals("reversesubtract") ? 32779 : var1
						.equals("reverse_subtract") ? 32779 : var1
						.equals("min") ? 32775 : var1.equals("max") ? 32776
						: 32774;
	}
	...
	public static JsonBlendingMode func_148110_a(JsonObject p_148110_0_) {
		if (p_148110_0_ == null)
			...
			return var6 ? new JsonBlendingMode() : var7 ? new JsonBlendingMode(
					var2, var3, var4, var5, var1) : new JsonBlendingMode(var2,
					var3, var1);
		}
	}
	...
	private JsonBlendingMode(boolean p_i45084_1_, boolean p_i45084_2_,
			int p_i45084_3_, int p_i45084_4_, int p_i45084_5_, int p_i45084_6_,
			int p_i45084_7_) {
	...
	public JsonBlendingMode(int p_i45085_1_, int p_i45085_2_, int p_i45085_3_) {
		this(false, false, p_i45085_1_, p_i45085_2_, p_i45085_1_, p_i45085_2_,
				p_i45085_3_);
	}

	public JsonBlendingMode(int p_i45086_1_, int p_i45086_2_, int p_i45086_3_,
			int p_i45086_4_, int p_i45086_5_) {
		this(true, false, p_i45086_1_, p_i45086_2_, p_i45086_3_, p_i45086_4_,
				p_i45086_5_);
	}
	...
	public void func_148109_a() {
		if (!equals(field_148118_a)) {
			if (field_148118_a == null
					|| field_148119_h != field_148118_a.func_148111_b()) {
				field_148118_a = this;
			...
			if (field_148113_g) {
				GL14.glBlendFuncSeparate(field_148116_b, field_148114_d,
						field_148117_c, field_148115_e);
			} else {
				GL11.glBlendFunc(field_148116_b, field_148114_d);
			}
		}
	}
