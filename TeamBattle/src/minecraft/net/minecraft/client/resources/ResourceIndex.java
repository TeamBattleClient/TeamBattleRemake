...
public class ResourceIndex {
	...
	public ResourceIndex(File p_i1047_1_, String p_i1047_2_) {
		if (p_i1047_2_ != null) {
			...
			final File var4 = new File(p_i1047_1_, "indexes/" + p_i1047_2_
					+ ".json");
			BufferedReader var5 = null;

			try {
				var5 = Files.newReader(var4, Charsets.UTF_8);
				final JsonObject var6 = new JsonParser().parse(var5)
						.getAsJsonObject();
				final JsonObject var7 = JsonUtils.getJsonObjectFieldOrDefault(
				...
				if (var7 != null) {
					...
					while (var8.hasNext()) {
						...
						final String var13 = var12.length == 1 ? var12[0]
								: var12[0] + ":" + var12[1];
						final String var14 = JsonUtils
								.getJsonObjectStringFieldValue(var10, "hash");
						final File var15 = new File(var3, var14.substring(0, 2)
								+ "/" + var14);
						field_152784_b.put(var13, var15);
					}
				}
			} catch (final JsonParseException var20) {
				field_152783_a.error("Unable to parse resource index file: "
						+ var4);
			} catch (final FileNotFoundException var21) {
				field_152783_a.error("Can\'t find the resource index file: "
						+ var4);
			} finally {
