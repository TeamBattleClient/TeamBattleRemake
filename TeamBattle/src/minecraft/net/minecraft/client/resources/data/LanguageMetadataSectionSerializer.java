...
public class LanguageMetadataSectionSerializer extends
	...
	public LanguageMetadataSection deserialize(JsonElement p_deserialize_1_,
		...
		do {
			...
			final JsonObject var9 = JsonUtils.getJsonElementAsJsonObject(
			...
			var12 = JsonUtils.getJsonObjectBooleanFieldValueOrDefault(var9,
					"bidirectional", false);

			if (var10.isEmpty())
				throw new JsonParseException("Invalid language->\'" + var8
						+ "\'->region: empty value");
		...
		throw new JsonParseException("Duplicate language->\'" + var8
				+ "\' defined");
	}
