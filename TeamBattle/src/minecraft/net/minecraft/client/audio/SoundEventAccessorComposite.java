...
public class SoundEventAccessorComposite implements ISoundEventAccessor {
	...
	public SoundEventAccessorComposite(ResourceLocation p_i45120_1_,
			double p_i45120_2_, double p_i45120_4_, SoundCategory p_i45120_6_) {
		field_148735_c = p_i45120_1_;
		field_148731_f = p_i45120_4_;
		field_148733_e = p_i45120_2_;
		field_148732_d = p_i45120_6_;
	}

	@Override
	public SoundPoolEntry func_148720_g() {
		final int var1 = func_148721_a();

		if (!field_148736_a.isEmpty() && var1 != 0) {
			int var2 = field_148734_b.nextInt(var1);
			final Iterator var3 = field_148736_a.iterator();
			...
			var5.func_148651_a(var5.func_148650_b() * field_148733_e);
			var5.func_148647_b(var5.func_148649_c() * field_148731_f);
			return var5;
		} else
			return SoundHandler.field_147700_a;
	}
	...
	public int func_148721_a() {
		...
		for (final Iterator var2 = field_148736_a.iterator(); var2.hasNext(); var1 += var3
				.func_148721_a()) {
	...
	public void func_148727_a(ISoundEventAccessor p_148727_1_) {
		field_148736_a.add(p_148727_1_);
	}
