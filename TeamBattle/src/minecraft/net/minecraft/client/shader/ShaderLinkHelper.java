...
public class ShaderLinkHelper {
	...
	public void func_148075_b(ShaderManager p_148075_1_) {
		...
		final int var2 = OpenGlHelper.func_153175_a(
				p_148075_1_.func_147986_h(), OpenGlHelper.field_153207_o);

		if (var2 == 0) {
			logger.warn("Error encountered when linking program containing VS "
					+ p_148075_1_.func_147989_e().func_148055_a() + " and FS "
					+ p_148075_1_.func_147994_f().func_148055_a()
					+ ". Log output:");
			logger.warn(OpenGlHelper.func_153166_e(p_148075_1_.func_147986_h(),
					32768));
		}
	}
	...
	public int func_148078_c() throws JsonException {
		...
		if (var1 <= 0)
			throw new JsonException(
					"Could not create shader program (returned program ID "
							+ var1 + ")");
		else
			return var1;
	}
