...
public class ServerListEntryLanDetected implements
	...
	protected ServerListEntryLanDetected(GuiMultiplayer p_i45046_1_,
	...
	public void func_148279_a(int p_148279_1_, int p_148279_2_,
			...
			boolean p_148279_9_) {
		field_148293_a.fontRenderer.drawString(
				I18n.format("lanServer.title", new Object[0]),
				p_148279_2_ + 32 + 3, p_148279_3_ + 1, 16777215);
		field_148293_a.fontRenderer.drawString(field_148291_b.getServerMotd(),
				p_148279_2_ + 32 + 3, p_148279_3_ + 12, 8421504);

		if (field_148293_a.gameSettings.hideServerAddress) {
			field_148293_a.fontRenderer.drawString(
					I18n.format("selectServer.hiddenAddress", new Object[0]),
					p_148279_2_ + 32 + 3, p_148279_3_ + 12 + 11, 3158064);
		} else {
			field_148293_a.fontRenderer.drawString(
					field_148291_b.getServerIpPort(), p_148279_2_ + 32 + 3,
