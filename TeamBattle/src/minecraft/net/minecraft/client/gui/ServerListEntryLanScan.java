...
public class ServerListEntryLanScan implements GuiListExtended.IGuiListEntry {
	...
	public void func_148279_a(int p_148279_1_, int p_148279_2_,
			...
			boolean p_148279_9_) {
		final int var10 = p_148279_3_ + p_148279_5_ / 2
				- field_148288_a.fontRenderer.FONT_HEIGHT / 2;
		field_148288_a.fontRenderer.drawString(
				I18n.format("lanServer.scanning", new Object[0]),
				field_148288_a.currentScreen.width
						/ 2
						- field_148288_a.fontRenderer.getStringWidth(I18n
								.format("lanServer.scanning", new Object[0]))
						/ 2, var10, 16777215);
		String var11;
		...
		field_148288_a.fontRenderer
				.drawString(
						var11,
						field_148288_a.currentScreen.width
								/ 2
								- field_148288_a.fontRenderer
										.getStringWidth(var11) / 2, var10
								+ field_148288_a.fontRenderer.FONT_HEIGHT,
						8421504);
	}
}
