...
public class GuiTextField extends Gui {
	...
	public GuiTextField(FontRenderer p_i1032_1_, int p_i1032_2_,
	...
	public void drawTextBox() {
		if (func_146176_q()) {
			...
			if (var4.length() > 0) {
				...
				var9 = field_146211_a.drawStringWithShadow(var10, var7, var8,
						var1);
			}
			...
			if (var4.length() > 0 && var5 && var2 < var4.length()) {
				field_146211_a.drawStringWithShadow(var4.substring(var2), var9,
						var8, var1);
			}
