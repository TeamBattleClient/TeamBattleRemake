...
public class GuiTwitchUserMode extends GuiScreen {
	...
	public static List func_152328_a(Set p_152328_0_, Set p_152328_1_,
			IStream p_152328_2_) {
		final String var3 = p_152328_2_ == null ? null : p_152328_2_
				.func_152921_C();
		...
		while (var6.hasNext()) {
			final ChatUserSubscription var10 = (ChatUserSubscription) var6
					.next();
	...
	public static IChatComponent func_152329_a(ChatUserMode p_152329_0_,
			String p_152329_1_, boolean p_152329_2_) {
		...
		if (p_152329_0_ == ChatUserMode.TTV_CHAT_USERMODE_ADMINSTRATOR) {
			var3 = new ChatComponentTranslation(
					"stream.user.mode.administrator", new Object[0]);
			...
			if (p_152329_1_ == null) {
				...
				var3 = new ChatComponentTranslation(
						"stream.user.mode.banned.self", new Object[0]);
			} else {
				var3 = new ChatComponentTranslation(
			...
			if (p_152329_1_ == null) {
				var3 = new ChatComponentTranslation(
						"stream.user.mode.broadcaster", new Object[0]);
			} else if (p_152329_2_) {
				var3 = new ChatComponentTranslation(
						"stream.user.mode.broadcaster.self", new Object[0]);
			} else {
				var3 = new ChatComponentTranslation(
						"stream.user.mode.broadcaster.other", new Object[0]);
			}
			...
			if (p_152329_1_ == null) {
				var3 = new ChatComponentTranslation(
						"stream.user.mode.moderator", new Object[0]);
			} else if (p_152329_2_) {
				var3 = new ChatComponentTranslation(
						"stream.user.mode.moderator.self", new Object[0]);
			} else {
				var3 = new ChatComponentTranslation(
	...
	public static IChatComponent func_152330_a(
			ChatUserSubscription p_152330_0_, String p_152330_1_,
			boolean p_152330_2_) {
		ChatComponentTranslation var3 = null;
		...
		if (p_152330_0_ == ChatUserSubscription.TTV_CHAT_USERSUB_SUBSCRIBER) {
			if (p_152330_1_ == null) {
				var3 = new ChatComponentTranslation(
						"stream.user.subscription.subscriber", new Object[0]);
			} else if (p_152330_2_) {
				var3 = new ChatComponentTranslation(
			...
			var3 = new ChatComponentTranslation(
					"stream.user.subscription.turbo", new Object[0]);
			var3.getChatStyle().setColor(field_152336_g);
		}
	...
	public GuiTwitchUserMode(IStream p_i1064_1_, ChatUserInfo p_i1064_2_) {
		...
		field_152332_r.addAll(func_152328_a(p_i1064_2_.modes,
				p_i1064_2_.subscriptions, p_i1064_1_));
	}
	...
	protected void actionPerformed(GuiButton p_146284_1_) {
		if (p_146284_1_.enabled) {
			if (p_146284_1_.id == 0) {
				field_152333_s.func_152917_b("/ban "
						+ field_152337_h.displayName);
			} else if (p_146284_1_.id == 3) {
				field_152333_s.func_152917_b("/unban "
						+ field_152337_h.displayName);
			} else if (p_146284_1_.id == 2) {
				field_152333_s.func_152917_b("/mod "
						+ field_152337_h.displayName);
			} else if (p_146284_1_.id == 4) {
				field_152333_s.func_152917_b("/unmod "
						+ field_152337_h.displayName);
			} else if (p_146284_1_.id == 1) {
				field_152333_s.func_152917_b("/timeout "
						+ field_152337_h.displayName);
			}
	...
	public void drawScreen(int p_73863_1_, int p_73863_2_, float p_73863_3_) {
		...
		drawCenteredString(fontRendererObj,
				field_152338_i.getUnformattedText(), width / 2, 70, 16777215);
		int var4 = 80;
		...
		for (final Iterator var5 = field_152332_r.iterator(); var5.hasNext(); var4 += fontRendererObj.FONT_HEIGHT) {
			...
			drawString(fontRendererObj, var6.getFormattedText(),
					field_152334_t, var4, 16777215);
		}
	...
	public void initGui() {
		...
		buttons.add(new GuiButton(1, var1 * 0 + var2 / 2, height - 70, 130, 20,
				I18n.format("stream.userinfo.timeout", new Object[0])));
		buttons.add(new GuiButton(0, var1 * 1 + var2 / 2, height - 70, 130, 20,
				I18n.format("stream.userinfo.ban", new Object[0])));
		buttons.add(new GuiButton(2, var1 * 2 + var2 / 2, height - 70, 130, 20,
				I18n.format("stream.userinfo.mod", new Object[0])));
		buttons.add(new GuiButton(5, var1 * 0 + var2 / 2, height - 45, 130, 20,
				I18n.format("gui.cancel", new Object[0])));
		buttons.add(new GuiButton(3, var1 * 1 + var2 / 2, height - 45, 130, 20,
				I18n.format("stream.userinfo.unban", new Object[0])));
		buttons.add(new GuiButton(4, var1 * 2 + var2 / 2, height - 45, 130, 20,
				I18n.format("stream.userinfo.unmod", new Object[0])));
		int var3 = 0;
		IChatComponent var5;

		for (final Iterator var4 = field_152332_r.iterator(); var4.hasNext(); var3 = Math
				.max(var3,
						fontRendererObj.getStringWidth(var5.getFormattedText()))) {
