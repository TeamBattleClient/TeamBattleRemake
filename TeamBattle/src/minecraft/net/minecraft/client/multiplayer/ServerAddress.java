...
public class ServerAddress {
	public static ServerAddress func_78860_a(String p_78860_0_) {
		if (p_78860_0_ == null)
			...
			String var5 = var1[0];
			int var6 = var1.length > 1 ? parseIntWithDefault(var1[1], 25565)
					: 25565;
	...
	private static String[] getServerAddress(String p_78863_0_) {
		try {
			...
			final Attributes var4 = var3.getAttributes("_minecraft._tcp."
					+ p_78863_0_, new String[] { "SRV" });
			final String[] var5 = var4.get("srv").get().toString()
					.split(" ", 4);
