...
public class ModelZombieVillager extends ModelBiped {
	...
	public ModelZombieVillager(float p_i1165_1_, float p_i1165_2_,
			boolean p_i1165_3_) {
		...
		if (p_i1165_3_) {
			...
			bipedHead.setRotationPoint(0.0F, 0.0F + p_i1165_2_, 0.0F);
			bipedHead.setTextureOffset(0, 32).addBox(-4.0F, -10.0F, -4.0F, 8,
					10, 8, p_i1165_1_);
			bipedHead.setTextureOffset(24, 32).addBox(-1.0F, -3.0F, -6.0F, 2,
					4, 2, p_i1165_1_);
		}
	}
	...
	public void setRotationAngles(float p_78087_1_, float p_78087_2_,
		...
		final float var8 = MathHelper.sin(onGround * (float) Math.PI);
		final float var9 = MathHelper.sin((1.0F - (1.0F - onGround)
				* (1.0F - onGround))
				* (float) Math.PI);
