...
public class ModelVillager extends ModelBase {
	...
	public ModelVillager(float p_i1164_1_, float p_i1164_2_, int p_i1164_3_,
			int p_i1164_4_) {
		villagerHead = new ModelRenderer(this).setTextureSize(p_i1164_3_,
				p_i1164_4_);
		villagerHead.setRotationPoint(0.0F, 0.0F + p_i1164_2_, 0.0F);
		villagerHead.setTextureOffset(0, 0).addBox(-4.0F, -10.0F, -4.0F, 8, 10,
				8, p_i1164_1_);
		villagerNose = new ModelRenderer(this).setTextureSize(p_i1164_3_,
				p_i1164_4_);
		villagerNose.setRotationPoint(0.0F, p_i1164_2_ - 2.0F, 0.0F);
		villagerNose.setTextureOffset(24, 0).addBox(-1.0F, -1.0F, -6.0F, 2, 4,
				2, p_i1164_1_);
		villagerHead.addChild(villagerNose);
		villagerBody = new ModelRenderer(this).setTextureSize(p_i1164_3_,
				p_i1164_4_);
		...
		villagerBody.setTextureOffset(0, 38).addBox(-4.0F, 0.0F, -3.0F, 8, 18,
				6, p_i1164_1_ + 0.5F);
		villagerArms = new ModelRenderer(this).setTextureSize(p_i1164_3_,
				p_i1164_4_);
		...
		villagerArms.setTextureOffset(40, 38).addBox(-4.0F, 2.0F, -2.0F, 8, 4,
				4, p_i1164_1_);
		rightVillagerLeg = new ModelRenderer(this, 0, 22).setTextureSize(
				p_i1164_3_, p_i1164_4_);
		rightVillagerLeg.setRotationPoint(-2.0F, 12.0F + p_i1164_2_, 0.0F);
		rightVillagerLeg.addBox(-2.0F, 0.0F, -2.0F, 4, 12, 4, p_i1164_1_);
		leftVillagerLeg = new ModelRenderer(this, 0, 22).setTextureSize(
				p_i1164_3_, p_i1164_4_);
	...
	public void setRotationAngles(float p_78087_1_, float p_78087_2_,
		...
		villagerHead.rotateAngleY = p_78087_4_ / (180F / (float) Math.PI);
		villagerHead.rotateAngleX = p_78087_5_ / (180F / (float) Math.PI);
		villagerArms.rotationPointY = 3.0F;
		villagerArms.rotationPointZ = -1.0F;
		villagerArms.rotateAngleX = -0.75F;
		rightVillagerLeg.rotateAngleX = MathHelper.cos(p_78087_1_ * 0.6662F)
				* 1.4F * p_78087_2_ * 0.5F;
		leftVillagerLeg.rotateAngleX = MathHelper.cos(p_78087_1_ * 0.6662F
				+ (float) Math.PI)
				* 1.4F * p_78087_2_ * 0.5F;
