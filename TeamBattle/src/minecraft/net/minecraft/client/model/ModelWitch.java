...
public class ModelWitch extends ModelVillager {
	...
	private final ModelRenderer field_82901_h = new ModelRenderer(this)
	...
	public ModelWitch(float p_i1166_1_) {
		...
		field_82901_h.setTextureOffset(0, 0).addBox(0.0F, 3.0F, -6.75F, 1, 1,
				1, -0.25F);
		...
		final ModelRenderer var2 = new ModelRenderer(this).setTextureSize(64,
				128);
		...
		final ModelRenderer var3 = new ModelRenderer(this).setTextureSize(64,
				128);
		...
		var2.addChild(var3);
		final ModelRenderer var4 = new ModelRenderer(this).setTextureSize(64,
				128);
	...
	public void setRotationAngles(float p_78087_1_, float p_78087_2_,
		...
		villagerNose.rotateAngleX = MathHelper.sin(p_78087_7_.ticksExisted
				* var8)
				* 4.5F * (float) Math.PI / 180.0F;
		villagerNose.rotateAngleY = 0.0F;
		villagerNose.rotateAngleZ = MathHelper.cos(p_78087_7_.ticksExisted
				* var8)
