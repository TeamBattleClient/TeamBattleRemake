...
public class ItemMonsterPlacer extends Item {
	 ...
	 */
	public static Entity spawnCreature(World p_77840_0_, int p_77840_1_,
			double p_77840_2_, double p_77840_4_, double p_77840_6_) {
		if (!EntityList.entityEggs.containsKey(Integer.valueOf(p_77840_1_)))
			...
			for (int var9 = 0; var9 < 1; ++var9) {
				...
				if (var8 != null && var8 instanceof EntityLivingBase) {
					...
					var8.setLocationAndAngles(p_77840_2_, p_77840_4_,
							p_77840_6_, MathHelper
									.wrapAngleTo180_float(p_77840_0_.rand
	...
	public int getColorFromItemStack(ItemStack p_82790_1_, int p_82790_2_) {
		...
		return var3 != null ? p_82790_2_ == 0 ? var3.primaryColor
	...
	public IIcon getIconFromDamageForRenderPass(int p_77618_1_, int p_77618_2_) {
		return p_77618_2_ > 0 ? theIcon : super.getIconFromDamageForRenderPass(
				p_77618_1_, p_77618_2_);
	}
	...
	public String getItemStackDisplayName(ItemStack p_77653_1_) {
		...
		final String var3 = EntityList.getStringFromID(p_77653_1_
				.getItemDamage());
	...
	public void getSubItems(Item p_150895_1_, CreativeTabs p_150895_2_,
		...
		while (var4.hasNext()) {
			final EntityList.EntityEggInfo var5 = (EntityList.EntityEggInfo) var4
					.next();
		...
		if (p_77659_2_.isClient)
			...
			if (var4 == null)
				...
				if (var4.typeOfHit == MovingObjectPosition.MovingObjectType.BLOCK) {
					...
					if (!p_77659_3_.canPlayerEdit(var5, var6, var7,
							var4.sideHit, p_77659_1_))
						return p_77659_1_;

					if (p_77659_2_.getBlock(var5, var6, var7) instanceof BlockLiquid) {
						final Entity var8 = spawnCreature(p_77659_2_,
								p_77659_1_.getItemDamage(), var5, var6, var7);

						if (var8 != null) {
							if (var8 instanceof EntityLivingBase
									&& p_77659_1_.hasDisplayName()) {
								((EntityLiving) var8)
										.setCustomNameTag(p_77659_1_
												.getDisplayName());
							}
	...
	public boolean onItemUse(ItemStack p_77648_1_, EntityPlayer p_77648_2_,
		...
		if (p_77648_3_.isClient)
			...
			final Entity var14 = spawnCreature(p_77648_3_,
					p_77648_1_.getItemDamage(), p_77648_4_ + 0.5D, p_77648_5_
							+ var12, p_77648_6_ + 0.5D);

			if (var14 != null) {
				if (var14 instanceof EntityLivingBase
						&& p_77648_1_.hasDisplayName()) {
					((EntityLiving) var14).setCustomNameTag(p_77648_1_
							.getDisplayName());
				}
	...
	public void registerIcons(IIconRegister p_94581_1_) {
		...
		theIcon = p_94581_1_.registerIcon(getIconString() + "_overlay");
	}
