	...
	public boolean onItemUse(ItemStack p_77648_1_, EntityPlayer p_77648_2_,
		...
		if (p_77648_7_ == 0)
			...
			if (!p_77648_2_.canPlayerEdit(p_77648_4_, p_77648_5_, p_77648_6_,
				...
				return false;
			else if (!Blocks.standing_sign.canPlaceBlockAt(p_77648_3_,
				...
				if (p_77648_7_ == 1) {
					final int var11 = MathHelper
							.floor_double((p_77648_2_.rotationYaw + 180.0F) * 16.0F / 360.0F + 0.5D) & 15;
					p_77648_3_.setBlock(p_77648_4_, p_77648_5_, p_77648_6_,
							Blocks.standing_sign, var11, 3);
				} else {
					p_77648_3_.setBlock(p_77648_4_, p_77648_5_, p_77648_6_,
							Blocks.wall_sign, p_77648_7_, 3);
				}

				--p_77648_1_.stackSize;
				final TileEntitySign var12 = (TileEntitySign) p_77648_3_
