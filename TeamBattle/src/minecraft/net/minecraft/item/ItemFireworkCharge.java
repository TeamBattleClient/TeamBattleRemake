...
public class ItemFireworkCharge extends Item {
	public static void func_150902_a(NBTTagCompound p_150902_0_,
			List p_150902_1_) {
		final byte var2 = p_150902_0_.getByte("Type");

		if (var2 >= 0 && var2 <= 4) {
			p_150902_1_.add(StatCollector.translateToLocal(
					"item.fireworksCharge.type." + var2).trim());
		} else {
			p_150902_1_.add(StatCollector.translateToLocal(
					"item.fireworksCharge.type").trim());
		}
			...
			for (var8 = 0; var8 < var7; ++var8) {
				...
				for (int var11 = 0; var11 < 16; ++var11) {
					if (var9 == ItemDye.field_150922_c[var11]) {
						...
						var5 = var5
								+ StatCollector
										.translateToLocal("item.fireworksCharge."
												+ ItemDye.field_150923_a[var11]);
						break;
					}
				}
				...
				if (!var10) {
					var5 = var5
							+ StatCollector
									.translateToLocal("item.fireworksCharge.customColor");
				}
			}
		...
		if (var13.length > 0) {
			var14 = true;
			String var15 = StatCollector
					.translateToLocal("item.fireworksCharge.fadeTo") + " ";
		...
		if (var14) {
			p_150902_1_.add(StatCollector
					.translateToLocal("item.fireworksCharge.trail"));
		}
		...
		if (var16) {
			p_150902_1_.add(StatCollector
					.translateToLocal("item.fireworksCharge.flicker"));
		}
	}

	public static NBTBase func_150903_a(ItemStack p_150903_0_,
			String p_150903_1_) {
		if (p_150903_0_.hasTagCompound()) {
			final NBTTagCompound var2 = p_150903_0_.getTagCompound()
	...
	public IIcon getIconFromDamageForRenderPass(int p_77618_1_, int p_77618_2_) {
		return p_77618_2_ > 0 ? field_150904_a : super
	...
	public void registerIcons(IIconRegister p_94581_1_) {
		...
		field_150904_a = p_94581_1_.registerIcon(getIconString() + "_overlay");
	}
