...
public class ItemBucket extends Item {
	...
	public ItemStack onItemRightClick(ItemStack p_77659_1_, World p_77659_2_,
		...
		final boolean var4 = isFull == Blocks.air;
		final MovingObjectPosition var5 = getMovingObjectPositionFromPlayer(
				p_77659_2_, p_77659_3_, var4);
		...
		if (var5 == null)
			...
			if (var5.typeOfHit == MovingObjectPosition.MovingObjectType.BLOCK) {
				...
				if (var4) {
					if (!p_77659_3_.canPlayerEdit(var6, var7, var8,
							var5.sideHit, p_77659_1_))
						return p_77659_1_;

					final Material var9 = p_77659_2_.getBlock(var6, var7, var8)
							.getMaterial();
					final int var10 = p_77659_2_.getBlockMetadata(var6, var7,
							var8);

					if (var9 == Material.water && var10 == 0) {
						p_77659_2_.setBlockToAir(var6, var7, var8);
						return func_150910_a(p_77659_1_, p_77659_3_,
								Items.water_bucket);
					}
					...
					if (tryPlaceContainedLiquid(p_77659_2_, var6, var7, var8)
	 ...
	 */
	public boolean tryPlaceContainedLiquid(World p_77875_1_, int p_77875_2_,
			int p_77875_3_, int p_77875_4_) {
		if (isFull == Blocks.air)
			return false;
		else {
			final Material var5 = p_77875_1_.getBlock(p_77875_2_, p_77875_3_,
					p_77875_4_).getMaterial();
			final boolean var6 = !var5.isSolid();

			if (!p_77875_1_.isAirBlock(p_77875_2_, p_77875_3_, p_77875_4_)
					&& !var6)
				return false;
			else {
				if (p_77875_1_.provider.isHellWorld
						&& isFull == Blocks.flowing_water) {
					p_77875_1_
							.playSoundEffect(
									p_77875_2_ + 0.5F,
									p_77875_3_ + 0.5F,
					...
					for (int var7 = 0; var7 < 8; ++var7) {
						p_77875_1_.spawnParticle("largesmoke", p_77875_2_
								+ Math.random(), p_77875_3_ + Math.random(),
								p_77875_4_ + Math.random(), 0.0D, 0.0D, 0.0D);
					}
				} else {
					if (!p_77875_1_.isClient && var6 && !var5.isLiquid()) {
						p_77875_1_.func_147480_a(p_77875_2_, p_77875_3_,
								p_77875_4_, true);
					}

					p_77875_1_.setBlock(p_77875_2_, p_77875_3_, p_77875_4_,
							isFull, 0, 3);
				}
