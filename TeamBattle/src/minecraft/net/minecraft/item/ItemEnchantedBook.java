...
public class ItemEnchantedBook extends Item {
	...
	public void addInformation(ItemStack p_77624_1_, EntityPlayer p_77624_2_,
		...
		final NBTTagList var5 = func_92110_g(p_77624_1_);
		...
		if (var5 != null) {
			for (int var6 = 0; var6 < var5.tagCount(); ++var6) {
				...
				if (Enchantment.enchantmentsList[var7] != null) {
					p_77624_3_.add(Enchantment.enchantmentsList[var7]
	...
	public NBTTagList func_92110_g(ItemStack p_92110_1_) {
		return p_92110_1_.stackTagCompound != null
				&& p_92110_1_.stackTagCompound.func_150297_b(
						"StoredEnchantments", 9) ? (NBTTagList) p_92110_1_.stackTagCompound
				.getTag("StoredEnchantments") : new NBTTagList();
	}

	public WeightedRandomChestContent func_92112_a(Random p_92112_1_,
			int p_92112_2_, int p_92112_3_, int p_92112_4_) {
		final ItemStack var5 = new ItemStack(Items.book, 1, 0);
		EnchantmentHelper.addRandomEnchantment(p_92112_1_, var5, 30);
		return new WeightedRandomChestContent(var5, p_92112_2_, p_92112_3_,
				p_92112_4_);
	}

	public void func_92113_a(Enchantment p_92113_1_, List p_92113_2_) {
		for (int var3 = p_92113_1_.getMinLevel(); var3 <= p_92113_1_
				.getMaxLevel(); ++var3) {
			p_92113_2_.add(getEnchantedItemStack(new EnchantmentData(
					p_92113_1_, var3)));
		}
	}
	...
	public EnumRarity getRarity(ItemStack p_77613_1_) {
		return func_92110_g(p_77613_1_).tagCount() > 0 ? EnumRarity.uncommon
