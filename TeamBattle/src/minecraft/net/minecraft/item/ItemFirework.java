...
public class ItemFirework extends Item {
			...
			if (var5 != null) {
				if (var5.func_150297_b("Flight", 99)) {
					p_77624_3_.add(StatCollector
							.translateToLocal("item.fireworks.flight")
							+ " "
							+ var5.getByte("Flight"));
				}
	...
	public boolean onItemUse(ItemStack p_77648_1_, EntityPlayer p_77648_2_,
		...
		if (!p_77648_3_.isClient) {
			final EntityFireworkRocket var11 = new EntityFireworkRocket(
					p_77648_3_, p_77648_4_ + p_77648_8_, p_77648_5_
							+ p_77648_9_, p_77648_6_ + p_77648_10_, p_77648_1_);
