...
public class ItemSkull extends Item {
		...
		if (p_77653_1_.getItemDamage() == 3 && p_77653_1_.hasTagCompound()) {
			if (p_77653_1_.getTagCompound().func_150297_b("SkullOwner", 10))
				return StatCollector.translateToLocalFormatted(
						...
						new Object[] { NBTUtil.func_152459_a(
								p_77653_1_.getTagCompound().getCompoundTag(
										"SkullOwner")).getName() });

			if (p_77653_1_.getTagCompound().func_150297_b("SkullOwner", 8))
				return StatCollector.translateToLocalFormatted(
						"item.skull.player.name", new Object[] { p_77653_1_
								.getTagCompound().getString("SkullOwner") });
		}
	...
	public boolean onItemUse(ItemStack p_77648_1_, EntityPlayer p_77648_2_,
		...
		if (p_77648_7_ == 0)
			return false;
		else if (!p_77648_3_.getBlock(p_77648_4_, p_77648_5_, p_77648_6_)
				.getMaterial().isSolid())
			return false;
		else {
			if (p_77648_7_ == 1) {
			...
			if (!p_77648_3_.isClient) {
				p_77648_3_.setBlock(p_77648_4_, p_77648_5_, p_77648_6_,
						Blocks.skull, p_77648_7_, 2);
				int var11 = 0;

				if (p_77648_7_ == 1) {
					var11 = MathHelper
							.floor_double(p_77648_2_.rotationYaw * 16.0F / 360.0F + 0.5D) & 15;
				}

				final TileEntity var12 = p_77648_3_.getTileEntity(p_77648_4_,
				...
				if (var12 != null && var12 instanceof TileEntitySkull) {
					if (p_77648_1_.getItemDamage() == 3) {
						...
						if (p_77648_1_.hasTagCompound()) {
							final NBTTagCompound var14 = p_77648_1_
									.getTagCompound();

							if (var14.func_150297_b("SkullOwner", 10)) {
								var13 = NBTUtil.func_152459_a(var14
										.getCompoundTag("SkullOwner"));
							} else if (var14.func_150297_b("SkullOwner", 8)
									&& var14.getString("SkullOwner").length() > 0) {
								var13 = new GameProfile((UUID) null,
										var14.getString("SkullOwner"));
							}
						}

						((TileEntitySkull) var12).func_152106_a(var13);
					} else {
						((TileEntitySkull) var12).func_152107_a(p_77648_1_
								.getItemDamage());
					}

					((TileEntitySkull) var12).func_145903_a(var11);
					((BlockSkull) Blocks.skull).func_149965_a(p_77648_3_,
	...
	public void registerIcons(IIconRegister p_94581_1_) {
		...
		for (int var2 = 0; var2 < field_94587_a.length; ++var2) {
			field_94586_c[var2] = p_94581_1_.registerIcon(getIconString() + "_"
					+ field_94587_a[var2]);
		}
	}
}
