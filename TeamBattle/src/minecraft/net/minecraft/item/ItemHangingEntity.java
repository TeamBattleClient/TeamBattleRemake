...
public class ItemHangingEntity extends Item {
	 ...
	 */
	private EntityHanging createHangingEntity(World p_82810_1_, int p_82810_2_,
			int p_82810_3_, int p_82810_4_, int p_82810_5_) {
		return hangingEntityClass == EntityPainting.class ? new EntityPainting(
				p_82810_1_, p_82810_2_, p_82810_3_, p_82810_4_, p_82810_5_)
				: hangingEntityClass == EntityItemFrame.class ? new EntityItemFrame(
						p_82810_1_, p_82810_2_, p_82810_3_, p_82810_4_,
						p_82810_5_) : null;
	}
	...
	public boolean onItemUse(ItemStack p_77648_1_, EntityPlayer p_77648_2_,
		...
		if (p_77648_7_ == 0)
			...
			final EntityHanging var12 = createHangingEntity(p_77648_3_,
					p_77648_4_, p_77648_5_, p_77648_6_, var11);
