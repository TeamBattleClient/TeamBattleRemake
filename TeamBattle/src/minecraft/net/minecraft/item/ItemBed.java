	...
	public boolean onItemUse(ItemStack p_77648_1_, EntityPlayer p_77648_2_,
		...
		if (p_77648_3_.isClient)
			...
			final int var12 = MathHelper
					.floor_double(p_77648_2_.rotationYaw * 4.0F / 360.0F + 0.5D) & 3;
			byte var13 = 0;
			byte var14 = 0;
			...
			if (p_77648_2_.canPlayerEdit(p_77648_4_, p_77648_5_, p_77648_6_,
					...
					&& p_77648_2_.canPlayerEdit(p_77648_4_ + var13, p_77648_5_,
							p_77648_6_ + var14, p_77648_7_, p_77648_1_)) {
				if (p_77648_3_.isAirBlock(p_77648_4_, p_77648_5_, p_77648_6_)
						&& p_77648_3_.isAirBlock(p_77648_4_ + var13,
								p_77648_5_, p_77648_6_ + var14)
						&& World.doesBlockHaveSolidTopSurface(p_77648_3_,
								p_77648_4_, p_77648_5_ - 1, p_77648_6_)
						&& World.doesBlockHaveSolidTopSurface(p_77648_3_,
								p_77648_4_ + var13, p_77648_5_ - 1, p_77648_6_
										+ var14)) {
					p_77648_3_.setBlock(p_77648_4_, p_77648_5_, p_77648_6_,
							var11, var12, 3);

					if (p_77648_3_.getBlock(p_77648_4_, p_77648_5_, p_77648_6_) == var11) {
						p_77648_3_.setBlock(p_77648_4_ + var13, p_77648_5_,
								p_77648_6_ + var14, var11, var12 + 8, 3);
					}
