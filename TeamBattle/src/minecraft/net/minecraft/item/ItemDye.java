...
public class ItemDye extends Item {
	public static final String[] field_150921_b = new String[] { "black",
			"red", "green", "brown", "blue", "purple", "cyan", "silver",
			"gray", "pink", "lime", "yellow", "light_blue", "magenta",
			"orange", "white" };
	...
	public static final String[] field_150923_a = new String[] { "black",
			"red", "green", "brown", "blue", "purple", "cyan", "silver",
			"gray", "pink", "lime", "yellow", "lightBlue", "magenta", "orange",
			"white" };

	public static void func_150918_a(World p_150918_0_, int p_150918_1_,
			int p_150918_2_, int p_150918_3_, int p_150918_4_) {
		if (p_150918_4_ == 0) {
			p_150918_4_ = 15;
		}

		final Block var5 = p_150918_0_.getBlock(p_150918_1_, p_150918_2_,
				p_150918_3_);

		if (var5.getMaterial() != Material.air) {
			var5.setBlockBoundsBasedOnState(p_150918_0_, p_150918_1_,
			...
			for (int var6 = 0; var6 < p_150918_4_; ++var6) {
				...
				final double var11 = itemRand.nextGaussian() * 0.02D;
				p_150918_0_.spawnParticle(
						"happyVillager",
						p_150918_1_ + itemRand.nextFloat(),
						p_150918_2_ + itemRand.nextFloat()
								* var5.getBlockBoundsMaxY(), p_150918_3_
								+ itemRand.nextFloat(), var7, var9, var11);
			}
		}
	}
	...
	public static boolean func_150919_a(ItemStack p_150919_0_,
		...
		final Block var5 = p_150919_1_.getBlock(p_150919_2_, p_150919_3_,
				p_150919_4_);
	...
	public String getUnlocalizedName(ItemStack p_77667_1_) {
		final int var2 = MathHelper
				.clamp_int(p_77667_1_.getItemDamage(), 0, 15);
	...
	public boolean itemInteractionForEntity(ItemStack p_111207_1_,
		...
		if (p_111207_3_ instanceof EntitySheep) {
			...
			final int var5 = BlockColored.func_150032_b(p_111207_1_
					.getItemDamage());
	...
	public boolean onItemUse(ItemStack p_77648_1_, EntityPlayer p_77648_2_,
		...
		if (!p_77648_2_.canPlayerEdit(p_77648_4_, p_77648_5_, p_77648_6_,
			...
			if (p_77648_1_.getItemDamage() == 15) {
				if (func_150919_a(p_77648_1_, p_77648_3_, p_77648_4_,
						p_77648_5_, p_77648_6_)) {
					if (!p_77648_3_.isClient) {
						p_77648_3_.playAuxSFX(2005, p_77648_4_, p_77648_5_,
								p_77648_6_, 0);
					}
				...
				if (var11 == Blocks.log && BlockLog.func_150165_c(var12) == 3) {
					...
					if (p_77648_3_.isAirBlock(p_77648_4_, p_77648_5_,
							p_77648_6_)) {
						final int var13 = Blocks.cocoa.onBlockPlaced(
								p_77648_3_, p_77648_4_, p_77648_5_, p_77648_6_,
								p_77648_7_, p_77648_8_, p_77648_9_,
								p_77648_10_, 0);
	...
	public void registerIcons(IIconRegister p_94581_1_) {
		field_150920_d = new IIcon[field_150921_b.length];

		for (int var2 = 0; var2 < field_150921_b.length; ++var2) {
			field_150920_d[var2] = p_94581_1_.registerIcon(getIconString()
					+ "_" + field_150921_b[var2]);
		}
	}
}
