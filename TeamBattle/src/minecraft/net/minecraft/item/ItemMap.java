...
public class ItemMap extends ItemMapBase {
	...
	public void addInformation(ItemStack p_77624_1_, EntityPlayer p_77624_2_,
		...
		final MapData var5 = getMapData(p_77624_1_, p_77624_2_.worldObj);
	...
	public Packet func_150911_c(ItemStack p_150911_1_, World p_150911_2_,
		...
		final byte[] var4 = getMapData(p_150911_1_, p_150911_2_)
				.getUpdatePacketData(p_150911_1_, p_150911_2_, p_150911_3_);
		return var4 == null ? null : new S34PacketMaps(
				p_150911_1_.getItemDamage(), var4);
	}
	...
	public MapData getMapData(ItemStack p_77873_1_, World p_77873_2_) {
		...
		if (var4 == null && !p_77873_2_.isClient) {
			...
			var4.xCenter = Math.round((float) p_77873_2_.getWorldInfo()
					.getSpawnX() / (float) var5)
					* var5;
			var4.zCenter = Math.round(p_77873_2_.getWorldInfo().getSpawnZ()
					/ var5)
					* var5;
	...
	public void onCreated(ItemStack p_77622_1_, World p_77622_2_,
		...
		if (p_77622_1_.hasTagCompound()
				&& p_77622_1_.getTagCompound().getBoolean("map_is_scaling")) {
			final MapData var4 = Items.filled_map.getMapData(p_77622_1_,
					p_77622_2_);
			p_77622_1_.setItemDamage(p_77622_2_.getUniqueDataId("map"));
			final MapData var5 = new MapData("map_"
					+ p_77622_1_.getItemDamage());
	...
	public void onUpdate(ItemStack p_77663_1_, World p_77663_2_,
		...
		if (!p_77663_2_.isClient) {
			final MapData var6 = getMapData(p_77663_1_, p_77663_2_);
			...
			if (p_77663_5_) {
				updateMapData(p_77663_2_, p_77663_3_, var6);
			}
		}
	}

	public void updateMapData(World p_77872_1_, Entity p_77872_2_,
			MapData p_77872_3_) {
		if (p_77872_1_.provider.dimensionId == p_77872_3_.dimension
				&& p_77872_2_ instanceof EntityPlayer) {
			final int var4 = 1 << p_77872_3_.scale;
			final int var5 = p_77872_3_.xCenter;
			final int var6 = p_77872_3_.zCenter;
			final int var7 = MathHelper.floor_double(p_77872_2_.posX - var5)
					/ var4 + 64;
			final int var8 = MathHelper.floor_double(p_77872_2_.posZ - var6)
					/ var4 + 64;
			int var9 = 128 / var4;
			...
			final MapData.MapInfo var10 = p_77872_3_
					.func_82568_a((EntityPlayer) p_77872_2_);
			++var10.field_82569_d;
			...
			for (int var11 = var7 - var9 + 1; var11 < var7 + var9; ++var11) {
				if ((var11 & 15) == (var10.field_82569_d & 15)) {
					...
					for (int var16 = var8 - var9 - 1; var16 < var8 + var9; ++var16) {
						if (var11 >= 0 && var16 >= -1 && var11 < 128
								&& var16 < 128) {
							final int var17 = var11 - var7;
							final int var18 = var16 - var8;
							final boolean var19 = var17 * var17 + var18 * var18 > (var9 - 2)
									* (var9 - 2);
							final int var20 = (var5 / var4 + var11 - 64) * var4;
							final int var21 = (var6 / var4 + var16 - 64) * var4;
							final HashMultiset var22 = HashMultiset.create();
							final Chunk var23 = p_77872_1_
									.getChunkFromBlockCoords(var20, var21);

							if (!var23.isEmpty()) {
								final int var24 = var20 & 15;
								final int var25 = var21 & 15;
								int var26 = 0;
								double var27 = 0.0D;
								int var29;
								...
								if (p_77872_1_.provider.hasNoSky) {
									...
									var29 = var29 * var29 * 31287121 + var29
											* 11;

									if ((var29 >> 20 & 1) == 0) {
										var22.add(Blocks.dirt.getMapColor(0),
												10);
									} else {
										var22.add(Blocks.stone.getMapColor(0),
												100);
									}
									...
									for (var29 = 0; var29 < var4; ++var29) {
										for (int var30 = 0; var30 < var4; ++var30) {
											int var31 = var23.getHeightValue(
													var29 + var24, var30
															+ var25) + 1;
											...
											if (var31 > 1) {
												do {
													...
													var33 = var23
														...
														.getMapColor(var33) == MapColor.field_151660_b
														&& var31 > 0);
								...
								var26 /= var4 * var4;
								double var36 = (var27 - var14) * 4.0D
										/ (var4 + 4)
										+ ((var11 + var16 & 1) - 0.5D) * 0.4D;
								byte var37 = 1;
								...
								final MapColor var38 = Iterables.getFirst(
										Multisets.copyHighestCountFirst(var22),
										MapColor.field_151660_b);

								if (var38 == MapColor.field_151662_n) {
									var36 = var26 * 0.1D + (var11 + var16 & 1)
											* 0.2D;
									var37 = 1;
								...
								if (var16 >= 0
										&& var17 * var17 + var18 * var18 < var9
												* var9
										&& (!var19 || (var11 + var16 & 1) != 0)) {
									final byte var39 = p_77872_3_.colors[var11
											+ var16 * 128];
									final byte var40 = (byte) (var38.colorIndex * 4 + var37);
