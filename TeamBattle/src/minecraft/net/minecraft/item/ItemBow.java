...
public class ItemBow extends Item {
	...
	public ItemStack onItemRightClick(ItemStack p_77659_1_, World p_77659_2_,
		...
		if (p_77659_3_.capabilities.isCreativeMode
				|| p_77659_3_.inventory.hasItem(Items.arrow)) {
	...
	public void onPlayerStoppedUsing(ItemStack p_77615_1_, World p_77615_2_,
		...
		final boolean var5 = p_77615_3_.capabilities.isCreativeMode
				|| EnchantmentHelper.getEnchantmentLevel(
						Enchantment.infinity.effectId, p_77615_1_) > 0;

		if (var5 || p_77615_3_.inventory.hasItem(Items.arrow)) {
			final int var6 = getMaxItemUseDuration(p_77615_1_) - p_77615_4_;
			...
			final EntityArrow var8 = new EntityArrow(p_77615_2_, p_77615_3_,
					var7 * 2.0F);
			...
			p_77615_2_.playSoundAtEntity(p_77615_3_, "random.bow", 1.0F, 1.0F
	...
	public void registerIcons(IIconRegister p_94581_1_) {
		...
		for (int var2 = 0; var2 < iconArray.length; ++var2) {
			iconArray[var2] = p_94581_1_.registerIcon(getIconString() + "_"
					+ bowPullIconNameArray[var2]);
		}
	}
}
