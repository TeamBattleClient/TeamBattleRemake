...
public final class GuiPasswordField extends Gui {
	...
	public GuiPasswordField(FontRenderer p_i1032_1_, int p_i1032_2_,
			int p_i1032_3_, int p_i1032_4_, int p_i1032_5_) {
	...
	public void drawTextBox() {
		if (func_146176_q()) {
			...
			final int var1 = field_146226_p ? field_146222_t : field_146221_u;
			final int var2 = field_146224_r - field_146225_q;
			int var3 = field_146223_s - field_146225_q;
			final String var4 = field_146211_a.trimStringToWidth(
					field_146216_j.substring(field_146225_q), func_146200_o());
			final boolean var5 = var2 >= 0 && var2 <= var4.length();
			final boolean var6 = field_146213_o && field_146214_l / 6 % 2 == 0
					&& var5;
			final int var7 = field_146215_m ? field_146209_f + 4
					: field_146209_f;
			final int var8 = field_146215_m ? field_146210_g
			...
			if (var4.length() > 0) {
				...
				var9 = field_146211_a.drawStringWithShadow(
			...
			if (var4.length() > 0 && var5 && var2 < var4.length()) {
				field_146211_a.drawStringWithShadow(var4.substring(var2)
	...
	public void func_146175_b(int p_146175_1_) {
		if (field_146216_j.length() != 0) {
			if (field_146223_s != field_146224_r) {
				...
				final int var3 = var2 ? field_146224_r + p_146175_1_
						: field_146224_r;
				final int var4 = var2 ? field_146224_r : field_146224_r
						+ p_146175_1_;
				String var5 = "";
	...
	public void func_146191_b(String p_146191_1_) {
		...
		final String var3 = ChatAllowedCharacters
				.filerAllowedCharacters(p_146191_1_);
		final int var4 = field_146224_r < field_146223_s ? field_146224_r
				: field_146223_s;
		final int var5 = field_146224_r < field_146223_s ? field_146223_s
				: field_146224_r;
		final int var6 = field_146217_k - field_146216_j.length()
				- (var4 - field_146223_s);
		if (field_146216_j.length() > 0) {
	...
	public void func_146199_i(int p_146199_1_) {
		...
		if (field_146211_a != null) {
			...
			if (p_146199_1_ == field_146225_q) {
				field_146225_q -= field_146211_a.trimStringToWidth(
						field_146216_j, var3, true).length();
			}
	...
	public String func_146207_c() {
		final int var1 = field_146224_r < field_146223_s ? field_146224_r
				: field_146223_s;
		final int var2 = field_146224_r < field_146223_s ? field_146223_s
				: field_146224_r;
	...
	public void mouseClicked(int p_146192_1_, int p_146192_2_, int p_146192_3_) {
		final boolean var4 = p_146192_1_ >= field_146209_f
		...
		if (field_146213_o && p_146192_3_ == 0) {
			...
			final String var6 = field_146211_a.trimStringToWidth(
					field_146216_j.substring(field_146225_q), func_146200_o());
